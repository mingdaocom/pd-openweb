...
export default (function ($) {
  ...
  var DialogSelectMapGroupDepart = function (el, param) {
    var _this = this;
    var defaults = {
      title: _l('设置关联部门'),
      defaultSelectId: '',
      ...
      /*
       var data = {
       departmentId:"",    //当前选择关联的部门ID,
       departmentName:"",  //当前选择关联的部门名称
       };
       */
    ...
    _this.bindEvent = function () {
      ...
      $('#sortDept').on('click', function () {
        ...
        // 重置为灰色
        $this.find('.sortItem span').removeClass('Gray_6').addClass('Gray_c6');
        $this
