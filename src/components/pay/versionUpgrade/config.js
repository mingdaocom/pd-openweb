...
const featureData = [
  ...
  { className: 'subTitle', subTitle: _l('AI') },
  {
    className: 'chatbot',
    name: _l('对话机器人'),
    dataTip: '',
  ...
  },
  {
    ...
    dataTip: _l('HAP可与您的Microsoft Entra目录进行整合， 终端用户可实现单点登录'),
    value0: 'basicNo',
    value1: 'basicPng',
    value2: 'basicPng',
    value3: 'basicPng',
  ...
  },
  {
    ...
    dataTip: '',
    value0: 'basicNo',
    value1: _l('100元/1万块/年'),
    value2: _l('100元/1万块/年'),
    value3: _l('100元/1万块/年'),
  },
];
...
export const SUBSCRIPTION_TABS = [
  { key: 'monthly', text: _l('按月计费') },
  { key: 'yearly', text: _l('按年计费') },
];

export const VERSION_CARD_LIST = [
  {
    type: 'free',
    name: _l('免费版'),
    description: _l('最多10个成员'),
    price: { monthly: 0, yearly: 0 },
    featureTitle: _l('免费版功能：'),
    featureList: [
      _l('3 个应用配额'),
      _l('100 个工作表配额'),
      _l('每表最多 5,000 行'),
  ...
  },
  {
    type: 'standard',
    name: _l('标准版'),
    description: _l('5个成员起步'),
    price: { monthly: 15, yearly: 150 },
    featureTitle: _l('包含免费版的所有功能，此外还包括：'),
    featureList: [
      _l('无限的应用配额'),
      _l('每表最多 1,000,000 行'),
      _l('总行数不限'),
  ...
  },
  {
    type: 'professional',
    name: _l('专业版'),
    description: _l('10个成员起步'),
    price: { monthly: 28, yearly: 280 },
    featureTitle: _l('包含标准版的所有功能，此外还包括：'),
    featureList: [
      _l('无限的工作表配额'),
      _l('每表最多 5,000,000 行'),
      _l('每月 500,000 次工作流执行'),
      _l('每月 500,000 次数据同步'),
      _l('每年 120GB 附件上传'),
      _l('超级搜索'),
      _l('使用分析'),
