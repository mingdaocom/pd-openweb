...
export default class WelinkSyncCourse extends React.Component {
  ...
  renderDing = () => {
    ...
    return (
      <React.Fragment>
        <h3 className="Font18 textPrimary mTop40">{_l('1. 登录Welink管理后台 — 前往“业务应用”下的“应用管理”')}</h3>
        <img src={welinkPng1} />
        <h3 className="Font18 textPrimary mTop40">{_l('2. 在“自建应用”一栏，前往开放平台创建应用')}</h3>
        <img src={welinkPng2} />
        <h3 className="Font18 textPrimary mTop40">{_l('3. 在开放平台，选择“企业内部应用”下的“轻应用”，创建轻应用')}</h3>
        <img src={welinkPng3} />
        ...
        <img src={welinkPng4} />
        <h3 className="Font18 textPrimary mTop40">{_l('5. 应用创建完成后，请配置首页地址并开通接口权限')}</h3>
        <p className="Font14 textSecondary mTop24 LineHeight22">
        ...
        <img src={welinkPng6} />
        <h3 className="Font18 textPrimary mTop40">{_l('6. 发布应用')}</h3>
        <p className="Font14 textSecondary mTop24 LineHeight22">
