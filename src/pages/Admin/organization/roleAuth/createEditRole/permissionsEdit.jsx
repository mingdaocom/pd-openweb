              ...
              <tr>
                ...
                {adminPermission ? (
                  <td className="TxtRight Gray_9e Font13">
                    <span data-tip={_l('拥有%0的所有权限', permissionType.typeName)} className="tip-top TxtMiddle Gray_9e mRight5">
                      <span className="icon-task-setting_promet Font16" />
                    </span>
                    <span className="Gray_9e Font13 TxtMiddle">{_l('授权为%0管理员', permissionType.typeName)}</span>
                    <Switch
