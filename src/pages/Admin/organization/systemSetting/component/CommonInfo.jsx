        ...
        {isLoading ? (
          ...
          <div className="common-info mBottom80">
            ...
            <div className="common-info-row mTop24">
              ...
              <span className="mRight16">{((timeZoneName || '').match(/.*? /) || [''])[0].trim() || _l('未设置')}</span>
            </div>
            <div className="common-info-row mTop24">
                ...
                <div className="common-info-row mTop24">
                  ...
                  <div className="common-info-row-content">
                    <CertificationDisplay
                      ...
                      authType={authType}
                      projectId={Config.projectId}
                      onUpdateCertStatus={value => this.setState({ authType: value })}
            ...
            <div className="common-info-row mTop24">
              <div className="common-info-row-label">
                {window.platformENV.isOverseas || window.platformENV.isLocal ? _l('扩展信息') : _l('二级域名')}
                {Config.project.licenseType === 0 && <UpgradeIcon />}
              </div>
              <div className="common-info-row-content">
                <div>
                  {subDomain ? (
                    <span className="Font13">
                      {window.platformENV.isOverseas || window.platformENV.isLocal
                        ? subDomain
                        : `${subDomain}.mingdao.com`}
                    </span>
                  ) : (
                    <span className="set-describe">
                      {window.platformENV.isOverseas || window.platformENV.isLocal
                        ? _l('可自定义组织别名和登录背景图片')
                        : _l('可自定义访问链接和登录背景图片')}
                    </span>
            ...
            {isSuperAdmin && (
              <div className="common-info-row">
                ...
                <div>
                  ...
                  <div className="Font13 textTertiary">
                    {_l(
