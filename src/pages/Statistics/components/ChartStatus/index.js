...
export const Loading = () => {
  return (
    <div className="flex flexColumn valignWrapper" style={style}>
      ...
      <div className="textTertiary mTop10">{_l('正在加载数据...')}</div>
    </div>
  );
};
...
export const WithoutData = () => {
  return (
    <div className="flex flexColumn valignWrapper textTertiary Font16 h100" style={style}>
      {_l('没有记录')}
    </div>
  );
};
...
export const Overload = () => {
  return (
    <div className="flex flexColumn valignWrapper textTertiary Font16 h100 centerAlign" style={style}>
...
export const Abnormal = props => {
  ...
  const withoutPermission = (
    <div className="flex flexColumn valignWrapper textPlaceholder" style={style}>
      <Icon icon="password" className="Font64 textPlaceholder mBottom10" />
      <div className="textTertiary Font20 mBottom2">{_l('无法形成图表')}</div>
      <div className="textTertiary Font16">{_l('无权限')}</div>
    </div>
  );
