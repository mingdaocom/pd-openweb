...
export default class DataItemColor extends Component {
  constructor(props) {
    super(props);
    this.state = {
      min: undefined,
  ...
  handleSave = () => {
    const { min, max, positiveNumberColor, negativeNumberColor, axisColor, direction } = this.state;
    this.props.onSave({
      min,
      max,
      positiveNumberColor,
        ...
        <div className="flexRow">
          <div className="flex mRight10">
            ...
            <Input
              ...
              placeholder={_l('最小值')}
              onChange={(e) => {
                this.setState({ min: Number(formatNumberFromInput(e.target.value)) });
              }}
            />
          ...
          <div className="flex">
            ...
            <Input
              ...
              placeholder={_l('最大值')}
              onChange={(e) => {
                this.setState({ max: Number(formatNumberFromInput(e.target.value)) });
              }}
            />
