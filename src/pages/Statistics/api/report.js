...
var report = {
   ...
   * 获取统计图表的条件id
   * @param {Object} args 请求参数
   * @param {ReportSingleCacheIdRequest} {contrastType:对比周期(integer),isPersonal:查看原始数据： ture，其他:false(boolean),match:点击的数值条件：{"caid":"user-workflow","ownerid":"user-undefined"}(object),particleSizeType:(integer),reportId:图表id(string),}*request
   * @param {Object} options 配置参数
   * @param {Boolean} options.silent 是否禁止错误弹层
   */
