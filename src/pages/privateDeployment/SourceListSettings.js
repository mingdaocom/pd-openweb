  ...
  handleSave = () => {
    ...
    if (creatreItem.id) {
      ...
      privateSource.addSource({
        ...
        if (result) {
          this.setState({ dialogVisible: false, creatreItem: _.object() });
          this.getSources();
        }
      });
    }
      ...
      >
        ...
        <div className="flexRow valignWrapper">
          <Input
            ...
            onChange={value => {
              this.setState({ creatreItem: Object.assign(_.object(), creatreItem, { name: value }) });
            }}
          />
        </div>
        ...
        <div className="flexRow valignWrapper">
          <Input
            ...
            onChange={value => {
              this.setState({ creatreItem: Object.assign(_.object(), creatreItem, { url: value }) });
            }}
          />
        </div>
        ...
        <div className="flexRow valignWrapper">
          {
            COLORS.map((item, index) => (
              <div
                ...
                onClick={() => {
                  this.setState({ creatreItem: Object.assign(_.object(), creatreItem, { color: item }) });
                }}
              >
        ...
        <div className="flexRow valignWrapper mTop15 sourcesIconWrapper">
          {
            systemIcon.map((item, index) => (
              <div
                ...
                onClick={() => {
                  this.setState({ creatreItem: Object.assign(_.object(), creatreItem, { icon: item.fileName }) });
                }}
              >
  ...
  render() {
    ...
    return (
      <div className="privateDeploymentWrapper card mAll15 pAll20 flexColumn">
        ...
        <div className="sourceListContent flex flexColumn">
          <Button className="addButton" onClick={() => { this.setState({ dialogVisible: true }) }}>{_l('添加资源')}</Button>
