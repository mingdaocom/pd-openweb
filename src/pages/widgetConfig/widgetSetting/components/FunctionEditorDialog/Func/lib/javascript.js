export default function setJavascriptMode(CodeMirror) {
  'use strict';

  CodeMirror.defineMode('javascript', function (config, parserConfig) {
    var indentUnit = config.indentUnit;
    var defaultKeywords = config.keywords;
    ...
    return {
      ...
      indent: function (state, textAfter) {
        ...
        if (type == 'vardef')
          return (
            lexical.indented + (state.lastType == 'operator' || state.lastType == ',' ? lexical.info.length + 1 : 0)
          );
