 ...
 * 54: 自定义
 */
export const NOT_NEED_SET_READONLY_CONTROL = [22, 25, 30, 31, 32, 33, 37, 38, 43, 45, 47, 51, 53, 54, 10010];
...
export const NEED_SPECIAL_DISPLAY_CONTROLS = [
  2, 6, 9, 10, 11, 14, 19, 21, 22, 23, 24, 26, 27, 28, 29, 31, 34, 35, 36, 37, 38, 40, 41, 42, 43, 47, 48, 49, 51, 52,
  53, 10010,
];
...
// 有高级设置的控件
export const HAVE_HIGH_SETTING_WIDGET = [2, 6, 10, 14, 15, 16, 23, 24, 27, 28, 29, 31, 32, 33, 35, 38, 40, 42, 46];
...
// sort排序组件需要过滤的控件
export const UN_SORT_WIDGET = [10, 14, 19, 21, 22, 23, 24, 25, 34, 35, 40, 41, 43, 45, 47, 49, 51, 52, 10010];
