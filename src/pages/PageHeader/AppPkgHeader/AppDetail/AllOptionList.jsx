      ...
      <div className="title Bold">
        ...
        <div className="operate">
          <Tooltip placement="bottom" title={_l('编辑')}>
            <Icon icon="edit" type="link" onClick={() => handleClick('edit')} />
          </Tooltip>
          <Tooltip placement="bottom" title={_l('删除')}>
            <Icon icon="trash" type="delete" onClick={() => handleClick('delete')} />
          </Tooltip>
        </div>
      </div>
      <ul>
  ...
  return (
    <Fragment>
      <AllOptionHeader>
        ...
        <div className="addAndClose flexCenter">
          <div className="addOptionList Bold" onClick={() => setVisible({ createVisible: true })}>
            {_l('+ 新增选项集')}
          </div>
          <Icon icon="close" type="link" className="Font22" onClick={onClose} />
        </div>
      </AllOptionHeader>
