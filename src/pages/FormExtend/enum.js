...
export const NAV_LIST = {
  0: [
    { key: 'publicform', icon: 'visibility', title: _l('公开表单') },
    { key: 'query', icon: 'search', title: _l('公开查询') },
  ],
  1: [
    { key: 'pay', icon: 'sp_payment_white', title: _l('支付') },
    { key: 'invoice', icon: 'Invoice', title: _l('开票') },
  ],
};
