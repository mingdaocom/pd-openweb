...
export default function ({ controls, hidedControlIds, disabledControlIds, onAdd = () => {}, onHide = () => {} }) {
  ...
  const renderControlList = (list, filterSection = true) => {
    return (
      <Wrapper>
        {list
          .filter(c => (!c.sectionId || !filterSection) && !disabledControlIds.includes(c.controlId))
          .map(c => {
