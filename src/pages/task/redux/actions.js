...
// 更新项目名称
export const updateFolderName = (folderId, folderName, callback = () => {}) => (dispatch, getState) => {
...
// 获取任务详情
export const getTaskDetail = (taskId, callback = () => {}, addPostSuccessCount = () => {}) => (dispatch, getState) => {
  const { taskConfig } = getState().task;
...
// 修改任务锁定状态
export const updateTaskLocked = (taskId, locked, callback = () => {}) => (dispatch, getState) => {
...
// 更改任务状态
export const editTaskStatus = (taskId, status, isSubTask, subTaskId, callback = () => {}) => (dispatch, getState) => {
...
// 更改项目
export const updateTaskFolderId = (taskId, folderId, callback = () => {}) => (dispatch, getState) => {
...
// 更改母任务
export const updateTaskParentId = (taskId, parentId, callback = () => {}) => (dispatch, getState) => {
...
// 更改阶段
export const updateTaskStageId = (taskId, stageId, stageName, callback = () => {}) => (dispatch, getState) => {
...
// 更改任务名称
export const updateTaskName = (taskId, taskName, subTaskId, callback = () => {}) => (dispatch, getState) => {
  _.debounce(() => {
...
// 更改任务星标
export const updateTaskMemberStar = (taskId, star, callback = () => {}) => (dispatch, getState) => {
...
// 更改任务负责人
export const updateTaskCharge = (taskId, user, subTaskId, callback = () => {}) => (dispatch, getState) => {
...
// 添加成员
export const addTaskMember = (taskId, users, specialAccounts, callback = () => {}) => (dispatch, getState) => {
  ajaxRequest
    .batchAddTaskMember({
      taskIDstr: taskId,
...
// 添加子任务
export const addSubTask = (taskId, taskName, accountId, projectId, callback = () => {}) => (dispatch, getState) => {
...
// 获取检查清单
export const getCheckListsWithItemsInTask = (taskId, addPostSuccessCount = () => {}) => (dispatch, getState) => {
...
// 修改清单顺序
export const updateCheckListIndex = (taskId, currentCheckListId, previousCheckListId, insertIndex) => (dispatch, getState) => {
...
// 修改检查项顺序
export const updateItemIndex = (taskId, currentItemId, previousItemId, targetCheckListId, insertIndex) => (dispatch, getState) => {
...
// 自定义字段
export const getTaskControls = (taskId, addPostSuccessCount = () => {}) => (dispatch, getState) => {
...
// 任务详情折叠项
export const taskFoldStatus = (taskId, foldId, callback = () => {}) => (dispatch, getState) => {
...
// 添加标签
export const addTaskTag = (taskId, tagId, tagName, callback = () => {}) => (dispatch, getState) => {
  tagController
    .addTaskTag2({
      taskIds: [taskId],
      tagName,
...
// 删除标签
export const removeTasksTag = (taskId, tagId, callback = () => {}) => (dispatch, getState) => {
  tagController
    .removeTasksTag({
      sourceIds: [taskId],
      tagId,
...
// 添加附件
export const addTaskAttachments = (taskId, attachmentData, kcAttachmentData, callback = () => {}) => (dispatch, getState) => {
  ajaxRequest
    .addTaskAttachments({
      taskId,
...
// 修改任务计划时间
export const updateTaskStartTimeAndDeadline = (taskId, startTime, deadline, callback = () => {}) => (dispatch, getState) => {
...
// 修改任务实际开始时间
export const updateTaskActualStartTime = (taskId, actualStartTime, callback = () => {}) => (dispatch, getState) => {
  ajaxRequest
...
// 修改任务完成时间
export const updateCompletedTime = (taskId, time, callback = () => {}) => (dispatch, getState) => {
  ajaxRequest
    .updateCompletedTime({
      taskId,
      time,
