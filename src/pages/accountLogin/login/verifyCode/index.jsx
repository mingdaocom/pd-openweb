...
import { isTel } from 'src/pages/accountLogin/util.js';
import _ from 'lodash';
import { captcha } from 'ming-ui/functions';
import cx from 'classnames';
import { removePssId } from 'src/util/pssId';
import { SupportFindVerifyCodeUrl, CodeTypeEnum } from 'src/pages/accountLogin/config.js';
...
export default function (props) {
  const { changeVerifyActionResult = () => {}, verifyLen = 6, isNetwork, emailOrTel, dialCode } = props;
  ...
  const onLogin = () => {
    ...
    const loginFetch = res => {
      const { emailOrTel, isCheck, dialCode, loginCallback, projectId, loginMode, isNetwork } = props;
      ...
      let cb = data => {
        ...
        loginCallback({ ...data, projectId, loginMode, isNetwork, isVerifyLogin: true });
      };
