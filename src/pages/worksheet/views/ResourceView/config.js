...
export const dayTimeByPart = 2;
export const weekObj = [_l('周一'), _l('周二'), _l('周三'), _l('周四'), _l('周五'), _l('周六'), _l('周日')];
export const GroupControlWidth = 100;
export const minHeightObj = [32, 44, 56];
export const BlockHeight = minHeightObj[0];
