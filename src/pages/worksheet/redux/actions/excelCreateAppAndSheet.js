...
export const updateExcelDetailData = data => (dispatch, getState) => {
...
export const updateSelectedImportSheetIds = data => (dispatch, getState) => {
  dispatch({ type: 'UPDATE_SELECTED_IMPORT_SHEET_IDS', data });
};

export const changeDialogUploadVisible = data => (dispatch, getState) => {
  dispatch({ type: 'UPDATE_UPLOAD_VISIBLE', data });
};

export const changeSetDataDialogVisible = data => (dispatch, getState) => {
  dispatch({ type: 'UPDATE_SETDATA_VISIBLE', data });
};

export const changeDialogCreateAppVisible = data => (dispatch, getState) => {
  dispatch({ type: 'UPDATE_CREATE_APP_VISIBLE', data });
};

export const changeCreateAppLoading = data => (dispatch, getState) => {
