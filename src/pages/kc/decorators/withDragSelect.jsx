...
class DragSelect extends React.Component {
    ...
    if (this.started) {
      ...
      if (
        ...
        if (!this.selectionEl) {
          ...
          rootNode.appendChild(this.selectionEl);
        }
        ...
        React.Children.forEach(this.props.children, (child, i) => {
          ...
          const childEl = this.getChildNode(i);
  ...
  startDragSelect = evt => {
    ...
    const rect = this.getRootNode().getBoundingClientRect();
    const pos = {
      x: evt.clientX - rect.left,
      y: evt.clientY - rect.top,
    };
      ...
      <Component {...rest} ref={this.setRootNode}>
        {React.Children.map(children, (child, i) => {
          ...
          return React.cloneElement(child, {
            ref: ref => (this['dragSelectItem$' + i] = ref),
            setRef: node => this.setChildNode(i, node),
          });
        })}
      </Component>
    );
