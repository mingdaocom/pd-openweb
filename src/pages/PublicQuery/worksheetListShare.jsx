...
const LoadableRecordCard = lazy(() => import('src/components/recordCard'));
...
class WorksheetListShare extends React.Component {
  ...
  render() {
    ...
    const RecordInfo = browserIsMobile() ? LoadableMobileRecordInfoModal : LoadableRecordInfoWrapper;
              ...
              >
                {this.getCardControlsForTitle(Controls)
                  ...
                  .map((control, i) => {
                    return (
                      <div
                        className={cx('controlName flex Hand', {
