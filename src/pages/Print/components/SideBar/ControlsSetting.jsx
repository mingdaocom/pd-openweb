            ...
            >
              ...
              {(isRelationControls ||
                ...
                <div className={cx({ mLeft24: it.type !== 52 })}>
                  ...
                  {it.type === 26 && it.expand && renderUserChild(it, it.controlId, handleClick)}
                </div>
              )}
              {isSysTime && (
                <Icon
                  icon="settings"
                  className="Font18 moreList textTertiary Hand TxtCenter TxtBottom"
            ...
            <div className="Relative" key={`${uniqueId}-li`}>
              ...
              {it.type === 26 && (
                <div className={cx({ mLeft24: it.type !== 52 })}>
                  ...
                  />
                  {it.type === 26 && hasExpandKey && renderUserChild(it, uniqueId, handleClick)}
                </div>
              )}
            </div>
          );
