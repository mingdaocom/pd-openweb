...
export default class Con extends React.Component {
  ...
  loadWorksheetShortUrl = props => {
    ...
    if (shareType === 0) {
      ...
      sheetAjax
        ...
        .then(({ shareLink }) => {
          this.setState({ shareUrl: shareLink });
        });
      return;
    }
  ...
  renderRelations = (tableList, dataInfo) => {
    ...
    let sign = !relationStyleNum.type || relationStyleNum.type === 1 || relationStyleNum.type === 3;
    ...
    return (
      <React.Fragment>
        ...
        {!relationStyleNum.type || relationStyleNum.type === 1 || relationStyleNum.type === 3 ? (
          // 表格
          <RelationTable
            dataSource={list}
            controls={controls}
            ...
            relationStyleNum={relationStyleNum}
          />
        ) : (
          // 平铺
          <React.Fragment>
