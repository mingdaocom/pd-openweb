...
只需要传: 9e4554bb-4fb4-4ef7-abb8-d79fcdbc3f7d.jpg
    ...
    * @returns {Promise<Boolean, ErrorModel>}
    **/
    checkJoinProjectByToken: function (args, options) {
      return $.api('Account', 'CheckJoinProjectByToken', args, options);
    },
    ...
    * @param {Object} args 请求参数
    * @param {string} args.projectCode 企业号
    * @param {boolean} args.needCheckCode 是否需要验证
    * @param {string} args.ticket 验证码返票据
    * @param {string} args.randStr 票据随机字符串
    * @param {} args.captchaType 验证码类型（默认腾讯云）
    * @param {Object} options 配置参数
    ...
    * @returns {Promise<Boolean, ErrorModel>}
    **/
    checkJoinProjectByCode: function (args, options) {
      return $.api('Account', 'CheckJoinProjectByCode', args, options);
    },
    ...
    * @returns {Promise<Boolean, ErrorModel>}
    **/
    checkJoinProjectByCodeWithCard: function (args, options) {
      return $.api('Account', 'CheckJoinProjectByCodeWithCard', args, options);
    },
