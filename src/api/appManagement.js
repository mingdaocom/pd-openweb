export default {
   ...
   * @param {string} args.appId 应用id
   * @param {string} args.name 名称
   * @param {integer} args.type 权限范围类型 1=全部，2=只读，10=自定义
   * @param {boolean} args.viewNull 不传视图id不返回数据配置
   * @param {array} args.sheets 工作表权限集（内含视图权限）
   * @param {Object} options 配置参数
   * @param {Boolean} options.silent 是否禁止错误弹层
   * @returns {Promise<Boolean, ErrorModel>}
   **/
...
滑动过期
  ...
  **/
   ...
   * @param {integer} args.modelType 覆盖类型， 0 = 默认，1 = 全量
   * @param {Object} options 配置参数
   * @param {Boolean} options.silent 是否禁止错误弹层
   * @returns {Promise<Boolean, ErrorModel>}
   **/
   ...
   * @param {Object} args 请求参数
   * @param {string} args.appId 应用id
   * @param {array} args.langCode 应用语种数组
   * @param {string} args.projectId
   * @param {Object} options 配置参数
   * @param {Boolean} options.silent 是否禁止错误弹层
   * @returns {Promise<Boolean, ErrorModel>}
