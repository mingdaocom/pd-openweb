  ...
  module.exports = {
    ...
    **/
    shareAttachmentByPost: function (args, options) {
      return $.api('Attachment', 'ShareAttachmentByPost', args, options);
    },
    ...
    **/
    getAttachmentDetail: function (args, options) {
      return $.api('Attachment', 'GetAttachmentDetail', args, options);
    },
    ...
    **/
    editLinkAttachment: function (args, options) {
      return $.api('Attachment', 'EditLinkAttachment', args, options);
    },
    ...
    **/
    getShareLocalAttachmentUrl: function (args, options) {
      return $.api('Attachment', 'GetShareLocalAttachmentUrl', args, options);
    },
    ...
    **/
    getShortUrl: function (args, options) {
      return $.api('Attachment', 'GetShortUrl', args, options);
    },
    ...
    **/
    addAttachmentClick: function (args, options) {
      return $.api('Attachment', 'AddAttachmentClick', args, options);
    },

    /**
    * 根据fileId 批量获取附件信息
    * @param {Object} args 请求参数
    * @param {array} args.fileIds 多个fileId，请以逗号分隔(,)
    * @param {Object} options 配置参数
    * @param {Boolean} options.silent 是否禁止错误弹层
    * @returns {Promise<Boolean, ErrorModel>}
    **/
    getAttachmentToList: function (args, options) {
      return $.api('Attachment', 'GetAttachmentToList', args, options);
    },
    ...
    **/
    saveToKnowledge: function (args, options) {
      return $.api('Attachment', 'SaveToKnowledge', args, options);
    },

    /**
    * 根据 docVersionID 列表获取所有附件的所有版本, 并将地址写入docservice需要读取的缓存
    * @param {Object} args 请求参数
    ...
    * @returns {Promise<Boolean, ErrorModel>}
    **/
    getAttachmentsByDocVersionIDs: function (args, options) {
      return $.api('Attachment', 'GetAttachmentsByDocVersionIDs', args, options);
    },
    ...
    **/
    getPreviewLink: function (args, options) {
      return $.api('Attachment', 'GetPreviewLink', args, options);
    },
    ...
    **/
    update: function (args, options) {
      return $.api('Attachment', 'Update', args, options);
    },
    ...
    * @param {} args.fromType 来源
    * @param {Object} options 配置参数
    * @param {Boolean} options.silent 是否禁止错误弹层
    * @returns {Promise<Boolean, ErrorModel>}
    **/
    deleteAttachment: function (args, options) {
      return $.api('Attachment', 'DeleteAttachment', args, options);
    },
    ...
    **/
    newVersion: function (args, options) {
      return $.api('Attachment', 'NewVersion', args, options);
    },
    ...
    **/
    getPreViewMsg: function (args, options) {
      return $.api('Attachment', 'GetPreViewMsg', args, options);
    },
