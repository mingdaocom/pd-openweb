...
滑动过期
  ...
  **/
   ...
   * @param {object} args.rowAndFilterControls 批量打印时 传入不同行记录对应筛选条件 key 为行id value为筛选条件
...
滑动过期
  ...
  **/
   ...
   * @param {string} args.projectId
   * @param {string} args.name
   * @param {array} args.extraParams 云打印服务商特定扩展参数
   * @param {} args.serviceType
   * @param {Object} options 配置参数
   * @param {Boolean} options.silent 是否禁止错误弹层
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  createCloudPrint: function (args, options = {}) {
   ...
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  loadCloudPrintDatas: function (args, options = {}) {
   ...
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  updateCloudPrint: function (args, options = {}) {
   ...
   * @param {string} args.worksheetId
   * @param {string} args.appId
   * @param {array} args.rowIds 行记录id集合
   * @param {} args.serviceType
   * @param {Object} options 配置参数
   * @param {Boolean} options.silent 是否禁止错误弹层
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  sendCloudPrint: function (args, options = {}) {
...
remark:待识别文件url ，图片的 Url 地址。要求图片经Base64编码后不超过 7M，分辨率建议500*800以上，支持PNG、JPG、JPEG、BMP格式。建议卡片部分占据图片2/3以上。 建议图片存储于腾讯云，可保障更高的下载速度和稳定性
  ...
  **/
   ...
   * @param {string} args.matchControlId
   * @param {string} args.separator
   * @param {string} args.attachmentControlId
   * @param {} args.writeMode
   * @param {boolean} args.createWhenNoMatch
   * @param {boolean} args.triggerWorkflow
   * @param {string} args.viewId
   * @param {Object} options 配置参数
   * @param {Boolean} options.silent 是否禁止错误弹层
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  importWorksheetAttachments: function (args, options = {}) {
    return mdyAPI('Worksheet', 'ImportWorksheetAttachments', args, options);
  },
  /**
   * 获取 批量导入附件更新/新增记录 错误报告
   * @param {Object} args 请求参数
   * @param {string} args.randomKey
   * @param {Object} options 配置参数
   * @param {Boolean} options.silent 是否禁止错误弹层
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  getImportByAttachmentsLog: function (args, options = {}) {
    return mdyAPI('Worksheet', 'GetImportByAttachmentsLog', args, options);
  },
  /**
   * 下载 批量导入附件更新/新增记录 错误报告
   * @param {Object} args 请求参数
   * @param {string} args.randomKey
   * @param {Object} options 配置参数
   * @param {Boolean} options.silent 是否禁止错误弹层
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  downImportByAttachmentsLog: function (args, options = {}) {
