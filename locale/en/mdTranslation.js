var translations = {
  ...
  "显示全选操作": "Show Select All Operation",
  ...
  "允许输入自定义位置": "Allow input of custom location",
  ...
  "删除按钮": "Delete button",
  "过去6小时": "The past 6 hrs",
  "自定义按钮": "Custom action",
  "过去12小时": "The past 12 hrs",
  "将来3天": "The next 3 days",
  "过去1小时": "Last 1 hour",
  ...
  "过去3小时": "The past 3 hrs",
  "过去3天": "The past 3 days",
  "创建新按钮": "Create a new button",
  "系统操作": "System operations",
  "过去15分钟": "The past 15 min",
  "过去5分钟": "The past 5 min",
  "过去30分钟": "The past 30 min",
  "过去24小时": "Past 24 Hours",
  "将来5分钟": "The next 5 min",
  "将来15分钟": "The next 15 min",
  "将来3小时": "The next 3 hrs",
  "将来24小时": "The next 24 hrs",
  "将来1小时": "Next hour",
  "将来30分钟": "The next 30 min",
  "将来6小时": "The next 6 hrs",
  "将来12小时": "The next 12 hrs",
  "等于": "Equal to",
  "开头是": "Beginning with",
  "属于": "Belong to",
  "结尾是": "The ending is",
  ...
  "预设时间范围选项": "Default Time Range Options",
  "筛选方式": "Filtering method",
  "颗粒度": "Granularity",
  "卡片显示内容": "Card display",
  ...
  "支持10MB以内的xls、xlsx、csv文件, 最大行数不超过20000行，列数不超过200列；导入多选类型的控件，请确保Excel字段内各个选项/人员用“，”隔开；导入地区控件，省市县之间以“/”隔开，如：江西省/上饶市/铅山县，如填写的地区格式没有“/”，则会按照名称精准匹配": "Support xls, xlsx, csv files within 10MB, maximum rows not more than 20000, columns not more than 200; Importing multiple selection type control, please make sure that each option/person in the Excel field is separated by \\\",\\\"; Importing region control, provinces, cities and counties are separated by \\\"/\\\" , e.g: Jiangxi Province / ShangRao City / Lingshan County, if the filled area format does not have \\\"/\\\", it will be wholly matched according to the name",
  ...
  "暂无部门，可": "No department available, can",
  ...
  "·导入成功后，成员会收到邀请链接，验证后可加入组织": ".After successful import, members will receive an invitation link and can join the organization after verification",
  ...
  "请注意，单次批量离职人数不得超过50人": "Please note that the number of batch termination cannot exceed 50 in a single batch",
  "批量离职": "Batch termination",
  "个成员，是否确认将勾选成员离职？": "members, is it confirmed that the ticked member will be separated?",
  "批量离职失败": "Batch termination failure",
  ...
  "调封装业务流程": "Adjust Business Process Packaging",
  "设置为": "Set to",
  "声音": "Sound",
  ...
  "多个关键词请用换行符分隔": "Multiple keywords should be separated by newline characters",
  ...
  "条件组为专业版功能": "Conditional Group is a Professional Edition feature",
  "保存为": "Save As",
  ...
  "其中%0行错误": "There is an error in %0 line",
  ...
  "当前子表中的字段为空": "The fields in the current sub-table are empty",
  ...
  "超过导入上限 (上限 50000 行)，请调整导入数据": "Exceeded import limit (limit 50,000 rows), please adjust import data",
  ...
  "当前表共%0行，仅显示前%1行": "There are %0 rows in the current worksheet, showing only the first %1 rows",
  ...
  "该sheet超过导入上限（上限20000行）": "The worksheet exceeds the import limit (limit of 20,000 rows)",
  ...
  "该sheet超过导入上限（上限%0张表）": "This worksheet exceeds the import limit (limit of %0 sheets)",
  ...
  "2.点击”设置接口权限”，开通明道云集成需要用到的接口权限": "2. Click /\"Set Interface Permissions/\" to enable the interface permissions needed for Mingdao Cloud integration.",
  ...
  "1.点击”设置首页地址”，将下方的应用主页地址分别复制到手机端链接和PC端链接上": "1. Click on \\\"Set Home Page Address\\\" and copy the application home page address below to the mobile link and PC link respectively.",
  ...
  "暂未添加记录，点击创建": "No records added yet, click to create",
  "添加看板": "Add Dashboard",
  "反选%02055": "Deselect",
  ...
  "汇总概览": "Summary Overview",
  "图片过大，加载失败": "Image is too large, failed to load",
  "下一天": "Next Day",
  "浮窗打开": "Floating window opened",
  "使用情况": "Usage",
  "记录创建人数": "Number of records created",
  "通过工作表表单页面创建的记录、不包含Excel导入、工作流创建、API调用的方式": "Records created through the worksheet form page, excluding Excel import, workflow creation, and API calls",
  ...
  "应用访问量": "Application Access Volume",
  "公开表单仅统计非平台登录用户上传的附件": "Public forms only count attachments uploaded by non-platform logged-in users",
  "筛选条件“按部门”不生效": "The filtering condition 'by department' is not effective",
  "生成链接": "Generate Link",
  ...
  "首页可以找到CorpId，填入明道云对应输入框内": "You can find the CorpId on the homepage and fill it in the corresponding input box in Mingdao Cloud",
  "邮箱等个人信息【建议开通，用于手机号对比账号】": "Personal information such as email address [Recommended to enable for mobile number account comparison]",
  ...
  "从%0通讯录同步到明道云。": "Sync from %0 contacts to Mingdao Cloud.",
  ...
  "中文名，建议：明道云": "Chinese name, suggestion: Mingdao Cloud",
  ...
  "4. 在创建流程填写应用信息": "4. Fill out application information when creating the process",
  ...
  "点击下方“自建应用”进入钉钉开放平台": "Click \\\"Build Your Own Application\\\" below to enter the DingTalk Open Platform",
  ...
  "定位到“网页应用”的 H5应用配置信息，讲以下链接填入对应输入框内": "Locate the H5 application configuration information for the \\\"Web Application\\\" and fill the following link into the corresponding input box.",
  ...
  "取消按钮": "Cancel button",
  "确认按钮": "Confirm button",
  "切换至“基础信息”，将AgentId、ClientId、ClientScret分别填入明道云的“组织管理 - 集成 - 钉钉 - 对接信息录入”对应输入框内": "Switch to \\\"Basic Information\\\", fill in AgentId, ClientId and ClientScret into the corresponding input boxes of \\\"organization Management - Integration - Nail - Matching Information Entry\\\" in Mindray Cloud respectively.",
  ...
  "2.切换到“机器人”，启用机器人功能，这样在飞书消息测就能直接收到明道云内部的流程、应用消息": "2. Switch to \\\"Robot\\\" and enable the robot feature, so you can directly receive internal process and application messages from Mingdao Cloud in Feishu messages.",
  ...
  "“凭证与基础信息”可以查看该App的ID和Secret；回到明道云管理后台，下一步录入信息将会用到": "You can view the App's ID and Secret in \\\"Credentials and Basic Information\\\"; return to the Mingdao Cloud management background, and the next step of inputting information will utilize this.",
  ...
  "因企业微信规则调整，新的对接方案正在开发，支持线下完成对接。": "Due to adjustments in WeCom Work rules, a new integration plan is under development, supporting offline integration completion.",
  ...
  "其中，点击Secret的查看后，您的企业微信会收到一条消息；再点击其中的“前往查看”获取": "After clicking to view the Secret, your WeChat Work will receive a message; then click on 'Go to View' to obtain it.",
  ...
  "可以根据成员属性去创建职位，如，技术、生产、销售设置后应用和工作流可以直接选择职位": "You can create positions based on member attributes, such as setting technology, production, and sales, and then applications and workflows can directly select positions.",
  "暂无职位，可": "No positions available, but",
  "额外可见的成员": "Additional visible members",
  "只允许查看本部门通讯录": "Only allow viewing the departmental address book",
  "规则生效范围包含所选部门的子部门": "The effective range of the rule includes the sub-departments of the selected department.",
  "隐藏的成员": "Hidden Members",
  "被限制后，只能看到本部门的通讯录": "After restrictions, you can only see the address book of your department",
  "被隐藏的成员 ，不会显示在通讯录中": "Hidden members will not appear in the address book",
  "被隐藏的成员 被限制后，不能看到企业所有通讯录": "Hidden members cannot see the company's entire directory after being restricted.",
  "不能看到组织所有通讯录": "Unable to view all contacts of the organization",
  "添加的用户在本组织通讯录中隐藏": "The added user is hidden in the organization's directory.",
  "规则 %0": "Rule %0",
  ...
  "导入时匹配人员部门和组织角色": "Match personnel departments and organizational roles during import",
  "升级时同时备份当前版本": "Backup the current version during the upgrade",
  "升级范围": "Upgrade Scope",
  "不更新角色的显隐配置": "Don’t update the visibility settings of roles",
  "应用升级需要一段时间，正在升级中的应用将为不可用状态。": "The application upgrade will take some time, and the application being upgraded will be in an unavailable state.",
  ...
  "导入单个应用文件，实现对当前应用快速升级。": "Import a single application file for a quick upgrade of the current application.",
  ...
  "此步骤可能耗时较久，请耐心等待": "This step may take some time, please be patient",
  "退出导入升级": "Exit Import Upgrade",
  "选择需要升级的应用，可以选择同源应用升级或者生成为新的应用": "Select the application that needs to be upgraded; you can choose to upgrade the same-source application or generate a new application.",
  "选择已有应用": "Select Existing Applications",
  "应用导入升级": "Application Import Upgrade",
  "生成为新应用": "Create a New Application",
  ...
  "重复:": "Repeat:",
  "日程重复性修改，不支持此操作": "Modification of recurring schedule is not supported",
  "（组织者）": "(Organizer)",
  "重新发送邀请": "Resend Invitation",
  "添加出席者": "Add Attendees",
  "通过日程分享加入的用户": "Users who joined through schedule sharing",
  "结果:": "Results:",
  "退出本日程": "Exit this schedule",
  "移出本日程": "Remove from this schedule",
  ...
  "更新日程信息后，是否需要通知参与人员重新确认？": "After updating the schedule information, do you need to notify the participants to reconfirm?",
  "群发邮件": "Bulk Email",
  "通知重新确认": "Notification Reconfirmation",
  "不需要": "No need",
  "确认要删除此%0吗？": "Are you sure you want to delete this %0?",
  ...
  "定时设置依据字段未设置": "Scheduled setting based on field is not set",
  ...
  "长度过长，请切换\"周\"或\"月\"视图后重试": "The length is too long. Please switch to \\\"Week\\\" or \\\"Month\\\" view and try again.",
  "导出图片": "Export Picture",
  ...
  "必须配置筛选条件和更新字段": "You must configure the filter conditions and update fields.",
  ...
  "当新增和更新记录时触发": "Triggered when records are added or updated",
  ...
  "每%0年在 %1 触发": "Trigger every %0 year on %1",
  "按钮：": "Button:",
  "%0 个参数": "%0 parameters",
  "当外部用户收到讨论通知时（被回复、被提到）触发": "Triggered when external users receive discussion notifications (replies or mentions)",
  "数据对象：": "Data Object:",
  "已启用平台API能力": "Platform API capability enabled",
  "未完成服务号消息设置": "Incomplete service number message settings",
  "推送地址：": "Push Address:",
  ...
  "选择要执行的动作": "Select the action to perform",
  ...
  "抄送%03026": "Cc",
  "选择要执行的动作，或": "Select the action to perform, or",
  "分支下方的节点整体放置在": "The nodes below the branch are placed as a whole in",
  "复制已有节点": "Copy existing node",
  "等待分支汇集后再执行下方节点": "Wait for the branches to converge before executing the following nodes",
  ...
  "查询并更新记录": "Query and update records",
  "获取关联记录": "Get Related Records",
  ...
  "根据查询条件从工作表中获取一条记录": "Retrieve a record from the worksheet based on the query conditions",
  "根据查询条件从工作表中查找一条记录后直接删除": "Delete a record directly after searching for it in the worksheet based on query conditions",
  "查询并删除记录": "Query and delete records",
  "从多条数据节点获取一条符合条件的记录": "Retrieve a record that meets the criteria from multiple data nodes",
  "从多条数据中获取": "Get from multiple data entries",
  "从存有记录链接的文本字段获取一条指定记录": "Get a specified record from a text field containing a record link",
  ...
  "根据查询条件从工作表获取多条数据并批量更新，后续节点可使用新值": "Retrieve multiple records from the worksheet based on the query criteria and batch update, subsequent nodes can use the new values",
  "获取后什么也不做，在以后节点使用": "Do nothing after obtaining, use it at later nodes",
  "获取批量新增结果": "Get Batch Add Results",
  ...
  "从审批、填写、抄送节点获取操作明细。包含：操作人、时间、操作内容、备注等": "Obtain operation details from approval, fill-in, and carbon copy nodes. Includes: operator, time, operation content, remarks, etc.",
  ...
  "通过函数对 文本/数值/日期时间 等流程节点对象的值进行处理": "Process the values of text/numbers/datetime objects at process nodes using functions",
  ...
  "校准": "Calibration",
  "校准单条数据": "Calibrate a single data point",
  ...
  "发送服务号信息%03031": "Send service number information",
  "循环方式": "Looping Method",
  "声音播报": "Voice Notification",
  "一直循环运行一段流程，并在参数达到退出条件后结束": "Continuously run a process and end when parameters meet the exit condition",
  "使用已有循环流程": "Use Existing Loop Workflow",
  "复用已经配置好的循环流程": "Reuse the already configured loop process",
  "延时方式": "Delay Method",
  "调用已集成 API%03040": "Call Integrated API",
  "更新流程参数%03023": "Update Process Parameters",
  "延时%03034": "Delay",
  "构件%03032": "Component",
  ...
  "获取一名人员的相关信息，包含个人信息（姓名、性别、生日、手机、邮箱）和组织信息（部门、职位、工号、上下级（可选））": "Obtain relevant information for a person, including personal information (name, gender, birthday, mobile, email) and organizational information (department, position, employee ID, supervisor/subordinate (optional))",
  ...
  "获取单条人员/部门/组织角色数据%03047": "Get single personnel/department/organization role data",
  "获取单条人员信息": "Get single staff information",
  ...
  "组织/部门/协作%03046": "Organization/Department/Collaboration",
  "从所有组织成员中查找": "Search among all organization members",
  ...
  "获取多条人员/部门/组织角色数据%03048": "Get multiple personnel/department/organizational role data",
  ...
  "获取多名人员的相关信息，包含个人信息（姓名、性别、生日、手机、邮箱）和组织信息（部门、职位、工号、上下级（可选））": "Get relevant information for multiple personnel, including personal information (name, gender, birthday, phone, email) and organizational information (department, position, employee number, superior/subordinate (optional))",
  ...
  "更新外部用户信息%03051": "Update external user information",
  "获取单条外部人员数据%03053": "Get External Personnel Data",
  "邀请外部用户%03052": "Invite External Users",
  "从外部门户中获取": "Get from external portal",
  "从外部用户字段获取一名指定人员的相关信息": "Retrieve related information of a specified person from external user fields",
  "获取多条外部人员数据%03054": "Get multiple external personnel data",
  "从当前应用的所有外部用户中获取一名指定人员的相关信息": "Obtain relevant information of a specified individual from all external users of the current application",
  "从当前应用的所有外部用户中获取批量用户的相关信息": "Get batch user information from all external users of the current application",
  "从外部用户字段获取批量用户的相关信息": "Retrieve bulk user information from external user fields",
  "了解这些动作": "Learn about these actions",
  "拥有成员管理权限才可以添加": "Only members with management permissions can add",
  "运行版本": "Running Version",
  "查看当前代码脚本的": "View the current code script",
  "可在审批步骤节点中配置更新数据": "Configuration of data updates can be done at the approval step nodes",
  "如何设置？": "How to set up?",
  "旧%03089": "Old",
  "自定义节点": "Custom Node",
  "将代码处理步骤封装为工作流节点，可以在组织内使用或上架到应用市场": "Encapsulate the code processing steps as workflow nodes, which can be used within the organization or listed in the app marketplace",
  "去插件中心添加": "Add to Plugin Center",
  ...
  "用于在邮件节点中插入动态值时指代当前节点，比使用节点ID更有辨识度。节点别名仅允许使用字母（不区分大小写）、数字和下划线组合，且必须以字母开头，不可重复。": "This is used to refer to the current node when inserting dynamic values in email nodes, making it more identifiable than using the node ID. Node aliases are only allowed to use a combination of letters (case insensitive), numbers, and underscores, and must start with a letter; they cannot be duplicated.",
  "请输入正确的别名": "Please enter a valid alias",
  "复制整个分支": "Copy Entire Branch",
  "编辑节点别名和说明": "Edit node alias and description",
  ...
  "%0 模型按 %1元 / 1K tokens 计费，直接从组织账户余额中扣除": "The %0 model is billed at %1 per 1K tokens, directly deducted from the organization's account balance.",
  "扣费说明": "Deduction Instructions",
  "提示词模板": "Prompt Template",
  "本次测试消耗 %0 tokens， 计费 %1 元": "This test consumed %0 tokens, billed %1 yuan",
  "提示词": "Prompt",
  "系统消息模板": "System Message Template",
  "温度": "Temperature",
  "给AI模型设置提示词，可引用其他节点动态值。": "Set prompt words for the AI model, you can reference dynamic values from other nodes.",
  "AI 测试数据": "AI Test Data",
  "告诉AI模型在生成响应时应该如何行为以及需要参考的任何上下文。你可以描述助手的个性，告诉它应该回答什么和不应该回答什么，并告诉它如何格式化响应。系统消息将按所消耗token数进行计费。": "Tell the AI model how it should behave when generating responses and any context it should reference. You can describe the assistant's personality, tell it what to respond to and what not to respond to, and instruct it on how to format the response. System messages will be billed based on the number of tokens consumed.",
  "值在0到1之间，控制随机性。降低温度意味着模型将产生更多重复和确定性的响应。增加温度会导致更多意外或创造性的响应。": "The value is between 0 and 1, controlling randomness. Lowering the temperature means the model will generate more repetitive and deterministic responses. Increasing the temperature will result in more unexpected or creative responses.",
  "向指定手机号发送短信邀请用户注册外部门户，并在外部门户下自动创建一条对应的用户数据（成员状态为“未激活”）。": "Send a text message to the specified phone number inviting the user to register for the external portal, and automatically create a corresponding user record (member status as 'inactive') under the external portal.",
  "传入 JSON 对象数组格式的会话历史，将有助于AI理解上下文并进行连续对话。会话历史将按所消耗 token 数进行计费。": "Passing in a session history in JSON object array format will help AI understand the context and engage in continuous dialogue. The session history will be billed based on the number of tokens consumed.",
  "会话历史": "Conversation History",
  "数据对象参数": "Data Object Parameters",
  "定义输出数据对象的参数，参数名称只能是英文、数字和下划线。参数名称和说明需要含义清晰以便 AI 识别。": "Define the parameters of the output data object. Parameter names can only contain letters, numbers, and underscores. Parameter names and descriptions should be clear in meaning for AI recognition.",
  "其它应用下的工作表": "Worksheets under other applications",
  "创建一个系统内日程。可同时生成一个ICS文件在其他节点中使用": "Create a schedule within the system. An ICS file can be generated simultaneously for use in other nodes.",
  "短信%0/条，将自动从企业账户扣除。": "SMS %0/message will be automatically deducted from the corporate account.",
  "仅生成一个日程ICS文件，在发送邮件等节点中作为附件使用。通过此文件可添加日程到个人日历": "Only generate an ICS file for the schedule, to be used as an attachment in email sending and other nodes. This file can be used to add the schedule to the personal calendar.",
  "邀请方式": "Invitation Method",
  "工作表无效或已删除": "Worksheet is invalid or has been deleted",
  "填充用户信息": "Fill in user information",
  "基于多条数据邀请多名用户": "Invite multiple users based on multiple data points",
  "项目无效或已删除": "The project is invalid or has been deleted",
  "选择项目": "Select Project",
  "基于多条记录逐条新增记录": "Add records one by one based on multiple records",
  "新增一条记录": "Add a new record",
  "根据此字段发送邀请短信，短信%0/条": "Send invitation SMS based on this field, %0 SMS/messages",
  ...
  "当前流程中的节点对象": "Node object in the current process",
  "彻底删除记录，不放入回收站": "Permanently delete the record without sending it to the recycle bin",
  "彻底删除后数据不可恢复，请谨慎操作": "Once deleted, data cannot be recovered. Please proceed with caution.",
  "选择校准对象": "Select Calibration Object",
  "基于一种获取方式，通过筛选条件和排序规则获得符合条件的唯一数据，供流程中的其他节点使用。": "Based on a method of acquisition, obtain unique data that meets the criteria through filtering conditions and sorting rules for use by other nodes in the process.",
  "选择关联类型字段": "Select association type field",
  "选择获取对象": "Select Target Object",
  "设置筛选条件，查找满足条件的数据。如果未添加筛选条件则表示只通过排序规则从所有记录中获得唯一数据": "Set filter conditions to find data that meets the criteria. If no filter conditions are added, it means to obtain unique data from all records only by sorting rules.",
  "系统将输出此字段中所关联的第一条记录，供流程中其他节点使用": "The system will output the first associated record in this field for use by other nodes in the process.",
  "减少": "Reduce",
  "增加": "Add",
  "当查找到多个数据时，将按照以下排序规则获得第一条数据。如果未设置规则，按照字段配置的排序规则返回第一条数据": "When multiple records are found, the first record will be obtained according to the following sorting rules. If no rules are set, the first record will be returned based on the sorting rules configured for the fields.",
  "刪除": "Delete",
  ...
  "（获取人员数据节点）": "Please retrieve personnel data node",
  "选择更新对象": "Select Update Object",
  "必须先选择一个对象后，才能设置可执行的动作": "You must select an object first before you can set executable actions.",
  ...
  "更换为新的工作表后，所有相关节点配置的字段都将被重置，你需要重新配置这些节点。请确认你需要执行此操作": "After switching to a new worksheet, all fields configured in related nodes will be reset, and you will need to reconfigure these nodes. Please confirm if you want to proceed with this action.",
  ...
  "重新发送请求获取 Access Token": "Resend the request to obtain Access Token",
  ...
  "第6层级": "Level 6",
  "指定节点": "Specify Node",
  "仅上一个节点": "Only the previous node",
  "退回设置": "Return Settings",
  "仅发起节点": "Initiate Node Only",
  "必须指定节点": "A node must be specified",
  "处理完成后": "After processing is complete",
  "最高层级": "Highest Level",
  "用户自由输入": "Users can input freely",
  "无可退回的节点": "Irreversible Node",
  "允许退回的节点": "Allowable Rejection Node",
  "已通过%0": "Approved by %0",
  "{记录名称}：{记录标题}，": "{Record Name}: {Record Title},",
  "于%0被否决": "Denied on %0",
  "设为默认值": "Set as Default",
  "拖拽调整排序": "Drag to adjust order",
  "第3层级": "Level 3",
  ...
  "第19层级": "Level 19",
  "第18层级": "Level 18",
  "向上2级": "Upward 2 Levels",
  "向上1级": "Upward 1 Level",
  "向上3级": "Upward 3 Levels",
  "向上4级": "Upward 4 Levels",
  "向上7级": "Upward 7 Levels",
  "向上6级": "Upward 6 Levels",
  "向上5级": "Upward 5 Levels",
  "向上9级": "Upward 9 Levels",
  "向上8级": "Upward 8 Levels",
  "向上11级": "Upward 11 Levels",
  "向上12级": "Upward 12 Levels",
  "向上14级": "Upward 14 Levels",
  "向上10级": "Upward 10 Levels",
  "向上13级": "Upward 13 Levels",
  "向上15级": "Upward 15 Levels",
  "向上19级": "Upward 19 Levels",
  "向上18级": "Upward 18 Levels",
  "向上16级": "Upward 16 Levels",
  "向上17级": "Upward 17 Levels",
  ...
  "的直接部门负责人": "direct department head",
  "审批终点": "Approval Endpoint",
  "仅主部门负责人需要审批": "Only the head of the main department needs to approve",
  "通讯录指定层级": "Directory Designated Level",
  "起点向上的级数": "The series of ascending points",
  "直到通讯录的最高级": "Until the highest level of the address book",
  "会签（需所有审批人通过）": "Co-signature (requires approval from all approvers)",
  "或签（一名审批人通过或否决即可）": "Or Sign (One approver can approve or reject)",
  "会签（只需一名审批人通过，否决需全员否决）": "Co-signing (Only one approver is needed to pass, all must deny for a rejection)",
  ...
  "及以上的成员通过后即视为节点通过": "Once members above have passed, the node is considered passed",
  "会签（按比例投票通过）": "Co-signing (Approved by proportionate voting)",
  "多人审批时采用的审批方式": "Approval method used in multi-person approval",
  "通过比例": "By Ratio",
  "用户可选": "User selectable",
  "通过后加签": "Add signature later",
  "数据更新": "Data Update",
  "审批设置": "Approval Settings",
  "审批人操作": "Approver Actions",
  "可加签给：": "Add a signature to:",
  "可转审给：": "Transferable to:",
  "加签方式": "Approval Method",
  "添加转审候选人": "Add Transfer Review Candidates",
  "添加候选人": "Add Candidate",
  "可添加：": "Addable:",
  "审批人为空时": "When the approver is empty",
  "添加加签候选人": "Add signatory candidate",
  ...
  "通过时通知": "Notification upon time",
  "否决时通知": "Notification on Rejection",
  "流程进入此节点且审批开始前，更新数据对象的字段值（退回至此节点也会触发更新）": "Before the workflow reaches this node and the approval begins, update the field values of the data object (returning to this node will also trigger the update)",
  "二级：实名+实人+网证（开发中...）": "Level 2: Real Name + Real Person + Online Certificate (in development...)",
  "默认消息内容": "Default message content",
  "否决/退回时，无需填写表单字段": "No need to fill out form fields when rejected/returned",
  ...
  "否决/退回时填写": "Fill in when rejected/returned",
  "通过时填写": "Fill in when",
  "节点结果通知发起人": "Notify the initiator of the node result",
  "通过时必须认证": "Authentication is required during access",
  "会签节点多人审批时和逐级审批时，在每个审批人处理后更新": "When multiple approvals are required at a co-signing node and during hierarchical approvals, update after each approver processes.",
  "认证等级": "Certification Level",
  "（用户自由输入）": "(User input)",
  "审批说明": "Approval instructions",
  "意见模板：": "Feedback Template:",
  "否决/退回时必须认证": "Approval is required for rejection/return",
  "退回按钮": "Return Button",
  "否决按钮": "Reject Button",
  "通过按钮": "Through Button",
  "意见模板": "Feedback Template",
  "必须先选择一个对象后，才能设置字段权限": "You must select an object first before you can set field permissions",
  "设置审批时可以查看、编辑、必填的字段。设为摘要的字段可以在流程待办列表和邮件通知中直接显示，使审批人无需打开详情即可快速完成审批。": "When setting up approvals, you can view, edit, and specify required fields. Fields set as summaries can be displayed directly in the pending task list and email notifications, allowing approvers to quickly complete their approvals without opening the details.",
  "预置常用的意见作为模板，帮助审批人快捷填写": "Predefined common comments as templates to help approvers fill out quickly",
  ...
  "通过时的模板": "Template for When",
  "日期不能为空": "Date cannot be empty",
  "设置筛选条件后，满足条件的数据才能进入该分支": "After setting the filtering conditions, only the data that meets the conditions can enter this branch.",
  "代码块必填": "Code block required",
  "实际运行时停留的秒钟数可能比设置的时间略长": "The actual seconds spent during execution may be slightly longer than the set time.",
  "时间不能为空": "Time cannot be empty",
  "代码片段不允许为空": "Code snippet cannot be empty",
  "请运行代码块以获得output对象; input对象将采用测试数据": "Please run the code block to obtain the output object; the input object will use test data",
  ...
  "代码错误": "Code Error",
  "代码块整体运行失败时自动重试": "Automatically retry when the code block fails to run entirely",
  ...
  "新版发送记录可以选择一个视图，按照所选视图配置的显示字段发送。如果通知人分发了此视图，可以直接按权限编辑记录、执行自定义动作。": "The new version of the send record allows you to select a view and send it according to the display fields configured in the selected view. If the notifier distributed this view, they can directly edit records and execute custom actions according to permissions.",
  ...
  "按照所选视图配置的显示字段发送，如果通知人被分发了此视图，可以直接按权限编辑记录、执行自定义动作": "Send the displayed fields configured according to the selected view. If the notifier has been distributed this view, they can directly edit records and execute custom actions according to their permissions.",
  "抄送人": "Cc Recipient",
  "视图无效或已删除": "View is invalid or has been deleted",
  "显示待办/记录标题": "Show To-Do/Record Title",
  "通知内容": "Notification Content",
  "添加抄送人": "Add CC Recipient",
  "可不设，默认显示记录标题。设置后，显示设置的通知内容和记录标题（可选）": "Can be left unset, default shows the record title. After setting, it displays the configured notification content and record title (optional)",
  ...
  "抄送设置": "CC Settings",
  "标准（支持抄送，每个收件人都可以看到所有收件人和抄送人）": "Standard (supports CC, each recipient can see all recipients and CCs)",
  "群发单显（采用一对一单独发送，每个收件人只能看到自己的地址）": "Batch message display (using one-on-one separate sending, each recipient can only see their own address)",
  ...
  "点击复制节点对象代码，粘贴到需要的位置": "Click to copy the node object code and paste it where needed",
  "选择人员、邮箱地址或输入邮箱": "Select personnel, email address or enter email",
  "非法文件名": "Illegal File Name",
  "没有可用的节点对象": "No available node object",
  "没有可用的字段": "No available fields",
  "将记录转为PDF、Word或Excel文件，可以通过新增记录、更新记录或发送邮件节点将文件写入附件。注：文档大小不得超过100M，作为邮件附件发送时不得超过10M。": "Convert records to PDF, Word, or Excel files, and write the files to attachments through the add record, update record, or send email nodes. Note: The document size must not exceed 100M, and must not exceed 10M when sent as an email attachment.",
  ...
  "打印对象": "Print Object",
  "系统默认使用记录标题作为文件名，自定义名称时不得包含英文字符/:*?\"<>|": "The system uses the record title as the default file name. Custom names must not include English characters/:*?\"<>|.",
  "同时生成PDF文件": "Generate PDF files simultaneously",
  "生成PDF文件是由WPS提供的第三方服务，收费标准为%0/次，转换失败的文件将不收取费用。": "Generating PDF files is a third-party service provided by WPS, with a fee of %0 per conversion. Files that fail to convert will not incur any charges.",
  ...
  "函数有误": "Function error",
  "对 数值/金额 等字段进行数学运算": "Perform mathematical operations on fields such as numbers/amounts",
  "函数不能为空": "Function cannot be empty",
  "英文输入+、-、*、/、( ) 进行运算 或": "Enter +, -, *, /, ( ) for calculations or",
  "年：Y（大写）": "Year: Y (uppercase)",
  "参与计算的字段值为空时，视为0": "When the value of the field involved in the calculation is empty, it is considered 0",
  "输入日期/时间字段": "Input Date/Time Field",
  "月：M（大写）": "Month: M (uppercase)",
  "添加公式": "Add Formula",
  "设置参与运算时的日期格式": "Set the date format for calculations participation",
  "如：SUM(1, 2, 3)*3，多个数值请使用英文逗号分隔": "For example: SUM(1, 2, 3)*3, please separate multiple values with commas",
  "运算结果类型": "Result Type",
  "位": "Position",
  "如：可以将 2008/11/11 12:23 格式化为“日期”，以2008/11/11参与运算。+8h后，得到时间结果：2008/11/11 8:00": "For example: You can format 2008/11/11 12:23 as a \\\"date\\\" to participate in calculations using 2008/11/11. After adding +8h, the resulting time will be: 2008/11/11 8:00",
  ...
  "设置筛选条件，获得满足条件的数据。如果未设置筛选条件，则获取所有数据": "Set filter conditions to obtain data that meets the criteria. If no filter conditions are set, all data will be retrieved.",
  "显示格式": "Display Format",
  "结果小数点后保留": "Keep decimal places in the results",
  ...
  "从记录获取关联记录": "Get related records from record",
  ...
  "JSON 解析器可以把 发送 API 请求 节点或者 代码块 节点中输出的 JSON 对象解析为后续节点可直接使用的变量和数组参数。": "The JSON parser can parse the JSON objects outputted from the Send API Request node or Code Block node into variables and array parameters that can be directly used by subsequent nodes.",
  ...
  "没有可以用来解析的流程参数": "There are no process parameters available for parsing",
  ...
  "设置筛选条件，获得满足条件的数据。如果未添加筛选条件，则只从字段中获得第一名外部用户的相关信息": "Set filtering criteria to obtain data that meets the conditions. If no filtering criteria are added, only the relevant information of the first external user from the fields will be obtained.",
  ...
  "设置筛选条件，获得满足条件的数据。如果未添加筛选条件，则只从字段中获得第一名人员的相关信息": "Set filter criteria to obtain data that meets the conditions. If no filter criteria are added, only the relevant information of the first person from the fields will be obtained.",
  "从组织人员中获取": "Retrieve from organizational personnel",
  "设置筛选条件，获得满足条件的数据。如果未添加筛选条件，则只从当前组织的所有人员中获得第一名（最新入职）人员的相关信息": "Set filter conditions to obtain data that meets the criteria. If no filter conditions are added, only the relevant information of the first (newest hire) person from all staff in the current organization will be retrieved.",
  ...
  "设置筛选条件，获得满足条件的数据。如果未添加筛选条件，则获得所有来自该字段的部门的相关信息": "Set filter conditions to get data that meets the criteria. If no filter conditions are added, all relevant information from the departments in that field will be obtained.",
  "从组织部门中获取": "Obtain from organizational departments",
  "设置筛选条件，获得满足条件的数据。如果未添加筛选条件，则获得所有来自该字段的外部用户的相关信息": "Set filter conditions to obtain data that meets the criteria. If no filter conditions are added, all relevant information from external users in that field will be obtained.",
  "设置筛选条件，获得满足条件的数据。如果未添加筛选条件，则只从当前应用的所有外部用户中获得第一名（最新注册）人员的相关信息": "Set filter criteria to obtain data that meets the conditions. If no filter criteria are added, only the relevant information of the first (most recently registered) person among all external users of the current application will be obtained.",
  ...
  "获取一名人员的相关信息，包含个人信息（姓名、性别、生日、手机、邮箱）和组织信息（部门、职位、工号、上下级（可选）），供流程中的其他节点使用。": "Obtain relevant information about a person, including personal information (name, gender, birthday, mobile, email) and organizational information (department, position, employee number, superior/subordinate (optional)), for use by other nodes in the process.",
  ...
  "获取一名外部用户的相关信息，包含用户名、手机号、角色、用户状态、openid和自定义字段，供流程中的其他节点使用。": "Obtain relevant information of an external user, including username, phone number, role, user status, openid, and custom fields, for use by other nodes in the process.",
  ...
  "在筛选条件的基础上，随机获取一个": "Randomly retrieve one based on the filter criteria",
  "没有搜索到\"": "No results found\\\"",
  ...
  "获取汇报关系": "Obtain Reporting Relationship",
  "同时获取人员的汇报关系信息": "Simultaneously retrieve personnel reporting relationship information",
  ...
  "包含人员的直属上司、直接下属、所有下属；如果您的使用场景无需汇报关系相关信息，推荐不勾选以提升您的查询效率": "Includes direct supervisors, direct subordinates, and all subordinates; if your usage scenario does not require reporting relationship-related information, it is recommended not to check this option to improve your query efficiency.",
  "根据当前流程节点中的记录对象，生成特定的对外分享链接。可以通过在邮件、短信的正文里引用此节点，邀请外部用户查看或填写指定的记录。": "Generate a specific external sharing link based on the record object in the current process node. You can invite external users to view or fill out the specified record by referencing this node in the body of an email or SMS.",
  ...
  "链接名称（仅用于发送邮件时）": "Link Name (Used Only for Sending Emails)",
  "设置链接有效期": "Set Link Expiration",
  "指定的日期时间": "Specified date and time",
  "指定时长": "Specified Duration",
  ...
  "短信%0/条，自动从企业账务中心扣费。70字计一条短信，超过70字以67字每条计费。每个标点、空格、英文字母都算一个字。短信实际发送可能有10-20分钟的延时。": "Text message %0/message, automatically charged from the enterprise billing center. 70 characters count as one message, and any characters over 70 will be charged at a rate of 67 characters per message. Each punctuation mark, space, and English letter counts as one character. There may be a delay of 10-20 minutes in the actual sending of the text message.",
  "类型：": "Type:",
  ...
  "一般性通知。如验证码短信、通知短信、物流快递短信、订单短信": "General notifications, such as verification code SMS, notification SMS, logistics and express SMS, order SMS",
  "如：促销、优惠、活动报名等产品推广和品牌宣传类短信；系统将自动为此类短信末尾附加【退订】字样": "For example: promotional, discount, event registration, and other product promotion and brand advertising SMS; the system will automatically append the text【Unsubscribe】 at the end of such SMS.",
  ...
  "为保证短信的稳定推送，以下内容须审核后才能使用。多于70字（含签名）的短信按67字每条计费": "To ensure stable SMS delivery, the following content must be reviewed before use. Messages longer than 70 characters (including signature) are charged at 67 characters per message.",
  "请谨慎选择您的短信类型，后续如果在发送时出现实际类型不符合预设类型的，可能面临模版被停用的风险": "Please carefully select your SMS type. If the actual type does not match the preset type when sending, you may face the risk of the template being disabled.",
  ...
  "审核时间约为1小时，非工作时间提交审核会延长": "The review time is approximately 1 hour. Submissions made during non-working hours will extend the review time.",
  "已审核模板": "Approved Template",
  "这些是您短信模板中使用到的动态值，请给出范例数据用于人工审核时验证您的短信类型": "These are the dynamic values used in your SMS templates. Please provide example data for manual review to verify your SMS type.",
  ...
  "将通过明道云系统消息发送": "Will be sent through the Mingdao Cloud system message",
  ...
  "其它应用下的自定义页面": "Custom Pages under Other Applications",
  ...
  "按照所选视图配置的显示字段发送，如果操作者被分发了此视图，可以直接按权限编辑记录、执行自定义动作": "Send the displayed fields configured according to the selected view; if the operator has been assigned this view, they can directly edit records and perform custom actions according to permissions.",
  ...
  "在顶部显示并自动消失。用于一句话的简短提示": "Displayed at the top and automatically disappears. Used for a brief one-sentence tip",
  ...
  "打开新页面": "Open New Page",
  "在底部显示并可设为不自动消失。可包含标题、描述、按钮，适合较多文字或带有操作的通知": "Displayed at the bottom and can be set to not disappear automatically. Can include a title, description, and button, suitable for notifications with a lot of text or actions.",
  ...
  "卡片按钮": "Card Button",
  "推送内容": "Push Content",
  "提示类型": "Notification Type",
  "按钮%0": "Button %0",
  "触发按钮后，直接推送指定内容给按钮操作者。不能是一个延时反馈（该节点与触发器之间不能有延时、人工和子流程节点）如果流程执行中触发了多个界面推送节点，只生效第一个": "After triggering the button, directly push the specified content to the button operator. It cannot be a delayed feedback (there cannot be any delay, manual intervention, or sub-process nodes between this node and the trigger). If multiple interface push nodes are triggered during the execution of the process, only the first one will take effect.",
  "创建草稿记录": "Create Draft Record",
  "指定时间后": "After a specified time",
  "永不，需要手动关闭": "Never need to close manually",
  "自动消失": "Automatically Disappear",
  "必须选择一个目标工作表": "You must select a target worksheet",
  "选择多条数据节点": "Select multiple data nodes",
  "从工作表中通过筛选条件和排序规则直接删除符合条件的唯一数据": "Directly delete the unique data that meets the criteria from the worksheet through filtering conditions and sorting rules.",
  ...
  "根据筛选条件和排序规则从工作表中查找符合条件的第一条数据，并在获取的同时对记录进行更新（原子性防止并发操作，适用于出入库等场景）": "Find the first data that meets the criteria in the worksheet based on the filtering conditions and sorting rules, and update the record at the same time when retrieving it (atomicity prevents concurrent operations, suitable for scenarios such as inventory in and out)",
  "使用记录更新前的数据": "Use records to update data before",
  "执行到本节点时保存该记录更新前的数据，供流程中的其他节点使用": "When reaching this node, save the data prior to updating the record for use by other nodes in the process.",
  "使用记录的最新数据": "Use the latest data from the record",
  "每次其他节点使用到本节点数据时，重新获取该记录的最新数据": "Every time other nodes use the data from this node, retrieve the latest data for that record again",
  ...
  "删除前保留记录数据，供之后的流程节点使用": "Keep record data before deletion for use in subsequent process nodes",
  ...
  "当查找到多个数据时，将按照以下排序规则获得第一条数据。": "When multiple data points are found, the first data point will be obtained according to the following sorting rules.",
  "必须选择一个自定义页面": "You must select a custom page",
  "当前流程节点中的文本类型字段，系统将根据此链接获取相应的记录，供流程中其他节点使用": "In the current process node, the text type field will allow the system to fetch the corresponding records based on this link for use by other nodes in the process.",
  ...
  "预计解析出的记录归属的工作表": "Expected worksheet for the parsed records",
  ...
  "等待页面加载一段时间后再开始截图。当截取页面未完全加载时，可适当延长时间。单位秒，默认60秒。": "Wait for the page to load for a while before starting the screenshot. If the page is not fully loaded when capturing, you can extend the time appropriately. Unit is seconds, default is 60 seconds.",
  "多个数据对象将同时执行各自的流程。即便某条子流程运行中止，也不影响其他子流程的执行。": "Multiple data objects will execute their respective processes simultaneously. Even if a sub-process is interrupted, it will not affect the execution of other sub-processes.",
  "等待时长": "Waiting Time",
  "页面宽度": "Page Width",
  "页面高度": "Page Height",
  "逐条执行，中止时不再触发后续子流程": "Execute step by step; subsequent sub-processes will not be triggered when interrupted",
  "如果某条子流程运行中止，则跳过该条继续执行下一条子流程": "If a sub-process is halted, skip it and continue executing the next sub-process.",
  ...
  "勾选后，当子流程数据源为工作表多条数据对象时，所有符合筛选条件的记录都将进入子流程，并忽略数据对象节点配置的排序规则和限制数量": "After checking, when the data source of the sub-process is multiple data objects from the worksheet, all records that meet the filtering criteria will enter the sub-process, ignoring the sorting rules and quantity constraints configured for the data object nodes",
  "多条数据执行方式": "Multiple Data Execution Methods",
  "行（最大 100 万行）": "Rows (up to 1 million)",
  "您选择了多条数据对象，将根据数据的条数执行多条子流程": "You have selected multiple data objects, and multiple sub-processes will be executed based on the number of data entries.",
  "选择已有流程": "Select Existing Process",
  "节点保存后，将自动创建一个新的子流程": "After the node is saved, a new sub-process will be automatically created",
  "未开启": "Not enabled",
  "勾选后，当子流程数据源为单条对象，之后节点可使用子流程中的参数": "After selecting, when the data source of the sub-process is a single object, the subsequent nodes can use parameters from the sub-process.",
  ...
  "生成初始七次的执行时间": "Generate the initial execution time for seven instances",
  ...
  "每月都触发": "Triggered monthly",
  "分开始，每隔": "Starts in minutes, every interval",
  "输入范围": "Input Range",
  "时开始，每隔": "starts at intervals of",
  "每小时": "Every hour",
  ...
  "在节点、API调用时使用的参数名称，如：phone。未填写时，使用字段名": "Parameter names used when calling nodes or APIs, such as: phone. If not filled in, use the field name",
  "选项名和选项值不能为空": "Option name and option value cannot be empty",
  "选项值": "Option Value",
  "在用户输入时字段的显示名称。如：请输入手机号": "The display name of the field when the user is inputting. For example: Please enter your phone number",
  "添加默认值，如果用户未输入或映射任何数据，则使用此内容": "Add default value. If the user has not entered or mapped any data, use this content",
  "为用户输入此参数时提供必要的帮助说明": "Provide necessary assistance instructions when users input this parameter",
  ...
  "当新增记录时触发流程": "Trigger process when adding a record",
  ...
  "向URL发送请求测试获取参数列表；请求中的动态参数将取测试值": "Send a request to the URL to test and retrieve the parameter list; dynamic parameters in the request will take test values",
  ...
  "设置筛选条件，仅使满足条件的记录进入流程。": "Set filter criteria so that only records that meet the conditions enter the process.",
  "当记录满足以下条件时进入流程": "Enter the process when the record meets the following conditions",
  "输入参数不允许为空": "Input parameters cannot be empty",
  "某些第三方平台需要设置白名单 IP 才能调用API，以下是系统使用的 IP 地址": "Certain third-party platforms require setting a whitelist IP to call the API. Below are the IP addresses used by the system.",
  "编辑 API 测试数据": "Edit API Test Data",
  "可信 IP 地址": "Trusted IP Address",
  "查看发送数据的": "View Sent Data",
  ...
  "将向对应的HTTP地址发送请求；URL后面可以拼接参数": "A request will be sent to the corresponding HTTP address; parameters can be appended to the URL.",
  "API URL （必填）": "API URL (Required)",
  "需要管理员在「组织管理-安全-数据」中配置}": "The administrator needs to configure in \"Organization Management - Security - Data\"",
  "请求时长": "Request Duration",
  "请求失败设置": "Request Failed Settings",
  "开启SSL证书验证": "Enable SSL Certificate Verification",
  "超时自动重试（最多重试2次）": "Automatic retry on timeout (up to 2 retries)",
  ...
  "指定 HTTP 状态码错误消息": "Specify HTTP status code error message",
  ...
  "指定填写人": "Specify Filler",
  "转交他人填写": "Delegate to others for filling",
  "填写人为空时": "When the filler is empty",
  "可转交给：": "Transferable to:",
  ...
  "云端": "Cloud",
  "搜索数据源名称、地址": "Search data source name, address",
  "创建于 %0": "Created on %0",
  ...
  "作为": "As",
  "保存密码后将加密存储，不可查看密码原文": "Passwords will be stored encrypted and cannot be viewed in plain text.",
  ...
  "已同步(增/改/删)": "Synchronized (Add/Modify/Delete)",
  "数据库表": "Database Table",
  ...
  "在 SQL Server 的菜单中找到\"帮助-版本\"，点击查看对应版本信息。": "In the SQL Server menu, find \\\"Help - Version\\\" and click to view the corresponding version information.",
  "Output 示例：output = {output: \"hello world\" };": "Output example: output = {output: \\\"hello world\\\" };",
  "注：此方式最多获取1000条关联记录，如果需要获取更多数据，请使用“从工作表获取记录”的方式。": "Note: This method can retrieve a maximum of 1,000 associated records. If you need to obtain more data, please use the \\\"Get Records from Worksheet\\\" method.",
  ...
  "创建连接过程出现SSL验证报错，可尝试在 其他连接串参数 增加如下配置": "An SSL verification error occurred during the connection process. You can try adding the following configuration in other connection string parameters.",
  ...
  "全部任务": "All Tasks",
  "截止到指定日期对项目下所有未完成的任务总数统计，包括正常未完成（未设置截止时间的任务视为正常未完成的任务）和逾期任务": "Statistics of the total number of unfinished tasks under the project by the specified date, including normal unfinished tasks (tasks without a deadline are considered normal unfinished tasks) and overdue tasks",
  "未完成逾期的总任务数": "Total number of overdue tasks not completed",
  "此项目下正在未完成的任务数": "Number of incomplete tasks under this project",
  "未完成任务逾期的总时间向下取整，不足1天的显示0天。如：3个未完成任务逾期时间累计为15小时，则显示总逾期0天，若累计为26小时，则显示总逾期1天，以此类推": "The total time for overdue incomplete tasks is rounded down, displaying 0 days if less than 1 day. For example: If the cumulative overdue time for 3 incomplete tasks is 15 hours, it will display a total overdue of 0 days. If the cumulative time is 26 hours, it will display 1 day overdue, and so on.",
  "逾期任务数": "Overdue Tasks Count",
  "逾期时间": "Overdue Time",
  "此项目下已经完成的任务数": "Number of tasks completed under this project",
  "已完成的任务中逾期的总完成的任务数": "Total number of completed tasks that are overdue among completed tasks",
  "已完成任务逾期的总时间向下取整，不足1天的显示0天。如：3个进行中任务逾期时间累计为15小时，则显示总逾期0天，若累计为26小时，则显示总逾期1天，以此类推": "The total time of overdue completed tasks is rounded down, and if it is less than 1 day, it displays as 0 days. For example, if the cumulative overdue time for 3 ongoing tasks is 15 hours, it will display a total overdue of 0 days; if it is 26 hours, it will display a total overdue of 1 day, and so on.",
  ...
  "截止到指定日期，统计项目下所有进行中的任务数（起止时间都未设置的视为进行中），包括未设置的、正常和逾期未完成的任务": "As of the specified date, count all ongoing tasks under the project (tasks without start and end dates are considered ongoing), including those not set, normal, and overdue incomplete tasks.",
  "截止到指定日期对项目下所有已完成的任务总数统计，包括按时完成（未设置截止时间的任务视为按时完成）和已逾期任务": "Statistics of the total number of completed tasks under the project as of the specified date, including on-time completion (tasks without a set deadline are considered on-time) and overdue tasks.",
  ...
  "逾期时间（天）": "Overdue Time (Days)",
  "进行中（个）": "In Progress (Units)",
  "截止到指定日期对项目下所有任务的总逾期时间统计，包含：总逾期/进行中/已完成3个维度。时间向下取整，不足1天的显示0天。例如：3个任务分别逾期 20、40、60小时，各个任务中分别显示其逾期 20小时、1天、2天，累计逾期120小时，显示为总逾期5天": "Statistics of total overdue time for all tasks under the project until the specified date, including three dimensions: total overdue/in progress/completed. Time is rounded down, with less than 1 day displayed as 0 days. For example, if three tasks are overdue by 20, 40, and 60 hours respectively, each task will display its overdue time as 20 hours, 1 day, and 2 days. The cumulative overdue time is 120 hours, displayed as a total overdue of 5 days.",
  "项目趋势（个）": "Project Trends (Count)",
  "未完成任务剩余时间（小时）": "Remaining time for incomplete tasks (hours)",
  ...
  "逾期任务数（个）": "Overdue Tasks (Count)",
  "截止到目前为止任务负责人按时完成任务数统计": "Statistics of tasks completed on time by responsible persons up to now",
  "截止到目前为止任务负责人负责的任务逾期时间统计，包含进行中和已完成的逾期时间，向下取整。如：3个进行中任务逾期时间累计为15小时，则显示总逾期0天，若累计为26小时，则显示总逾期1天，以此类推": "The overdue time statistics for tasks managed by the task owner up to now, including both ongoing and completed overdue times, rounded down. For example: If the cumulative overdue time for 3 ongoing tasks is 15 hours, it will display a total overdue of 0 days; if the cumulative is 26 hours, it will display a total overdue of 1 day, and so on.",
  "截止到目前为止任务负责人负责的任务逾期数统计，包含未完成和已完成的任务": "Statistics of overdue tasks handled by the task owner so far, including both incomplete and completed tasks",
  "截止到目前为止各个项目看板下未完成和已完成的任务数量统计": "Statistics of incomplete and completed tasks under various project dashboards up to now",
  "截止到目前为止任务负责人平均完成任务的时间统计，向下取整。如：3个进行中任务逾期时间累计为15小时，则显示总逾期0天，若累计为26小时，则显示总逾期1天，以此类推": "As of now, the average completion time statistics for task owners are rounded down. For example: If there are 3 ongoing tasks with a total overdue time of 15 hours, it will show a total overdue of 0 days. If the total overdue time is 26 hours, it will show 1 day overdue, and so on.",
  ...
  "动态转为的任务": "Dynamic Conversion Tasks",
  "所属组织：%0": "Affiliated Organization: %0",
  ...
  "即将开始": "Starting Soon",
  "%0年后开始": "Start after %0 years",
  "%0小时后开始": "Starts in %0 hours",
  "即将截止": "Upcoming deadline",
  "还剩%0个月": "%0 months remaining",
  "还剩%0天": "%0 days left",
  "%0个月后开始": "Starts in %0 months",
  "还剩%0年": "%0 years remaining",
  ...
  "请选择子表": "Please select a sub-table",
  "没有返回参数, 请检查模版配置": "No return parameters, please check the template configuration",
  "映射规则": "Mapping Rules",
  "请选择子表中的字段": "Please select fields from the sub-table",
  "选择文本，或子表字段": "Select text or subtable field",
  ...
  "按查询工作表": "Query Worksheet",
  "将返回数据作为下拉框选项": "Use returned data as dropdown options",
  ...
  "存储字段值": "Store Field Value",
  "静音": "Mute",
  "存储数据后字段可以参与搜索、筛选与导出": "After storing data, fields can participate in search, filtering, and export.",
  ...
  "true（正式）": "true",
  "查看字段环境变量与模拟加载记录的值": "View the field environment variables and simulate loading records' values",
  "运行": "Run",
  ...
  "触发者所在的角色": "Role of the Triggerer",
  "当前用户所在部门": "Current User's Department",
  "触发者所在的部门": "Department of the Triggering Party",
  ...
  "赋分值": "Assign Score",
  "批量添加": "Batch Add",
  "每个选项单列一行，重复选项无法添加（包括不得与回收站重复）": "Each option is listed on a separate line, and duplicate options cannot be added (including those that cannot overlap with the recycle bin)",
  ...
  "选择子表字段": "Select Subtable Field",
  "查询到的每行记录添加为一行子表明细。请选择需要写入的字段。": "Each retrieved record is added as a detail in a sub-table row. Please select the fields to write to.",
  ...
  "当前地点经纬度": "Current Location Longitude and Latitude",
  "限制移动端输入": "Limit mobile input",
  ...
  "自动压缩图片": "Automatic Image Compression",
  ...
  "允许扫描条形码": "Allow scanning of barcode",
  "允许扫描二维码": "Allow scanning QR code",
  ...
  "禁止手动输入": "Manual input is prohibited",
  ...
  "摘要字段（最多3个）": "Summary Field (up to 3)",
  "允许上传": "Allow Upload",
  "当前规则": "Current Rules",
  "允许删除": "Allow deletion",
  "单个文件": "Single File",
  ...
  "单行新增": "Add Row",
  "选择关联记录字段新增": "Select Associated Record Field to Add",
  ...
  "指定字符和之前的字": "Designated characters and previously used words",
  "结尾显示": "End Display",
  ...
  "设置需要显示的字符，其他字符全部显示为掩码": "Set the characters that need to be displayed; all other characters will be shown as masked.",
  ...
  "试一试掩盖效果": "Try the cover effect",
  "虚拟掩码长度": "Virtual Mask Length",
  "掩盖": "Cover",
  "个字": "character",
  "按顺序输入显示的字符，多个使用,隔开。如：a,b,c": "Enter the displayed characters in order, separating multiple with a comma. For example: a, b, c",
  "掩码方式：": "Masking Method:",
  ...
  "经典模式：点整行打开记录": "Classic Mode: Click on a whole row to open the record",
  "树形表格": "Tree Table",
  "未添加关联本表字段": "No associated fields added to this table",
  "选择关联表中的关联本表字段": "Select the corresponding fields from the related table",
  "电子表格模式：点单元格选中字段，按空格键打开记录": "Spreadsheet mode: Click on a cell to select the field, press the space bar to open the record",
  ...
  "不冻结": "Not Frozen",
  "冻结列": "Freeze Column",
  "开启后无论子表中是否存在记录，都会显示固定数量的行数。当子表没有记录时，将显示空白行。": "Once enabled, a fixed number of rows will be displayed regardless of whether there are records in the sub-table. When there are no records in the sub-table, blank rows will be displayed.",
  "最大高度（滚动方式）": "Maximum Height (Scroll Type)",
  "最大高度（每页行数）": "Maximum height (number of lines per page)",
  "限制文件数量": "Limit file quantity",
  "默认空行": "Default empty row",
  ...
  "选择下方常用表达式或自定义输入": "Select from the commonly used expressions below or enter your own",
  "6个字母": "6 letters",
  ...
  "限定金额范围": "Limited Amount Range",
  "自定义日期格式": "Custom Date Format",
  "取消修改": "Cancel Modification",
  "错误时提示": "Error Message",
  "最多": "Maximum",
  "必须选中": "Must be selected",
  "必须开启": "Must be enabled",
  "最少": "Minimum",
  "必须选是": "Must select Yes",
  "忽略业务规则的配置，在所有写入数据的场景中校验必填，包括工作流、批量导入、API写入、数据集成同步等": "Ignore the configuration of business rules and validate required fields in all scenarios of writing data, including workflows, batch imports, API writes, data integration synchronization, etc.",
  ...
  "在下方输入自定义格式，将日期按需要的方式显示": "Enter a custom format below to display the date as needed",
  "选择工作表/自定义页面": "Select Worksheet/Customize Page",
  "查看格式规则": "View Format Rules",
  "绝对值": "Absolute value",
  "选择统计图表": "Select Statistical Chart",
  "求余": "Remainder",
  "预览:  %0": "Preview: %0",
  "求整": "Request Completion",
  ...
  "此刻 减去 目标日期": "Subtract from target date now",
  "目标日期": "Target Date",
  "新建关联": "Create Association",
  "检测到所选表已关联 %0，是否建立": "Detected that the selected worksheet is associated with %0, do you want to establish it?",
  "已有关联": "Already Associated",
  "没有与当前工作表关联的表": "No tables associated with the current worksheet",
  "同步数据？": "Synchronize data?",
  "建立": "Establish",
  "同步数据": "Sync Data",
  "添加关联当前": "Add Related Current",
  "当前字段显示方式为：": "The current field display mode is:",
  "精确搜索": "Precise Search",
  "下拉框；": "Dropdown",
  ...
  "新建查询": "Create Query",
  "用户通过以下字段筛选关联记录": "Users can filter related records by the following fields",
  ...
  "如果您需要复用本流程，通过此操作将为本流程创建一个副本，触发器类型为子流程": "If you need to reuse this workflow, this action will create a copy of it with a trigger type of sub-process.",
  ...
  "定时触发%03012": "Scheduled Trigger",
  "按照设定的时间周期循环触发流程": "Trigger the process in cycles according to the set time period",
  "指定一个日期字段，将字段的日期作为时间表来触发流程。如：指定工作表中的员工生日或客户注册日期来发送短信通知": "Specify a date field and use the date in that field as a timetable to trigger the process. For example: specify the employee birthday or customer registration date in the worksheet to send SMS notifications.",
  ...
  "Webhook触发%03016": "Webhook Trigger",
  "外部用户事件触发%03015": "External User Event Trigger",
  ...
  "短信内容": "SMS content",
  "删除后，工作流中新添加的短信节点将不能在选到此模板，之前已使用此模板的节点不受影响": "After deletion, newly added SMS nodes in the workflow will not be able to select this template; nodes that have previously used this template are not affected.",
  "已选择%0个模板": "%0 templates selected",
  "设置此节点": "Set this node",
  "短信模版可在编辑短信节点时创建": "SMS templates can be created when editing the SMS node",
  "审核状态": "Review Status",
  "营销推广": "Marketing Promotion",
  "行业通知": "Industry Notice",
  "暂停4小时": "Pause for 4 hours",
  "直到手动恢复": "Until manually restored",
  "可恢复60天内删除的工作流": "Recover deleted workflows within 60 days",
  ...
  "当前排队": "Current Queue",
  "当累积排队超过 / 降低到": "When the accumulated queue exceeds / drops to",
  "条时": "time period",
  "排队": "Queue",
  ...
  "设置后，在扣款时若组织账户余额低于预警值则会发送预警给通知人（每天仅发送 1 次预警，若重置预警值则会再次发送）": "After setting, if the organization's account balance is below the warning value during deduction, a warning will be sent to the notifier (only 1 warning will be sent per day, and if the warning value is reset, it will be sent again)",
  ...
  "使用JavaScript语言": "Using JavaScript language",
  "未设置关联他表字段": "No associated field in other tables set",
  ...
  "按部门层级逐级审批": "Approval by department hierarchy",
  ...
  "您确定要删除审批结果分支吗？": "Are you sure you want to delete the approval result branch?",
  ...
  "收件人：": "Recipient:",
  "使用Python语言": "Use Python language",
  "当天": "That Day",
  "秒钟": "second",
  "运算：": "Calculation:",
  ...
  "无主题": "No Subject",
  "选择增补人数": "Select Additional Staff",
  "单月包": "Monthly Package",
  "每月额度升级包": "Monthly Quota Upgrade Package",
  ...
  "%0 W次": "%0 times",
  "%0 W行": "%0 row",
  "本月工作流执行数增加数量": "Number of workflow executions this month increased",
  "每月工作流执行数增加数量": "Monthly workflow execution increase count",
  ...
  "每月执行数免费额度不足时可购买使用，即时生效。": "When the free quota for monthly executions is insufficient, you can purchase additional usage, which takes effect immediately.",
  ...
  "聚合表扩充5个起购": "Aggregate table expands with 5 minimum purchases",
  ...
  "购买后增值服务账户金额：%0 元": "Value-added service account amount after purchase: %0 dollars",
  "本月额度升级包": "This Month's Quota Upgrade Package",
  "%0 人": "%0 people",
  "扩展包": "Extension Package",
  "开启后，当月剩余执行额度为2%时，自动购买100元/1万次的单月包，从账户余额中扣款（开启后仍可以在组织管理后台的工作流处关闭）": "Once enabled, when the remaining execution quota for the month is 2%, automatically purchase a monthly package of $100 for 10,000 times, deducting from the account balance (you can still disable this in the workflow section of the organization management backend after enabling)",
  "计费方式": "Billing Method",
  "开启后，当月剩余执行额度为2%时，自动购买 100元/10万行 的单月包，从账户余额中扣款。（开启后可以在数据集成的同步任务中关闭）": "Once activated, when the remaining execution quota for the month is 2%, automatically purchase the monthly package of 100 RMB/100,000 rows, deducted from the account balance. (It can be turned off in the data integration synchronization task after activation)",
  "生成订单": "Generate Order",
  "确认下单": "Confirm Order",
  "总计：": "Total:",
  "我希望得到销售代表的协助": "I would like assistance from the sales representative",
  "其他金额": "Other Amount",
  "选择充值金额": "Select Recharge Amount",
  "最多充值金额 999999 元": "Maximum recharge amount 999999 yuan",
  ...
  "升级明道云产品": "Upgrade Mingdao Cloud Product",
  ...
  "总计金额": "Total Amount",
  "到期时间:": "Due Date:",
  "短信内容的长度不能超过60个字符": "The length of the SMS content cannot exceed 60 characters",
  "总计金额：": "Total Amount:",
  "购买人数:": "Number of Purchases:",
  ...
  "全组织用户 %0 人": "Total organization users %0",
  "所有部门负责人 %0 人": "All department heads %0 people",
  "选择具体成员": "Select specific member",
  ...
  "允许成员自行加人": "Allow members to add themselves",
  ...
  "请至少选择2个要合并的工作地点": "Please select at least 2 locations to merge",
  "无工作地点": "No work location",
  "确认删除所选择的工作地点？": "Are you sure you want to delete the selected workspace?",
  "已选择 %0 条": "Selected %0 items",
  "合并": "Merge",
  "工作地点名称不能为空": "Work location name cannot be empty",
  "%0失败": "%0 failed",
  "%0成功": "%0 succeeded",
  "此工作地点已存在": "This workplace already exists",
  "添加成员(%0)": "Add Member (%0)",
  "请输入工作地点名称": "Please enter the workplace name",
  "%0工作地点": "%0 Work Location",
  "该工作地点还没有成员": "There are no members in this workspace yet",
  "合并成功": "Merge Successful",
  "合并工作地点": "Merge Locations",
  "请选择合并到哪个工作地点": "Please select which workplace to merge into",
  "合并失败": "Merge Failed",
  "确认合并所选择的工作地点？": "Confirm the merge of the selected workplace?",
  "合并到": "Merge into",
  ...
  "前往中投支付": "Go to China Investment Corporation Payment",
  ...
  "独立收款并提供安全、便捷的资金管理功能": "Independent collection with secure and convenient fund management features",
  "资金管理": "Fund Management",
  "完成商户签约认证才可使用支付功能收款": "Payment functionality can only be used after completing merchant signing certification.",
  "商户编号": "Merchant ID",
  ...
  "最多显示18个主题颜色": "Up to 18 theme colors can be displayed",
  "创建颜色": "Create Color",
  ...
  "确定恢复[%0]权限吗？": "Are you sure you want to restore [%0] permissions?",
  "用户包": "User Package",
  ...
  "用户待审核": "User Pending Approval",
  "用户未激活": "User not activated",
  "手机号填写错误": "Phone number is incorrect",
  "邮箱填写错误": "Email address is incorrect",
  ...
  "成员暂无汇报关系": "No reporting relationship for members",
  "添加角色": "Add Role",
  ...
  "为角色人员指定分管范围，在审批流程中可以动态获取当前角色中对应的分管负责人进行审批。": "Assign a supervisory scope to the role personnel, allowing the corresponding supervisory responsible person to be dynamically retrieved for approval in the approval process.",
  ...
  "选择应用的存储数据库，应用内工作表数据将会保存在所选专属数据库内": "Select the storage database for the application. The worksheet data within the application will be saved in the selected dedicated database.",
  ...
  "暂无第三方应用": "No third-party applications available",
  "明道云应用市场": "Mingdao Cloud Application Market",
  ...
  "归组字段": "Grouping Field",
  "名称修改成功": "Name modification successful",
  ...
  "聚合中...": "Aggregating...",
  "数据预览已完成（若需调整配置或预览最新数据请点击右侧重新预览）": "Data preview completed (If you need to adjust the configuration or preview the latest data, please click on the right to preview again)",
  "准备中...": "Preparing...",
  "正在从数据源同步数据": "Synchronizing data from the data source",
  "预览失败": "Failed to preview",
  "重新预览": "Repreview",
  "查看数据": "View Data",
  "从左侧面板中选择数据源和字段": "Select data sources and fields from the left panel",
  "预览时将从每个工作表获取最新的1000行数据进行聚合，点击右上角发布后会在后台异步聚合工作表内所有数据（注：数据量越多聚合速度越慢，请耐心等待）": "During the preview, the latest 1000 rows of data will be aggregated from each worksheet. After clicking the publish button in the upper right corner, all data within the worksheets will be aggregated asynchronously in the background (Note: The more data there is, the slower the aggregation will be, so please be patient.)",
  ...
  "%0个没有译文": "%0 no translations available",
  ...
  "清除缓存": "Clear Cache",
  "当应用权限异常时，可尝试清除缓存的权限数据": "When application permissions are abnormal, you can try clearing the cached permission data",
  "摘要": "Summary",
  ...
  "显示模式": "Display Mode",
  "十六宫格": "16-Square Grid",
  "分组展开方式": "Group Expand Mode",
  "默认全展开": "Default Expanded",
  "默认全收起": "Default collapse all",
  "每次展开单个一级分组（其他自动收起）": "Expand a single primary group each time (others collapse automatically)",
  ...
  "联动筛选指定组件后，将取消自动模式下，使用相同数据集的组件自动关联。": "After linking and filtering the specified components, the automatic association of components using the same dataset will be canceled in automatic mode.",
  "选择联动筛选相关组件": "Select Linked Filter Components",
  ...
  "当前值请按从大到小填写": "Please fill in the current value from largest to smallest",
  "前": "Front",
  "显示%0": "Display %0",
  "等分区间": "Equal Interval",
  "当输入大于0的值": "When the input value is greater than 0",
  "后": "After",
  "自定义区间": "Custom Range",
  ...
  "根据内容长度自动设置列宽": "Automatically adjust column width based on content length",
  ...
  "全部列": "All Columns",
  "移动端屏幕尺寸较小，设置时请注意宽度和高度": "The mobile screen size is smaller, so please pay attention to width and height when setting.",
  "%0列": "%0 Column",
  "奖牌": "Medal",
  "冻结列标题": "Freeze Column Header",
  "显示图形": "Display Graph",
  "皇冠": "Crown",
  "数字": "Number",
  "数据条": "Data bar",
  ...
  "计算方式失效，请重新调整": "Calculation method invalid, please readjust.",
  "计算值不能为空": "Calculated value cannot be empty",
  "请选择一个工作表和视图": "Please select a worksheet and view",
  "请选择一个聚合表": "Please select an aggregate table",
  ...
  "搜索外协用户": "Search External Users",
  "可新增、查看、编辑哪些字段？": "What fields can be added, viewed, or edited?",
  "指“新增记录”时，可查看的字段": "Fields that can be viewed when adding a record",
  "记录范围": "Record Range",
  "脱敏": "Data Masking",
  "打印模版": "Print Template",
  "成员、部门、组织角色类型的字段，作为“拥有者”的记录，包含多个权限为“拥有者”字段时，权限为“或”关系": "Fields of member, department, and organizational role types, as records of \\\"owners\\\", with multiple permissions as \\\"owner\\\" fields when the permissions are in an \\\"or\\\" relationship.",
  "其它": "Other",
  "可执行哪些操作？": "What actions can be performed?",
  "额外包含下属拥有的记录": "Additional records owned by subordinates",
  "%0表中%1字段包含当前用户的记录": "The %1 field in the %0 worksheet contains records for the current user.",
  "额外包含下属加入的记录": "Additional records of subordinates added",
  "可删除哪些记录？": "Which records can be deleted?",
  "可查看哪些记录？": "What records can be viewed?",
  "无理由": "No reason",
  "仅此日程": "Only this schedule",
  "更多日程...": "More schedules...",
  ...
  "【明道云平台】": "Mingdao Cloud Platform",
  "此操作会更改后续所有的日程": "This action will change all subsequent schedules",
  ...
  "管理员有权撤回其他成员消息，不限时间，是否确认撤回": "Administrators have the authority to retract messages from other members at any time. Do you confirm the retraction?",
  "来自知识中心": "From Knowledge Center",
  "管理员消息撤回": "Admin Message Recall",
  ...
  "我的好友": "My Friends",
  "添加好友": "Add Friend",
  "不显示其他协作关系": "Do not show other collaboration relationships",
  "新浪微博": "Sina Weibo",
  "添加联系人": "Add Contact",
  ...
  "取消按钮文字": "Cancel",
  "确认按钮文字": "Confirm",
  "其它应用下的封装业务流程": "Packaged business processes under other applications",
  ...
  "每行": "Every row",
  "扫码": "Scan Code",
  "选择下方预览卡片中的按钮进行设置": "Select a button from the preview cards below to configure",
  ...
  "选择筛选对象的数据源表中的字段进行筛选": "Select fields from the data source worksheet of the filtering object to filter",
  ...
  "不用了": "No, thanks",
  "是否将此动态作为问答？": "Would you like to use this dynamic as a Q&A?",
  "发表内容不能为空": "Content cannot be empty",
  "确认删除此条回复": "Confirm deletion of this reply",
  "修改截止日期": "Modify Due Date",
  ...
  "点赞": "Like",
  "通过 %0 的 %1": "Through %0 's %1",
  "通过 %0": "Through %0",
  "点赞人员": "Likers",
  "取消点赞": "Undo Like",
  "查看动态详情": "View Dynamic Details",
  "原动态已被删除": "The original dynamic has been deleted",
  "发布于 %0": "Published on %0",
  "点击查看详情": "Click to see details",
  "编辑于 %0": "Edited on %0",
  "移除后，该动态在动态墙中不可见，确认继续？": "Once removed, this activity will not be visible on the activity wall. Do you want to continue?",
  "原内容已被删除": "The original content has been deleted",
  "确认要删除此动态吗？": "Are you sure you want to delete this dynamic?",
  ...
  "调整当前节点负责人": "Adjust Current Node Owner",
  "前往填写": "Go to fill out",
  "整体耗时": "Total Time Taken",
  "前往办理": "Go to process",
  "重新发起": "Reinitiate",
  "等我审批...": "Waiting for my approval...",
  "填写中...": "Filling in...",
  "流程撤回": "Process Withdrawal",
  "等我填写...": "Wait for me to fill out...",
  "审批中...": "In Review...",
  "当前节点": "Current Node",
  "处理开始": "Processing Start",
  "催办成功": "Reminders sent successfully",
  ...
  "修改成功，无编辑权限的%0无法修改": "Modification successful; %0 with no editing permissions cannot be modified.",
  ...
  "你确定重置显示列吗？": "Are you sure you want to reset the displayed columns?",
  "关闭或拖拽到这里": "Close or drag here",
  "A → Z%02058": "A → Z",
  "最新的在前面": "Newest First",
  "Z → A%02059": "Z → A",
  "哪些工作表需要创建索引？": "Which worksheets need to create an index?",
  "在视图、筛选、快速筛选等查询场景中被检索的字段或者在视图、子表、关联记录中被排序的字段才需要创建索引。": "Only fields retrieved in query scenarios such as views, filters, and quick filters, or fields sorted in views, sub-tables, and related records need to create an index.",
  ...
  "流程执行完成后提示": "Notification after process execution is complete",
  ...
  "文件夹名和附件名的最大长度为90个汉字。超限的文件不会被导出。": "The maximum length for folder names and attachment names is 90 Chinese characters. Files that exceed this limit will not be exported.",
  ...
  "将视图下数据导出为 Excel": "Export data from the view to Excel",
  "将选中的%0条数据导出为 Excel": "Export the selected %0 records to Excel",
  "搜索字段名称": "Search Field Name",
  "导出当前表格显示列的字段": "Export fields of the currently displayed columns in the worksheet",
  ...
  "编码方式：code128，仅支持数字、字母、符号，最大包含30个字符": "Encoding method: code128, supports only numbers, letters, and symbols, maximum of 30 characters",
  "打印方式": "Print Method",
  ...
  "仅限管理员操作，一次最多校准10万行数据，校准完成后将推送系统消息通知。": "Admin operation only, with a maximum of 100,000 rows of data calibrated at once. A system message notification will be sent after calibration is complete.",
  ...
  "共": "Total",
  "刷新频率过快": "Refresh frequency is too fast",
  "分享视图": "Share View",
  ...
  "下级包含%25024": "Subordinate Contains",
  "插件发布后将作为使用者的视图配置": "After the plugin is released, it will be configured as the user's view.",
  "分组字段": "Grouping Field",
  "结尾不是%25008": "The end is not",
  "下级不包含%25025": "Subordinate not included",
  "为空%25009": "Empty",
  "属于%25019": "Belong to",
  "不属于%25020": "Not belonging to",
  "本人": "Myself",
  "是外部门户用户": "is an external portal user",
  "是常规用户": "is a regular user",
  "本人和下属": "Myself and subordinates",
  "同时包含%25023": "Also includes",
  "指定日期时间（时）": "Specify date and time (hour)",
  "指定日期时间（分）": "Specify date and time (minutes)",
  "过去...(旧)": "Past...(Old)",
  ...
  "创建一个画布页面，在页面中添加统计报表、按钮、视图等组件": "Create a canvas page and add components like statistical reports, buttons, views, etc.",
  "嵌入页面": "Embed Page",
  ...
  "仅系统角色在导航中可见（包含管理员、开发者），应用项权限依然遵循角色权限原则": "Only system roles are visible in the navigation (including administrators and developers), and the permissions for application items still follow the principle of role-based permissions.",
  ...
  "恢复成功，部分数据已被彻底删除无法恢复": "Recovery successful, some data has been permanently deleted and cannot be restored",
  ...
  "当前版本没有此功能，请升级版本": "This feature is not available in the current edition, please upgrade the edition",
  ...
  "当前版本无法使用此功能，请购买或者升级": "The current edition cannot use this feature, please purchase or upgrade",
  ...
  "5.在法律允许的范围内，明道云对因：（1）明道云产品受到计算机病毒、木马或其他恶意程序、黑客攻击的破坏；（2）明道云用户操作不当或用户通过非明道云授权的方式使用本服务；（3）程序版本过时、设备的老化和/或其兼容性问题；（4）其他明道云无法控制或合理预见的情形，导致的明道云服务中断或终止，不承担赔偿责任。": "5. To the extent permitted by law, Mingdao Cloud shall not be liable for any damages resulting from the interruption or termination of Mingdao Cloud services due to: (1) destruction caused by computer viruses, Trojans, or other malicious programs, hacker attacks on Mingdao Cloud products; (2) improper user operations or user access to this service in a manner not authorized by Mingdao Cloud; (3) outdated program versions, aging devices and/or compatibility issues; (4) other circumstances that Mingdao Cloud cannot control or reasonably foresee.",
  ...
  "专业版单个应用下最多可创建30个工作表，请升级版本以创建更多工作表": "You can create a maximum of 30 worksheets under a single application in the Professional Edition. Please upgrade the version to create more worksheets.",
  ...
  "抱歉，操作过于频繁或者创建的组织已经达到上限，请升级至付费版本即可创建更多组织，如有疑问请咨询客服！": "Sorry, the operation is too frequent or the number of organizations created has reached the limit. Please upgrade to a paid edition to create more organizations. If you have any questions, please contact customer service!",
  ...
  "选择版本": "Select Edition",
  "付费版本": "Paid Edition",
  "100元/个/年（版本剩余时间）": "100  CNY/item/year (remaining time for edition )",
  "300 元/人/年（版本剩余时间）": "300 CNY/person/year (remaining time for edition )",
  ...
  "不保留": "Not retained",
  "不再提示": "No more reminders",
  "是否将本次已填写内容保存为草稿？": "Do you want to save the completed content as a draft?",
  ...
  "您有未保存的修改，确定要离开此页吗？": "You have unsaved changes. Are you sure you want to leave this page?",
  ...
  "最多输入%0条记录，超出的记录不写入": "Maximum input of% 0 records, records exceeding this limit will not be written",
  ...
  "导入数据": "Import Data",
  "已超过子表最大行数": "Exceeded maximum row count of the sub-table",
  ...
  "下一条": "Next",
  "超过导入上限(上限 50000 行)，请调整导入数据": "Exceeds import limit (maximum 50,000 rows), please adjust the import data",
  ...
  "发送讨论": "Send Discussion",
  "含附件": "Attachments Included",
  ...
  "通过工作流，你可以将业务中的重复工作自动化执行，还可以发通知、短信，对接外部系统，彻底打通上下游业务。": "With workflows, you can automate the repetitive tasks in your business, send notifications, text messages, and connect with external systems, completely integrating upstream and downstream operations.",
  ...
  "检查即将导入的数据，你可以调整导入数据对应的字段": "Check the data that is about to be imported; you can adjust the corresponding fields of the imported data.",
  "表头行": "Header Row",
  ...
  "没有找到符合条件的记录": "No records found that meet the criteria",
  ...
  "结构化展示大量数据，编辑更方便": "Structured display of large amounts of data, easier editing",
  "显示 %0 个": "Show %0 items",
  "重新生成链接": "Regenerate Link",
  "如果您选择生成新链接，则旧链接将不再可用": "If you choose to generate a new link, the old link will no longer be available.",
  "按所在日期排列数据，日程安排更直观": "Arrange data by date for a more intuitive schedule",
  "以卡片形式展示数据，分配更灵活": "Display data in card format for more flexible allocation",
  "以图片为主要元素查看数据，浏览更高效": "View data with images as the main element for more efficient browsing",
  "聚焦数据详细内容，阅读更方便": "Focus on detailed data, making it easier to read",
  "根据父-子关系展示数据，结构更清晰": "Displays data based on parent-child relationships, making the structure clearer",
  "按所属资源展示数据，资源调度更方便": "Display data by associated resources for more convenient resource scheduling",
  "按定位显示数据，区域分布更直观": "Display data by location, making area distribution more intuitive",
  "通过插件开发，定制自己的视图": "Customize your own views through plugin development",
  "全显示%05008": "Show All",
  "以时间轴展示数据，项目管理更方便": "Display data on a timeline for easier project management",
  "默认视图": "Default View",
  "自定义视图": "Custom View",
  "开发视图插件": "Develop View Plugin",
  "组织发布的": "Published by the organization",
  ...
  "调整关联关系失败! 请稍后重试": "Failed to adjust the association! Please try again later",
  "拖拽更新失败!": "Drag and drop update failed!",
  "插件未发布": "Plugin Not Released",
  "保存表格外观失败！": "Failed to save worksheet appearance!",
  "插件开发中": "Plugin development in progress",
  ...
  "视图配置错误,请联系管理员": "View configuration error, please contact the administrator",
  "选择一个定位字段，前200条数据将按照此字段中的位置显示在地图中。": "Select a location field, and the first 200 records will be displayed on the map according to the positions in this field.",
  ...
  "按部门": "By Department",
  "从左侧选择部门后显示成员": "Select a department from the left to display members",
  "按群组": "By Group",
  "选择群组": "Select Group",
  ...
  "所有类型": "All Types",
  "导出的应用文件有效期为30天，请尽快下载": "The exported application file is valid for 30 days. Please download it as soon as possible.",
  "搜索应用名称/操作者": "Search app name/operator",
  "按日期筛选": "Filter by Date",
  "工作表 %0": "Worksheet %0",
  "自定义页面 %0": "Custom Page %0",
  "所属应用": "Belonging Applications",
  "查看密码": "View Password",
  "不导出": "Do not export",
  "上传应用 .mdy文件，获取导入密码、应用锁密码": "Upload the .mdy file for the application to obtain the import password and application lock password",
  "自定义导出的记录数量": "Number of Records to Export Customly",
  "每张表最多导出10000条记录": "A maximum of 10,000 records can be exported per worksheet",
  "该应用下没有工作表": "There are no worksheets under this application",
  "已选 %0 行（最大5万行）": "Selected %0 rows (maximum 50,000 rows)",
  ...
  "导入后不允许修改应用配置": "Modifications to application configuration are not allowed after import",
  ...
  "请从左侧列表选择应用,": "Please select the application from the list on the left.",
  "已选": "Selected",
  "搜索变量名称": "Search Variable Name",
  "导出的应用共%0个，已超过上限%1个，请重新选择": "A total of %0 applications have been exported, exceeding the limit of %1 applications. Please make a new selection.",
  "值为空": "Value is empty",
  ...
  "没有授权应用": "Unauthorized Application",
  ...
  "这可能需要一段时间，现在您可以进行其他操作，导出完成后通知您": "This may take some time, you can perform other actions now, and we will notify you once the export is complete.",
  ...
  "成功导出%0个应用：%1。请尽快下载，下载链接于30天后失效": "Successfully exported %0 applications: %1. Please download as soon as possible; the download link will expire in 30 days.",
  "导出成功": "Export succeeded",
  "正在导入%0... ( %1/%2 )": "Importing %0... ( %1/%2 )",
  "这可能需要一段时间，现在您可以进行其他操作，导入完成后通知您": "This may take some time; you can proceed with other tasks now, and you will be notified once the import is complete.",
  ...
  "可将指定应用内的所有工作表数据存储到专属数据库中，免受系统默认数据库的影响，适用于隔离等场景，系统默认支持最多创建%0个可用专属数据库实例；管理员创建应用时，可选择专属数据库。": "You can store all worksheet data within the specified application into a dedicated database, unaffected by the system's default database, suitable for isolation scenarios. The system defaults to support creating up to %0 available dedicated database instances; administrators can choose a dedicated database when creating an application.",
  "添加时间": "Add Time",
  ...
  "实例名称": "Instance Name",
  "数据库名称": "Database Name",
  "其他连接串参数": "Other connection string parameters",
  ...
  "关闭钉钉集成后，无法再从钉钉处进入明道云应用": "After disabling the DingTalk integration, you will no longer be able to access the Mingdao Cloud application from DingTalk.",
  "消息链接": "Message Link",
  ...
  "关闭飞书集成后，无法再从飞书处进入明道云应用": "After disabling the Feishu integration, you can no longer access the Mingdao Cloud application from Feishu.",
  ...
  "明道云OA": "Mingdao Cloud OA",
  "升级到明道云标准版+OA": "Upgrade to Mingdao Cloud Standard Version + OA",
  "明道云标准版+审批": "Mingdao Cloud Standard Version + Approval",
  "购买明道云审批": "Purchase Mingdao Cloud Approval",
  ...
  "获取打印记录文件生成PDF文件": "Generate PDF file from print record",
  ...
  "同步": "Sync",
  "关闭Welink集成后，无法再从Welink集成处进入明道云应用": "After disabling the Welink integration, you can no longer access the Mingdao Cloud application from the Welink integration.",
  "同步失败": "Synchronization failed",
  "同步中": "Synchronizing",
  ...
  "同步到": "Sync to",
  "同步到工号字段": "Synchronize to the employee ID field",
  ...
  "5元/人年": "5 CNY / person / year",
  "1000人": "1000 users",
  "100人": "100 people",
  "增补": "Supplement",
  "1元/人年": "1 CNY / person / year",
  "购买方式": "Purchase Method",
  "0.5元/人年": "0.5 CNY / person / year",
  "10万人": "100,000 people",
  "10000人": "10,000 users",
  "购买人数：": "Number of Purchases:",
  ...
  "扩充聚合表数量": "Expand the number of aggregated worksheets",
  ...
  "购买工作流执行数升级包": "Purchase Workflow Execution Count Upgrade Package",
  ...
  "购买外部用户人数": "Number of External Users Purchased",
  ...
  "总时间": "Total Time",
  "未开始": "Not Started",
  "所有未完成任务的总剩余时间": "Total remaining time for all unfinished tasks",
  ...
  "有%0位外部用户邀请失败。外部用户短信邀请用量达到上限": "Failed to invite %0 external users. The SMS invitation quota for external users has been reached.",
  ...
  "当启用\"收集填写者微信信息\"，或填写范围为\"平台/本组织用户\"时，可使用以下增强功能": "When enabling \"Collect WeChat Info from Fillers\" or when the fill range is \"Platform/Our Organization Users\", the following enhanced features can be used.",
  "列表视图": "List View",
  ...
  "修改时效：": "Modifiy time limit:",
  "选择日期": "Select Date",
  "提交后允许查看/修改": "Allow viewing/modification after submission",
  "一段时间内可修改": "Modifiable for a period of time",
  "已选择${selectedCount}个字段": "Selected ${selectedCount} fields",
  "始终允许修改": "Always allow modifications",
  "搜索字段": "Search fields",
  "选择月份": "Select Month",
  "选择字段": "Select fields",
  "设置链接开始/停止时间": "Set link start/stop time",
  "打开后，填写者只有在设置的这个时间段内填写，方可正常提交数据。": "After opening, the submitter can only submit data normally within the set time period.",
  "显示倒计时": "Show Countdown",
  "时%02069": "Time",
  "以下时段可填写": "Available time slots for entry",
  ...
  "自定义验证码签名": "Custom Verification Code Signature",
  "自定义签名仅支持国内号码，国际号码验证短信固定使用 【明道云】 短信签名": "Custom signatures are only supported for domestic numbers. For international numbers, the verification SMS will use the fixed signature of 【Mingdao Cloud】.",
  ...
  "（用户在点击按钮后开始填写）": "Please fill in your information here",
  "填写设置": "Fill Settings",
  ...
  "短信签名：": "SMS Signature:",
  "验证码短信%0每条，自动从企业账户扣除，余额不足时无法获取验证码。": "The verification code SMS %0 each will be automatically deducted from the company's account. If the balance is insufficient, you will not be able to receive the verification code.",
  "对填写的手机号字段进行短信验证，以确保为本人有效手机号。": "Verify the submitted phone number field via SMS to ensure it is a valid number belonging to the user.",
  ...
  "收集填写者微信信息": "Collect the WeChat information of the fill-out",
  "收集渠道": "Collection Channels",
  "获取填写信息": "Obtain fill-in information",
  "暂未绑定认证的服务号, 请前往": "No certified service account is bound yet. Please go to",
  "设备": "Device",
  "组织后台": "Organization Backend",
  "只允许在微信中填写": "Only allowed to fill in WeChat",
  "打开后，填写者只能在微信环境内填写表单。": "Once opened, the form can only be filled out in the WeChat environment.",
  "已开启链接时间设置，但未选择开始/停止时间": "Link time settings have been enabled, but start/stop times have not been selected.",
  "扩展值": "Extended Value",
  ...
  "请至少完整填写一个时间指定范围": "Please fill out at least one complete time range",
  ...
  "将用户填写表单时的IP地址、浏览器、填写设备、操作系统记录到工作表字段中（文本字段）。": "Record the user's IP address, browser, filling device, and operating system into the worksheet fields (text fields) when the user fills out the form.",
  "可以在下方输入生成带扩展值的链接。或自己拼接扩展值，拼接方法https://......?source=微博。https://...为公开表单链接，微博为设置的扩展值": "You can enter the link with extended values below or concatenate the extended values yourself. The concatenation method is https://......?source=Weibo. https://... is the public form link, and Weibo is the set extended value.",
  "请选择...": "Please select...",
  "设备信息": "Device Information",
  "选择记录设备信息的文本字段": "Select the text field for recording device information",
  "嵌入代码": "Embed Code",
  "请选择商户": "Please select a merchant",
  "当前有尚未保存的更改，你在离开页面前是否需要保存这些更改？": "There are unsaved changes. Do you want to save these changes before leaving the page?",
  "是否保存链接设置的更改？": "Do you want to save the changes to the link settings?",
  "是否保存微信增强的更改？": "Do you want to save the changes enhanced by WeChat?",
  "请选择支付金额": "Please select the payment amount",
  "请选择支付内容": "Please select payment content",
  "是%25028": "Yes",
  "应用内成员可用": "Members available in the app",
  "支付按钮设置（工作表记录）": "Payment button (Worksheet records)",
  "外部门户用户可用": "External portal users available",
  "请先开启外部门户功能": "Please enable the external portal feature first",
  "当支付内容、支付金额字段不为空时": "When the payment content and payment amount fields are not empty",
  "15分钟": "15 minutes",
  ...
  "20分钟": "20 minutes",
  "字段映射": "Field Mapping",
  "在公开表单提交后支付，常用于活动报名等场景": "Pay after submitting the public form, commonly used for event registration and similar scenarios",
  "30分钟": "30 minutes",
  "注：修改支付相关配置，可能影响已经支付订单，请谨慎操作": "Note: Changing payment-related settings may affect already paid orders. Please proceed with caution.",
  "选择商户": "Select Merchant",
  "请先开启公开表单功能": "Please enable the public form feature first",
  "在工作表记录中显示支付按钮，可以在用户使用外部门户时支付，或组织内完成支付": "Display the payment button in the worksheet record, allowing users to pay while using the external portal or complete the payment within the organization",
  "支付设置": "Payment Settings",
  "删除后对应表单数据也会被删除": "Deleting will also remove the corresponding form data",
  "选择文本字段": "Select Text Field",
  "开启后用户需要在系统设置的时间内完成交易，逾期平台将关闭交易，同时该记录将不再支持用户支付": "Once enabled, users must complete the transaction within the time set in the system. If the time expires, the platform will close the transaction, and the record will no longer support user payments.",
  "订单/支付页面显示的商品/产品简要描述": "Brief description of the product/items displayed on the order/payment page",
  "选择或填写时间": "Select or fill in the time",
  "设置交易有效期": "Set Transaction Validity Period",
  "开通后完成交易7天内的订单支持申请退款，目前仅付款人可申请退款": "Orders that are completed within 7 days after activation are eligible for a refund request. Currently, only the payer can request a refund.",
  "允许退款": "Refunds allowed",
  "将订单明细映射到当前记录": "Map the order details to the current record",
  "选择选项字段映射时，未映射的选项内容可增加为选项": "When mapping the option field, unmapped option content can be added as options.",
  "在记录详情侧边栏显示支付订单信息": "Display payment order information in the record detail sidebar",
  ...
  "可恢复60天内删除的字段": "Recoverable fields deleted within 60 days",
  ...
  "值设为": "Set Value To",
  "当": "When",
  "已设置数据写入字段": "Data write fields have been set",
  "未设置数据写入字段": "Data write fields not set",
  "%0 - %1": "%0 - %1",
  "满足条件%0": "Condition satisfied %0",
  "在详情页新建或打开记录": "Create or open a record on the details page",
  "返回 true": "Return true",
  "如果": "If",
  "否则如果": "Otherwise if",
  "那么": "So",
  ...
  "忽略此条件（当全部忽略时，返回无结果）": "Ignore this condition (when all are ignored, return no results)",
  ...
  "当条件使用的动态值为空时，如何处理？": "How to handle when the dynamic value used in the condition is empty?",
  "查询空值": "Query Null Values",
  ...
  "获取关联记录、子表、级联选择字段中的记录": "Get related records, sub-tables, and records from cascade selection fields",
  "级联选择：高级设置中勾选“选择结果显示层级路径”": "Cascade Selection: Check “Show Hierarchical Path of Selected Results” in Advanced Settings",
  "选择一个层级视图作为级联选择的数据源，将按照此视图下数据的层级关系来选择目标表记录。仅支持本表的层级结构": "Select a hierarchical view as the data source for cascade selection, and the target table records will be selected based on the hierarchical relationship of the data in this view. Only the hierarchical structure of this table is supported.",
  "我们将为您新建一个表与层级视图，用来管理级联选择的数据": "We will create a new worksheet and hierarchical view for you to manage the data for cascade selections.",
  ...
  "后缀": "Suffix",
  "当前子表记录": "Current Subtable Record",
  "当前记录": "Current Record",
  "修改数据源": "Edit Data Source",
  "选择已有表作为数据源": "Select an existing worksheet as the data source",
  "新建数据源": "Create Data Source",
  "数据源 %0": "Data source %0",
  "选择数据源": "Select Data Source",
  "获取后直接提交表单": "Submit the form directly after getting it",
  "%0  (本表)": "%0  (This table)",
  ...
  "勾选后，在移动端App创建记录时会首先调取扫码输入。此功能在自定义按钮填写时也会生效。": "Once checked, scanning input will be called first when creating a record on the mobile app. This function will also be effective when filling out custom buttons.",
  "%0  (本应用)": "%0 (This application)",
  "排列方式": "Sort Order",
  "横向排列": "Horizontal",
  ...
  "将从空白创建的子表转为一个实体工作表。此工作表将成为当前表单的一个关联子表，并可以在应用配置、流程、权限中被使用": "Convert the sub-table created from scratch into a physical worksheet. This worksheet will become a related sub-table of the current form and can be used in application configuration, workflows, and permissions.",
  "将子表转为工作表": "Convert Sub-table to Worksheet",
  "转换失败": "Conversion failed",
  "将关联记录字段转为子表字段": "Convert related record fields to sub-table fields",
  "转为子表字段后，原关联记录字段中配置的筛选条件，以及与关联视图相关的权限、排序方式、自定义动作将被清除。": "After converting to sub-table fields, the filter conditions configured in the original related record fields, as well as the permissions, sorting methods, and custom actions related to the associated views will be cleared.",
  "将富文本变更为普通文本后，文本样式、图片等信息将丢失。你确定要进行变更吗？": "Changing rich text to plain text will result in the loss of text styles, images, and other information. Are you sure you want to make this change?",
  "将子表转为关联记录": "Convert Sub-Worksheet to Associated Record",
  ...
  "将子表字段转为关联记录字段": "Convert sub-table fields to related record fields",
  ...
  "已转审": "Forwarded",
  "已转交": "Handed",
  "搜索名称和摘要": "Search by Name and Summary",
  "时间范围": "Time Range",
  "处理结果": "Processing Result",
  "应用/流程": "Application/Process",
  "旧的在前": "Oldest in front",
  "支持上传JPG、JPEG、PNG、Gif、WebP、Tiff、bmp、HEIC、HEIF格式的文件（在附件中支持预览）": "Supports uploading files in JPG, JPEG, PNG, Gif, WebP, Tiff, bmp, HEIC, HEIF formats (preview supported in attachments)",
  "海报": "Poster",
  "引用字段": "Reference Field",
  "音频": "Audio",
  "请输入自定义的文件扩展名，多个请用英文逗号隔开，不区分大小写。如：xls,doc,pdf": "Please enter the custom file extension. Separate multiple entries with commas (in English), case insensitive. For example: xls,doc,pdf",
  "文件类型": "File Type",
  "在单元格中显示文件名": "Display the file name in the cell",
  "支持除图片、音频、视频以外的文件": "Supports files other than images, audio, and video",
  "支持MP4、AVI、MOV、WMV、MKV、FLV、F4V、SWF、RMVB、MPG格式的文件": "Supports files in MP4, AVI, MOV, WMV, MKV, FLV, F4V, SWF, RMVB, MPG formats",
  "编号": "Number",
  "支持WAV、FLAC、APE、ALAC、WavPack、MP3、M4a、AAC、Ogg Vorbis、Opus、Au、MMF、AIF格式的文件": "Supports files in WAV, FLAC, APE, ALAC, WavPack, MP3, M4a, AAC, Ogg Vorbis, Opus, Au, MMF, AIF formats",
  "每周重置": "Weekly Reset",
  ...
  "编码方式：code128，仅支持数字、字母、符号，最大包含128个字符": "Encoding method: code128, supports only numbers, letters, and symbols, with a maximum of 128 characters",
  "字段值": "Field Value",
  "记录内部访问链接": "Record Internal Access Link",
  "编码方式：QR-code，可支持汉字，最大包含150个字": "Encoding method: QR-code, supports Chinese characters, with a maximum of 150 characters",
  "级联菜单": "Cascading Menu",
  ...
  "在视图过滤的基础上叠加筛选条件": "Overlay filter conditions on top of the view filter",
  "过滤": "Filter",
  "筛选%0": "Filter %0",
  "每页行数": "Rows per page",
  ...
  "年：Y（大写)": "Year: Y (uppercase)",
  "显示单位": "Display Unit",
  "参与计算的日期未设置时间时，格式化方式为:": "The formatting method when the date participating in the calculation does not have a time set is:",
  "输入你想要 添加/减去 的时间。如：+8h+1m，-1d+8h。当使用数值类型的字段运算时，请不要忘记输入单位。": "Enter the time you want to add/subtract. For example: +8h+1m, -1d+8h. When performing arithmetic with numerical fields, do not forget to include units.",
  "天：d": "Day: d",
  "分：m": "Min: m",
  "小时：h": "Hour: h",
  ...
  "显示字段": "Display Field",
  "通过手机gps获取经纬度获取定位，使用WGS84坐标系": "Obtain location using GPS on mobile phone with WGS84 coordinate system",
  "100米": "100 meters",
  "300米": "300 meters",
  "500米": "500 meters",
  "1000米": "1000 meters",
  ...
  "由于高德定位组件限制，必须使用https协议以获得准确的定位信息": "Due to the restrictions of the Gaode positioning component, it is necessary to use the HTTPS protocol to obtain accurate location information.",
  "关联金额": "Associated Amount",
  "输入方式": "Input Method",
  "请选择配置的”金额“字段": "Please select the configured 'Amount' field",
  "固定颜色": "Fixed Color",
  "计步器": "Pedometer",
  "步长": "Step Length",
  "区间": "Interval",
  ...
  "在加载记录时实时获取数据。适合只需要显示字段的场景。": "Retrieve data in real-time when loading records. Suitable for scenarios that only require displaying fields.",
  "注意：1.存储的数据与实际数据存在一定延时；2.当显示字段的数据变更后，最大支持更新与之关联的1000行数据。": "Note: 1. The stored data has a certain delay compared to the actual data; 2. When the displayed field's data changes, a maximum of 1000 associated rows can be updated.",
  "所以此方式适合显示字段的值不会变更，或虽然变更但关联的记录数量较少（不超过1000行）的场景。": "This method is suitable for scenarios where the values of the fields do not change, or change but are associated with a limited number of records (no more than 1000 rows).",
  ...
  "全局不允许重复输入": "Global duplicate input is not allowed",
  ...
  "短信模板没有通过审核": "The SMS template has not passed approval",
  "查找节点无数据": "No data found for the node",
  "短信发送需要组织门牌号": "Sending SMS requires the organization’s address number",
  ...
  "短信邮件内容有敏感词": "The SMS email content contains sensitive words",
  ...
  "他表字段配置异常": "The field configuration of the table is abnormal",
  "筛选条件不支持": "Filtering conditions not supported",
  "短信发送失败发送失败": "SMS sending failed",
  "从工作表获取多条记录失败": "Failed to retrieve multiple records from the worksheet",
  "新增记录失败": "Failed to add record",
  "从一条记录获得多条关联记录失败": "Failed to retrieve multiple related records from a single record",
  ...
  "未通过分支": "Branch Not Approved",
  "动作": "Action",
  "审批人无效": "Invalid Approver",
  "发起节点": "Initiate Node",
  "审批流程触发者无效": "The approver of the process is invalid",
  "被发起人撤回": "Withdrawn by the initiator",
  "数据丢失": "Data Loss",
  "填写人无效": "Invalid Filler",
  "网关": "Gateway",
  "短信": "SMS",
  "封装业务流程(PBP)": "Process Business Packaging (PBP)",
  "获取链接": "Get Link",
  ...
  "获得链接": "Get Link",
  "发送服务号消息": "Send service number message",
  "中止流程": "Terminate Process",
  "AI 生成数据对象": "AI Generated Data Object",
  ...
  "（第%0级）": "(Level %0)",
  "离开:": "Exit:",
  "触发流程数据": "Trigger Process Data",
  "中止 (%0)": "Discontinued (%0)",
  "直至手动恢复": "Until manually restored",
  "后恢复": "Restore",
  "原因": "Reason",
  "查看串行等待中的流程": "View the processes waiting in serial",
  "重试 (%0)": "Retry (%0)",
  "触发时间": "Trigger Time",
  "暂无数据运行记录": "No data operation records available",
  "%0条排队中...": "%0 items in queue...",
  ...
  "数据各自同步执行，适合运行实例间互不影响的流程。执行速度快，适合大多数流程使用": "Data is executed synchronously and independently, suitable for processes where instances do not affect each other. The execution speed is fast, making it suitable for most processes.",
  "顺序执行": "Execute Sequentially",
  "严格串行": "Strict Serial",
  "精确到分钟，如：2010-10-01 12:23": "Accurate to the minute, e.g., 2010-10-01 12:23",
  "按字段配置中的小数位数，如：3.14159 配置了4位小数，则取 3.1416": "Configure the number of decimal places in the field, for example: if 3.14159 is configured to 4 decimal places, it will take 3.1416",
  "按字段原始值取所有小数位数，如：3.14159": "Retrieve all decimal places based on the original value of the field, e.g., 3.14159",
  "精确到秒，如：2010-10-01 12:23:45": "Accurate to the second, e.g.: 2010-10-01 12:23:45",
  "流程拥有者": "Workflow Owner",
  "数据按顺序逐条执行，上一条流程完全执行完成后才会执行下一流程，速度最慢": "Data is executed sequentially, and the next process will only execute after the previous one has been fully completed, making it the slowest.",
  "内不发送同类错误通知": "Do not send similar error notifications internally",
  "其他通知人": "Other Notify Person",
  "仅支持分支节点条件判断": "Conditional judgment only supports branch nodes",
  "设置动态值在流程执行过程中引用或参与计算时使用的数据格式": "The data format used for referencing or participating in calculations of dynamic values during the execution process.",
  "运行方式": "Operating Mode",
  "设置流程的运行方式，仅支持新增记录触发，自定义动作触发的流程": "Set the way the process runs, only supports process triggered by new record creation and custom action triggers.",
  "（当流程错误时，同时通知以下人）": "(Notify the following people when the process fails)",
  "系统字段中的日期值": "Date values in system fields",
  "数值字段的小数位数": "Decimal Places of Numeric Field",
  "数据格式": "Data Format",
  "启用后，可以在历史日志中查看单个节点在流程执行时的输入、输出数据。日志保留最近90天的数据": "Once enabled, you can view the input and output data of individual nodes during process execution in the history log. The logs retain data for the last 90 days.",
  "关闭%03087": "Close",
  "节点日志": "Node Logs",
  "触发者查看": "Trigger Viewer",
  "启用后，流程触发者可以在“我发起的”待办项中查看、追踪此流程": "Once enabled, the process initiator can view and track this process in the 'My Initiated' tasks.",
  "允许触发": "Allow trigger",
  "触发其他工作流": "Trigger Other Workflows",
  "工作流触发者自动通过": "Workflow Trigger Automatically Passed",
  "在选择此配置时，如果要触发本表的其他工作流，必须为目标流程指定触发字段": "When selecting this configuration, if you want to trigger other workflows in this table, you must specify the trigger field for the target process.",
  "审批自动通过": "Approval Automatically Granted",
  "只能触发指定工作流": "Can only trigger the specified workflow",
  "不允许触发": "Not allowed to trigger",
  "已经审批过该对象的审批人自动通过": "The approver who has already approved the object is automatically approved.",
  "工作流触发者不发送通知": "Workflow trigger does not send notifications",
  ...
  "节点": "Node",
  "触发者操作": "Trigger Actions",
  "通过后不允许撤回": "Cannot be revoked after approval",
  "允许触发者催办": "Allow triggerer to expedite",
  "参数对象": "Parameter Object",
  "请求地址": "Request Address",
  "流程开始运行时生成，可以用以执行运算，或实现两个流程间的数据传递；命名时请以英文字母打头，名称中禁止出现汉字": "Generated when the process starts running, can be used to perform computations or achieve data transfer between two processes; please start with an English letter when naming, and prohibit the presence of Chinese characters in the name",
  "启用后，我们会自动为您的业务流程生成相关的API开发文档，供您向其他第三方外部系统提供平台开放能力": "Once enabled, we will automatically generate relevant API documentation for your business processes, allowing you to provide platform openness to other third-party external systems.",
  "平台API能力": "Platform API Capability",
  "执行当前运行中的流程": "Execute the current running process",
  ...
  "流程参数": "Process Parameters",
  "组织使用中": "Organization in use",
  "删除更改": "Delete changes",
  "编辑中…": "Editing…",
  "审批、填写节点无需操作，将会自动通过。": "Approval and fill-in nodes require no action and will be automatically approved.",
  "%0 发布于 %1": "%0 published on %1",
  "待办、通知节点以我自己作为节点执行人，实际执行人不会收到消息。": "The to-do and notification nodes are executed by me as the node executor, and the actual executor will not receive the message.",
  "更新于 %0": "Updated on %0",
  "未设置触发方式的工作流将不会被保存": "Workflows without a set trigger will not be saved",
  "放弃保存": "Discard Changes",
  "下次不再提示": "Do not remind me next time",
  "测试": "Test",
  "继续": "Continue",
  "仅对主流程进行测试执行。引用的子流程、PBP、审批流程将跳过执行，可单独前往测试这些流程。": "Only execute tests on the main process. Referenced sub-processes, PBP, and approval processes will be skipped during execution and can be tested separately.",
  "是否为%0开启审批功能项": "Should the approval feature for %0 be enabled?",
  "开始测试": "Start Test",
  "执行定时触发流程": "Execute Scheduled Triggered Process",
  ...
  "短信、邮件将发送给我的账号绑定的手机、邮箱测试。": "Text messages and emails will be sent to the phone and email linked to my account for testing.",
  "包含待办节点（审批、填写、抄送），通知节点（站内消息、短信、邮件）。": "Includes to-do nodes (approval, filling, copying) and notification nodes (in-site messages, SMS, emails).",
  ...
  "太棒了！流程已自动化运行": "Awesome! The process has been automated.",
  ...
  "打开记录时显示审批流转详情": "Display approval flow details when opening a record",
  "在视图上显示审批系统字段": "Display approval system fields on the view",
  "已修改": "Modified",
  ...
  "API Code": "API Code",
  "暂存": "Save Temporarily",
  "通过并加签": "Sign and co-sign",
  "催办": "Remind",
  "填写转交备注": "Fill in the handover notes",
  "填写加签备注": "Fill in the additional signing remarks",
  ...
  "您确定要删除片段“%0”吗？": "Are you sure you want to delete the fragment \"%0\"?",
  "使用时清空现有input参数与代码块": "Clear existing input parameters and code blocks during use",
  ...
  "个节点指定的对象已删除": "The object specified by the node has been deleted",
  "个节点有审核中、审核失败的短信模版": "Each node has SMS templates for under review and review failed",
  "个节点未进行配置": "The node has not been configured",
  "个节点未设置有效的操作或操作内容异常": "A node has not been configured with a valid operation or the operation content is abnormal",
  "个节点未指定人员或人员异常": "The node does not have specified personnel or there is an issue with the personnel.",
  "新增负责人": "Add Responsible Person",
  "循环流程": "Cyclic Process",
  "没有可选的应用": "No optional applications",
  "移除尚未进行操作的负责人，添加新的成员；您的操作仅对当前流程的本次运行生效": "Remove the responsible person who has not yet taken action and add new members; your actions will only take effect for this run of the current process.",
  ...
  "流程开始": "Process Start",
  "已执行": "Executed",
  "确认中止此条流程 ?": "Are you sure you want to abort this process?",
  "待执行": "Pending Execution",
  "当前节点未进行操作的成员将设为通过": "Members who have not operated at the current node will be marked as passed",
  "添加负责人": "Add Responsible Person",
  "原负责人": "Original Responsible Person",
  "修改密码失败,请稍后再试!": "Password change failed, please try again later!",
  "验证码已经失效，请重新发送!": "The verification code has expired, please resend!",
  "我的账户": "My Account",
  "请输入新密码！": "Please enter a new password!",
  "当前企业账号余额不足，无法发送短信": "The current enterprise account balance is insufficient to send SMS.",
  "未设置": "Not set",
  "已设置": "Set",
  ...
  "关注明道云服务号": "Follow the Mingdao Cloud Service Account",
  "手机号码格式错误": "Mobile phone number is invalid",
  "用微信【扫一扫】二维码": "Use WeChat to 【scan】 the QR code",
  ...
  "开启后，输入账户和密码后，仍需输入验证码；开启 %0。": "After enabling, you need to enter the verification code after entering the account and password; enable %0.",
  ...
  "专业和学历不能含特殊字符": "Special characters are not allowed in profession and education.",
  "学校名称": "School Name",
  "请输入学校名称": "Please input your school name",
  "期间最高职位": "Highest Position During Period",
  "专业和学历": "Profession and Education",
  "核心课程": "Core Courses",
  "还在这里工作": "Still working here",
  "请选择结束年月": "Please select the end year and month",
  "请选择起始年月": "Please select the start year and month",
  "居住地址": "Residential Address",
  "姓名不能为空": "Name cannot be empty",
  "还在这里学习": "Still learning here",
  "邮箱和手机设置请到": "For e-mail and cell phone settings, please go to",
  "图片过大": "Image is too large",
  "新浪微博主页输入不正确,请输入有效的URL": "The input for Sina Weibo homepage is incorrect, please enter a valid URL",
  ...
  "记录标题": "Record Title",
  "字段设置": "Field Settings",
  "开启后，平铺类型的选项字段会打印没有选中的选项": "Once enabled, the tiled option fields will print the unselected options",
  ...
  "构成要素不存在或已删除": "The component does not exist or has been deleted",
  ...
  "导出文件准备完成": "Export file preparation completed",
  ...
  "上传成功后会发送短信/邮箱邀请用户注册外部门户": "After the upload is successful, an invitation will be sent via SMS/email for users to register for the external portal.",
  "Excel表格第一行必须是字段名称，为保证短信发送成功请务必保证手机号真实有效，": "The first row of the Excel worksheet must be the field names. To ensure the successful sending of SMS, please ensure that the phone number is valid and effective.",
  ...
  "其他应用下的工作表": "Worksheets under other applications",
  ...
  "短信通知内容设置": "SMS Notification Content Settings",
  "已输入 %0  个字（含签名），短信按 %1 条计费": "A total of %0 characters (including signature) have been entered, and SMS is billed at %1 messages.",
  "通知：": "Notice:",
  "填写手机号": "Enter mobile number",
  "修改用户信息": "Edit User Information",
  "注销用户": "Delete User",
  "保存失败，请稍后再试": "Save failed, please try again later",
  "生成地址": "Generate Address",
  "外部门户通过配置注册方式、登录方式、角色可生成多个链接，实现外部用户个性化登录。": "The external portal can generate multiple links through the configuration of registration methods, login methods, and roles, allowing for personalized login for external users.",
  ...
  "登录时需同意用户协议和隐私条款": "You need to agree to the user agreement and privacy policy when logging in",
  "只勾选微信登录后首次扫码后需要输入手机号与微信绑定，后续可单独微信扫码快速登录。": "WeChat scan for quick login if only select to input phone number and bind with WeChat after first scan.",
  "通过审核的用户": "Approved users",
  "仅定向邀请的用户": "Invitation-only users",
  "允许访问的用户": "Users Allowed Access",
  "验证码每条%0，将自动从企业账户扣除。": "The verification code for each %0 will be automatically deducted from the enterprise account.",
  "门户名称": "Portal Name",
  ...
  "外部用户通过账号密码或微信扫码登录后，需要额外进行验证码验证，验证通过后才能成功登录": "External users need to perform additional verification via a verification code after logging in with their account password or WeChat scan code, and they can successfully log in after passing the verification.",
  ...
  "切换后，已有的外部讨论内容全部归为内部讨论，外部用户对其不可查看且不能回复；": "After switching, all existing external discussion content will be classified as internal discussions, inaccessible and unresponsive to external users;",
  "确定切换为可见全部讨论？": "Are you sure to switch to view all discussions?",
  "切换后，讨论分为两个讨论区域，外部用户只能参与外部讨论": "After switching, the discussion is divided into two discussion areas, and external users can only participate in external discussions.",
  "切换后，应用成员回复已有讨论，回复内容归属于内部讨论，外部用户不可查看且不能回复": "After switching, application members reply to existing discussions, and the reply content belongs to internal discussions, which external users cannot view or reply to.",
  ...
  "外部用户与成员共用一个讨论区域，可见全部讨论内容": "External users and members share a discussion area, where all discussion content is visible.",
  "分为内部和外部两个讨论区，外部用户不可见内部讨论区": "Divided into internal and external discussion areas, external users cannot see the internal discussion area.",
  "新用户注册、激活时通知管理员": "Notify administrator during new user registration and activation",
  "允许查看审批流转详情": "Allow viewing of approval flow details",
  "审核结果短信通知外部用户": "Notification of review results via SMS to external users",
  "启用水印配置后，将在外部门户内显示当前使用者的姓名+手机号后4位或邮箱前缀": "After enabling watermark configuration, the current user's name + last 4 digits of their phone number or email prefix will be displayed on the external portal.",
  "水印设置": "Watermark Settings",
  "有讨论消息时（被提到、被回复）通知外部用户": "Notify external users when there are discussion messages (mentioned, replied)",
  ...
  "组织成员查看": "View Organization Members",
  "设置外部用户的名片层中可以被其他人查看到的信息": "Information in the business card layer of external users that can be viewed by others",
  ...
  "建议上传不小于1920*1080px的封面图片，更利于首页展示，推荐免费图库": "We recommend uploading a cover image of at least 1920*1080px for better display on the homepage. Free image libraries are suggested.",
  ...
  "注册开启审核后，审核结果(通过、拒绝)会短信告知注册用户；外部门户类型设为私有后再添加用户后也会发送邀请通知，支持对短信内容自定义。": "After registration opens for review, the review results (approved, rejected) will be notified to the registered users via SMS; after the external portal type is set to private, adding users will also send invitation notifications, supporting customization of SMS content.",
  "短信收费标准：短信%0/条，自动从企业账务中心扣费。70字计一条短信，超过70字以67字每条计费。每个标点、空格、英文字母都算一个字。短信实际发送可能有10-20分钟的延时。": "SMS charging standard: SMS %0/message, automatically deducted from the enterprise billing center. 70 characters count as one SMS, and over 70 characters are charged at 67 characters per message. Every punctuation mark, space, and English letter counts as one character. There may be a delay of 10-20 minutes in the actual SMS sending.",
  "邮件通知": "Email Notification",
  "收不到短信？": "Didn’t receive the text message?",
  ...
  "发件人名称": "Sender Name",
  "邮件设置": "Email Settings",
  "您是否保存当前页的更改": "Do you want to save changes to the current page?",
  "当前有尚未保存的更改，您在离开当前页面前是否需要保存这些更改。": "There are unsaved changes. Do you need to save these changes before leaving this page?",
  ...
  "短信签名格式不正确": "The SMS signature format is incorrect",
  "复制到常规": "Copy to General",
  "发件人名称不能为空": "Sender name cannot be empty",
  "背景图": "Background Image",
  "用户列表信息名称不能为空": "User list information name cannot be empty",
  "已开启外部用户注册开始/停止时间，但未选择开始/停止时间": "External user registration start/stop time has been enabled, but no start/stop time has been selected",
  "设为默认": "Set as default",
  "最近 7 天": "Last 7 Days",
  "最近一年": "Last Year",
  ...
  "作为权限标签的扩展信息字段": "Extended information field for permission tags",
  ...
  "通过工作表管理应用成员额外的扩展信息字段": "Manage additional extension information fields for application members through worksheets",
  "在角色权限、筛选器中可以使用用户的扩展信息字段来作为动态筛选条件": "User's extended information fields can be used as dynamic filtering criteria in role permissions and filters.",
  "建立用户扩展信息表": "Create User Extension Information Worksheet",
  "可以通过建立成员表来管理销售人员的团队、地区、关联订单等扩展信息": "You can manage sales team members, regions, associated orders, and other extended information by creating a member worksheet.",
  "如在销售管理应用中": "As in the sales management application",
  ...
  "创建中": "Creating",
  "对当前角色下的用户仅授予权限，但不显示应用入口。通常用于跨应用关联数据或引用视图时，只需要用户从另一个应用中进行操作的场景。": "Grant permissions only to users under the current role without displaying the application entry. This is typically used in scenarios where cross-application data association or view referencing occurs, and the user only needs to perform actions from another application.",
  ...
  "邮箱未绑定，请使用手机短信验证！": "Email not bound, please use SMS verification!",
  "两步验证 - 明道云 | APaaS平台、零代码、hpaPaaS、iPaaS、BaaS、快速开发工具、中台应用": "Two-step verification - Mingdao Cloud | APaaS platform, no-code, hpaPaaS, iPaaS, BaaS, rapid development tools, middle-platform applications",
  ...
  "还未绑定明道云帐号": "Account not yet linked to Mingdao Cloud",
  ...
  "如果未收到短信，可尝试重新发送或": "If you haven't received the text message, you can try resending it or",
  ...
  "申请加入失败，您在该企业已离职，请联系管理员恢复权限": "Application to join failed, you have left this company, please contact the administrator to restore permissions",
  "示例：MD1314": "Example: MD1314",
  "加入...": "Join...",
  "已有": "Already",
  "请填写组织门牌号": "Please fill in the organization door number",
  "同事已经在用，我要找到并加入组织": "My colleagues are already using it, I need to find and join the organization",
  "您当前账号默认成为组织的管理员": "Your current account is set as the default administrator of the organization",
  "请填写组织名称": "Please enter the organization name",
  "组织门牌号可以通过管理员获取": "The organization doorplate number can be obtained from the administrator.",
  "创建...": "Create...",
  "新的": "New",
  ...
  "请填写真实信息，方便大家与您联系": "Please fill in the accurate information to facilitate contact with you",
  "YYYY 年 MMMD日": "YYYY MMMM d",
  "YYYY 年 MMMD日 dddd": "YYYY MMMM dddd",
  "第%0周": "Week %0",
  "任务不可更改": "Task cannot be changed",
  "全天": "All Day",
  "您确定编辑重复日程吗?": "Are you sure to edit the recurring schedule?",
  ...
  "在 %0": "At %0",
  "在第 %0 天": "On day %0",
  "，共 %0 次": ", a total of %0 times",
  "，截止到 %0": "As of %0",
  "邀请成功，但有%0位用户邀请失败，外部用户短信邀请用量达到上限": "Invitation successful, but %0 users failed to be invited, and the SMS invitation quota for external users has reached its limit.",
  ...
  "邀请短信发送数量已达最大限制。": "The number of invitation text messages sent has reached the maximum limit.",
  "您确定退出该日程吗？": "Are you sure to exit this schedule?",
  "您确定编辑日程吗": "Are you sure to edit the schedule?",
  "您确定退出重复日程吗？": "Are you sure to exit the duplicate schedule?",
  "您确定移出日程成员吗？": "Are you sure to remove the schedule member?",
  "无权限或日程已删除": "No permission or schedule has been deleted",
  "您确定移出重复日程成员吗？": "Are you sure to remove the duplicate schedule members?",
  "您确定删除日程吗？": "Are you sure to delete the schedule?",
  "您确定删除重复日程吗?": "Are you sure to delete the duplicate schedule?",
  ...
  "回复了你": "Replied to you",
  "在回复中提到了你": "You were mentioned in the reply",
  "在任务讨论中提到了你": "You were mentioned in the task discussion",
  "在回复中提到了你所在的群组": "Your group was mentioned in the reply",
  "在任务讨论中回复了你": "Replied to you in the task discussion",
  "在项目讨论中提到了你": "You were mentioned in the project discussion",
  "在项目讨论中回复了你": "Replied to you in the project discussion",
  "发表了日程讨论": "Published the schedule discussion",
  "在日程讨论中回复了你": "Replied to you in the schedule discussion",
  "在日程讨论中提到了你": "mentioned you in event discussion",
  "发表了审批讨论": "Posted an approval discussion",
  "在审批讨论中提到了你": "You were mentioned in the approval discussion",
  "在考勤讨论中回复了你": "Replied to you in the attendance discussion",
  "发表了考勤讨论": "Posted attendance discussion",
  "在考勤讨论中提到了你": "You were mentioned in the attendance discussion",
  "在审批讨论中回复了你": "Replied to you in the approval discussion",
  "在%0讨论中回复了你": "Replied to you in the discussion of %0",
  "发表了%0讨论": "Posted %0",
  "Ctrl+Enter换行，": "Ctrl+Enter to add a new line,",
  "点击切换输入方式": "Click to switch input method",
  "Enter换行，": "Enter to wrap line",
  "在%0讨论中提到了你": "You were mentioned in the discussion of %0",
  ...
  "所有联系人": "All Contacts",
  "我的群组": "My Group",
  "其他协作关系": "Other Collaboration Relationships",
  ...
  "适应主题": "Adapt Theme",
  "全局颜色": "Global Color",
  "为所有图表设置统一颜色，全局颜色将覆盖图表本色的颜色配置。": "Set a uniform color for all charts; the global color will override the original color configuration of the charts.",
  ...
  "创建群组进行协作，群组可以设置管理员管理群组成员，并可作为动态分享范围，关联部门": "Create a group for collaboration; the group can set administrators to manage group members and can serve as a dynamic sharing scope, linking departments.",
  "通讯录": "Contacts",
  "发起聊天": "Start Chat",
  "取消置顶": "Cancel Pin",
  "字体大小": "Size",
  ...
  "隐藏会话详情": "Hide Conversation Details",
  "查看文件": "View File",
  ...
  "邀请好友": "Invite Friends",
  "快去%0加入当前%1吧": "Go and join the current %1 with %0 now!",
  "%0条未读消息": "%0 unread messages",
  "有人@了你": "Someone mentioned you",
  "%0创建成功": "%0 created successfully",
  "加载失败，点击重新加载": "Load failed, click to reload",
  "没有更早的历史消息了": "There are no earlier historical messages.",
  "查看动态": "View Posts",
  ...
  "网络已断开，正在重新连接": "Network disconnected, reconnecting",
  ...
  "从代码片段库中选择": "Select from code snippet library",
  "搜索来源名称": "Search Source Name",
  "%0 个API": "%0 APIs",
  "筛选时间范围": "Filter Date Range",
  "查看所有引用此 API 发送的请求日志": "View all request logs sent using this API",
  "已授权给 %0 个应用": "Authorized for %0 applications",
  "API设置": "API Settings",
  "编写代码对输入参数进行处理后用于 API 请求参数，如计算签名等": "Write code to process input parameters for API request parameters, such as calculating signatures, etc.",
  ...
  "请选择.mdy格式的应用文件": "Please select the application file in .mdy format",
  "发布 API": "Publish API",
  "更新发布": "Update Release",
  ...
  "申请上架到API库": "Apply to be listed in the API library",
  ...
  "数据同步任务": "Data Synchronization Task",
  ...
  "镜像": "Mirror",
  "在外部数据库中创建工作表数据的镜像，并保持同步": "Create a mirror of the worksheet data in the external database and keep it synchronized",
  ...
  "在各模块上传文件时，会计入每月上传量。免费用户上传流量为300M/月，付费版用户10G/月，多个组织可叠加。": "When uploading files in various modules, the monthly upload volume will be counted. Free users have an upload limit of 300M/month, while paid users have 10G/month, and multiple organizations can stack this limit.",
  "文件夹日志": "Folder Log",
  ...
  "拖拽文件到这里上传": "Drag and drop files here to upload",
  "选择文件夹": "Select Folder",
  ...
  "存入知识": "Store Knowledge",
  "链接有效期至%0": "The link is valid until %0",
  "打开APP": "Open APP",
  "通过%0明道云协作平台%1分享": "Share via %0Mingdao Cloud Collaboration Platform%1",
  "创建消息": "Create Message",
  "AI对话": "AI Dialogue",
  ...
  "公开范围：": "Scope of Disclosure:",
  "公开给指定群组": "Open to specified group",
  "复制项目": "Copy Project",
  ...
  "仅允许群主及管理员邀请新成员": "Only group owners and administrators can invite new members",
  ...
  "等待审批加入群组": "Waiting for approval to join the group",
  ...
  "位置": "Location",
  "请在移动端中获取当前位置": "Please get the current location on the mobile device",
  "子表数量达到上限": "The number of sub-forms has reached the limit",
  ...
  "移除或交接当前用户作为成员直接加入的应用（不包含通过部门、组织角色、职位加入的应用）": "Remove or hand over the applications that the current user has directly joined as a member (excluding applications joined through department, organizational roles, or positions)",
  "交接当前用户作为流程拥有者、通知人和节点负责人的工作流": "Hand over the current user as the process owner, notifier, and node responsible for the workflow",
  "交接给": "Hand over to",
  "交接工作：%0": "Handing over work: %0",
  "选择工作流": "Select Workflow",
  "交接当前用户未处理的流程待办": "Hand over the current user's unprocessed workflow tasks",
  ...
  "满足搜索范围的账户可登录平台": "Accounts that meet the search criteria can log in to the platform",
  ...
  "开放接口": "Open API",
  "此密钥是用于访问系统企业授权开放API接口的凭证": "This key is used as a credential to access the system's enterprise authorized open API interface.",
  "根据组在对应的DN检索账户": "Retrieve accounts based on the group in the corresponding DN",
  ...
  "勾选后，在用户使用LDAP登录时，将同步以下账号信息": "After selection, the following account information will be synchronized when the user logs in using LDAP",
  ...
  "2. 为保证您在明道云功能的正常使用，授权时请保持默认选择，把开放平台账号管理权限统一授权给明道云": "2. To ensure the normal use of features in Mingdao Cloud, please keep the default selection when granting authorization and uniformly grant the account management permissions of the open platform to Mingdao Cloud.",
  "成功取消绑定": "Successfully unbound",
  ...
  "申请角色请求": "Request Role Application",
  "允许申请管理员": "Allow application for administrator",
  "我的角色": "My Role",
  "退款订单": "Refund Order",
  "订单明细": "Order Details",
  ...
  "商户进件是由第三方支付公司（中投支付）提供，请按照支付公司要求完成资料填写及签约": "Merchant onboarding is provided by a third-party payment company (CIC Payments). Please complete the information filling and signing according to the requirements of the payment company.",
  ...
  "支付剩余时间：": "Remaining time for payment:",
  ...
  "确认订单": "Confirm Order",
  "付款人ID": "Payer ID",
  "支付内容：%0": "Payment Content: %0",
  "扫码支付": "Scan to Pay",
  "订单编号：%0": "Order Number: %0",
  "收款方：%0": "Payee: %0",
  "下单时间：%0": "Order Time: %0",
  "应付金额：": "Amount Payable:",
  "订单已生成，请使用移动设备扫码完成支付": "The order has been generated. Please use a mobile device to scan and complete the payment.",
  "订单已生成，请完成确认": "The order has been created, please complete the confirmation",
  "订单已生成，请于 %0 内完成确认": "The order has been created, please confirm within %0",
  ...
  "退款金额": "Refund Amount",
  "最多可退款%0元": "A maximum refund of %0 yuan is available",
  "10万": "100,000",
  "设置用户加入组织时的规则和需要填写的信息": "Set the rules and required information for users joining the organization",
  "安全 - 账号": "Security - Account",
  "全部退款": "Full Refund",
  "设置成员在可以看到的组织架构范围": "Set the range of the organizational structure that members can see",
  "安全 - 数据": "Security - Data",
  "屏幕水印": "Screen watermark",
  "禁止成员下载应用、讨论附件，保护组织文件安全": "Prohibit members from downloading applications and discussing attachments to protect organizational document security",
  "已设置：禁止所有设备下载": "Set: Disallow download on all devices",
  "启用水印配置后，将在组织所有应用内显示当前使用者的姓名": "Once watermark configuration is enabled, the current user's name will be displayed in all applications of the organization.",
  "加密规则": "Encryption Rules",
  "单附件上传": "Single Attachment Upload",
  "已设置：禁止所有Web移动端下载": "Set: Disable all Web mobile downloads",
  "全局限制应用中工作表、讨论附件中上传的单个文件大小。可设置白名单": "Global limit on the individual file size uploaded in worksheets and discussion attachments in the application. Whitelist can be set.",
  "配置工作表字段加密存储时可以选择的加密方式": "Encryption methods available for configuring encrypted storage of worksheet fields",
  "禁止所有设备下载": "Prohibit download on all devices",
  "系统支持的附件大小上限为 %0，可设置组织下允许的附件大小上限": "The maximum attachment size supported by the system is %0, and you can set the maximum attachment size allowed for the organization.",
  "已选择%0个应用": "%0 applications selected",
  "保存失败，超出上限": "Save failed, exceeded limit",
  "限制方式": "Restriction Method",
  "额外配置": "Additional Configuration",
  "单个附件大小": "Size of a single attachment",
  ...
  "上传图标保留颜色": "Upload icon retains color",
  "上传图标": "Upload Icon",
  "已选中%0个": "%0 selected",
  "%0列表": "%0 List",
  "查看%0": "View %0",
  ...
  "已关闭:%0": "Closed: %0",
  "关闭后，全组织下的自定义按钮、审批配置了登录密码验证的地方必须每次验证密码后方可继续操作": "After closing, custom buttons and approval configurations that have password verification in the entire organization must validate the password each time before continuing to operate.",
  ...
  "在工作表和工作流的汇报关系检索时，若当前用户的所有下级用户总数超过2000（含），系统将默认仅获取当前用户的“直属下一级”所有用户。": "When retrieving the reporting relationships of the worksheet and workflow, if the total number of all subordinate users of the current user exceeds 2000 (inclusive), the system will default to only retrieving all users of the current user's \"direct subordinate level.\"",
  ...
  "无外协人员": "No external collaborators",
  ...
  "计费外部用户人数": "Number of Billable External Users",
  ...
  "从应用库中安装%01004": "Install from the app library",
  "从空白创建%01003": "Create from Blank",
  ...
  "修改名称和图标%01007": "Modify Name and Icon",
  "复制应用%01008": "Copy Application",
  "删除应用%01009": "Delete Application",
  "上传Excel文件创建您的应用": "Upload Excel file to create your application",
  "管理用户": "Manage Users",
  "设置外部链接": "Set external link",
  "创建空白应用": "Create Blank Application",
  "添加分组": "Add Group",
  "安装应用库中现成的开箱模板，您可以直接使用，也可以继续按需修改": "Install the ready-made templates from the application library; you can use them directly or modify them as needed.",
  "从应用库安装": "Install from the application library",
  "从Excel创建应用": "Create applications from Excel",
  "请填写名称": "Please enter a name",
  "例：产品管理": "Product Management",
  "现在，从创建一个应用开始吧": "Now, let's start by creating an application.",
  "编辑分组": "Edit Group",
  "无分组，可从左侧列表创建": "No grouping, can be created from the left list",
  "无分组": "No Group",
  ...
  "删除分组成功": "Group deletion successful",
  ...
  "复制中...": "Copying...",
  "我以外协身份加入的其他组织的应用": "Applications of other organizations I joined as an external collaborator",
  "删除应用": "Delete Application",
  "将复制目标应用的应用结构、流程和角色。应用下的数据和成员不会被复制": "The application structure, processes, and roles of the target application will be copied. The data and members under the application will not be copied.",
  "橙红": "Orange Red",
  ...
  "空白子表": "Blank Subtable",
  "移动至其他应用": "Move to other applications",
  ...
  "应用时区是整个应用中使用的统一时间标准，确保所有团队成员在数据筛选、统计时看到一致的时间信息": "The application timezone is the unified time standard used throughout the application, ensuring that all team members see consistent time information when filtering and analyzing data.",
  "提交申请": "Submit Application",
  "设置用户在哪些设备环境下可见此应用，管理员和开发者在PC端始终可见": "Set which device environments the user can see this application; administrators and developers are always visible on the PC side.",
  ...
  "应用开启维护状态后，只有管理员和开发者可以访问应用进行更新维护，其他成员无法使用应用": "Once the application is in maintenance mode, only administrators and developers can access the application for updates and maintenance, while other members cannot use the application.",
  ...
  "暂未添加工作表": "No worksheet added yet",
  ...
  "添加语言": "Add Language",
  "确认是否删除 %0 ?": "Are you sure you want to delete %0?",
  "最后更新时间": "Last Updated",
  "暂无其他语言": "No other languages available",
  "删除后无法恢复语言": "Deleted language cannot be restored",
  "设置用户在访问应用时可以使用的语言": "Set the language users can use when accessing the application",
  "备份": "Backup",
  "共有 %0 个应用项": "There are %0 application items",
  ...
  "不限制备份文件个数": "No limit on the number of backup files",
  ...
  "备份文件一年有效，占用应用附件存储量": "Backup files are valid for one year and occupy application attachment storage capacity",
  ...
  "支持仅备份应用或者备份应用和数据，备份后的文件可以下载保存": "Supports backing up applications only or backing up applications and data, and the backup files can be downloaded and saved",
  ...
  "彻底删除成功": "Successfully deleted completely",
  ...
  "验证规则可以规范数据的录入。当满足条件时，禁止保存记录并对指定字段提示错误。": "Validation rules prevent saving records and show errors on certain fields when conditions are met.",
  "编辑%0规则": "Edit %0 rule",
  ...
  "应用于指定的视图": "Applied to the specified view",
  "快捷编辑": "Quick Edit",
  "执行自定义动作": "Execute Custom Action",
  "内部访问链接": "Internal Access Link",
  "系统默认打印": "System Default Print",
  ...
  "审批流转详情": "Approval Flow Details",
  "表格视图可以单元格直接编辑；": "The grid view allows direct editing of cells;",
  "在工作表右上方显示的创建记录按钮。关闭后，则无法直接在工作表中创建记录，只能通过关联记录等其他位置创建": "The create record button is displayed at the top right of the worksheet. Once closed, records can no longer be created directly in the worksheet and can only be created through associated records and other locations.",
  ...
  "子表记录最多复制200条;": "Up to 200 records can be copied in the sub-table;",
  "保留方式": "Retention Method",
  "子表中的关联记录最多复制5条。": "You can copy up to 5 associated records in the sub-table.",
  "关联记录（列表）不复制;": "Related records (list) do not copy",
  "%0个视图下的记录": "Records under %0 view",
  "修改失败，请稍后再试！": "Modification failed, please try again later!",
  "%0个视图": "%0 views",
  "关闭%0": "Close %0",
  ...
  "应用于指定的视图下的记录": "Records under the specified view",
  "批量操作中的导出功能需额外设置": "The export function in batch operations requires additional configuration.",
  "仅系统角色可见（包含管理员、运营者、开发者）": "Visible only to system roles (including administrators, operators, and developers)",
  "启用后，在连续创建数据时可以自动填充上次提交的内容，减少重复输入": "Enable auto-fill of last submission to reduce repetitive input when creating data continuously",
  "系统编号": "System Number",
  ...
  "确认层设置": "Confirm Layer Settings",
  "详细内容": "Detailed Content",
  "提示信息": "Notification",
  "按钮文案": "Button text",
  "修改按钮名称": "Edit Button Name",
  "按钮名称": "Button Name",
  "提交后：": "After submission:",
  ...
  "在点击表单提交时，弹出二次确认层确认后提交": "A confirmation prompt will appear before submitting the form.\n",
  "保留所有提交内容": "Keep all submitted content",
  "提交按钮": "Submit Button",
  "存草稿": "Save Draft",
  "启用后，通过点击表单提交按钮创建的记录，在触发工作流后会立即开始执行（无需系统默认的5s延时等待）。当执行完成或等待时会同时刷新前端数据。": "After enabled, records created by clicking the form submission button will begin executing immediately after the workflow is triggered (without the system's default 5 seconds delay). The front-end data will be refreshed simultaneously when the execution is completed or while waiting.",
  ...
  "取消星标成功": "Successfully unmarked as favorite",
  "设为%0": "Set as %0",
  ...
  "办理": "Handle",
  "处理中…": "Processing…",
  "添加委托成功": "Delegation added successfully",
  "更新委托成功": "Delegation updated successfully",
  "发起委托后，您负责的审批、填写事项将转交给被委托人": "After initiating the delegation, the approvals and fillable matters under your responsibility will be handed over to the delegatee.",
  "委托给": "Delegate to",
  "结束": "End",
  "此刻": "At this moment",
  ...
  "提交中...": "Submitting...",
  "加签": "Add Signature",
  "委托截止": "Delegation Deadline",
  "请填写完整内容": "Please fill in all fields",
  "必须选择一个人员": "Must select a user",
  "手动输入": "Manual Input",
  "将委托给": "Delegate to",
  "退回到": "Return to",
  "添加%0位审批人": "Add %0 approver(s)",
  "%0发起了委托": "%0 has initiated the委託",
  ...
  "角色调试：": "Role Debugging:",
  "是否删除子表记录 ?": "Do you want to delete the sub-table record?",
  "自由输入": "Free Input",
  "不排序": "No sorting",
  ...
  "请正确填写%0": "Please fill out %0 correctly",
  ...
  "大型专业版": "Large Prpfessional Edition",
  "专业版": "Professional Edition",
  "专业版单个工作表下最多可创建100万条行记录，请升级版本以创建更多行记录": "The Professional Edition allows a maximum of 1 million row records per worksheet. Please upgrade to create more row records.",
  ...
  "旗舰版单个应用下最多可创建100个工作表，请联系明道云顾问升级更多用量": "Ultimate Edition can create up to 100 sheets per app. Contact Mingdao Cloud consultant to upgrade for more usage.",
  ...
  "搜索人员": "Search Personnel",
  "按部门选择": "Select by Department",
  "全体人员": "All personnel",
  "只看我加入的部门": "Only view the departments I joined",
  ...
  "学习视频": "Learning Video",
  "博客": "Blog",
  "社区提问": "Community Questions",
  "寻找伙伴支持": "Looking for partner support",
  ...
  "聊天": "Chat",
  "共享文件夹": "Shared Folder",
  "暂无工作地点": "No work location available",
  "请填写工作地点": "Please fill in the work location",
  "暂无职位": "No positions available",
  "请填写职位": "Please fill in the position",
  "请填写工号": "Please enter your employee number",
  ...
  "你撤回了成员“%0”的一条消息": "You have recalled a message from member \"%0\"",
  "新消息": "New Message",
  ...
  "请选择你作为管理员或开发者的应用": "Please select the application you are using as an administrator or developer",
  ...
  "从左侧添加组件，开始创建页面": "Add components from the left side to start creating your page",
  ...
  "添加失败": "Add failed",
  "没有搜索到相关应用和应用项": "No related applications and application items found",
  "已收藏": "Favorited",
  ...
  "动态墙": "Post",
  "加载更多": "Load more",
  "可尝试更换关键字搜索": "Try changing the keyword search",
  "更新时间：": "Last updated:",
  ...
  "根据 code 获取访问令牌": "Obtain access token based on code",
  "配置授权认证地址，用户点击发起授权。state值不需要额外配置，发起授权时会自动生成拼接。": "Configure the authorization authentication address, and the user clicks to initiate the authorization. The state value does not require additional configuration and will be automatically generated upon initiating the authorization.",
  "获取 Access Token": "Obtain Access Token",
  ...
  "参数值": "Parameter Value",
  "用于配置鉴权时使用，设置为隐藏后，查看时该参数值将以掩码代替": "Used for configuring authentication. When set to hidden, the parameter value will be masked when viewed.",
  "暂无相关内容": "No related content available",
  "请选择类型": "Please select a type",
  "参数名称": "Parameter Name",
  "隐藏参数会加密存储，不可取消隐藏": "Hidden parameters will be stored encrypted and cannot be unhidden.",
  "保存并继续": "Save and Continue",
  "集合": "Collection",
  "请求时间 %0, 耗时 %1 秒": "Request time %0, duration %1 seconds",
  "请求结果": "Request Result",
  "官网地址": "Official website address",
  "连接名称": "Connection Name",
  "请求时间 %0, 状态码 %1，耗时 %2 秒": "Request time %0, status code %1, duration %2 seconds",
  "API 服务厂商": "API Service Provider",
  "你暂时没有权限查看该连接！": "You do not have permission to view this link at the moment!",
  "申请上架到API 库": "Apply to be listed in the API library",
  ...
  "消息队列": "Message Queue",
  "前往修改": "Go to modify",
  "支持.png、.jpg图片格式，不小于80*80px": "Supports .png and .jpg image formats, minimum size 80*80px",
  ...
  "只对“通过”审批的数据进行分支处理": "Only process branching for data that is \\\"approved through\\\"",
  "\"%0\"应用": "\"%0\" Application",
  "请先添加一个 ”关联记录“ 字段": "Please add a field of associated record first.",
  "创建或加入组织以启用“下属任务”，查看下属和协作同事的任务进展": "Create or join an organization to enable \\\"subordinate tasks\\\" and view the progress of tasks for subordinates and collaborating colleagues.",
  "非“人员”类型的成员，只能由管理员或运营者操作": "Non-\\\"person\\\" type members can only be operated by administrators or operators.",
  "选择一个“成员”字段，用于标识匹配系统登陆的用户，进而读取用户关联的扩展属性": "Select a \\\"Member\\\" field to identify the user matching the system login, and then read the user's associated extension attributes.",
  "应用“${appName}”正在导入升级，完成后会通知您": "Failed to apply \\\"${appName}\\\" import upgrade.You will be notified when it is completed.",
  "应用“${appName}”导入升级完成": "The import upgrade of the application \\\"${appName}\\\" is complete",
  "应用“${appName}”导入升级失败": "Import upgrade of application \\\"${appName}\\\" failed",
  ...
  "（关联表“%0”）": "(Related Table \\\"%0\\\")",
  "\"%0\"工作表": "\\\"%0\\\" worksheet",
  "工作流 “%0” 存在错误！": "Workflow \\\"%0\\\" has an error!",
  "插件 “%0” 存在错误！": "An error exists in plugin \\\"%0\\\"!",
  "工作表 “%0”": "Worksheet \\\"%0\\\"",
  "关联记录 “%0”": "Associated Record \\\"%0\\\"",
  "级联选择 “%0”": "Cascade Selection \\\"%0\\\"",
  "所有和标签“%0”有关的任务": "All tasks related to the tag \\\"%0\\\"",
  "搜索和“%0”相关的任务>": "Search for tasks related to \\\"%0\\\">",
  "将项目负责人移交给“%0”": "Transfer the project leader to  \\\"%0\\\"",
  "在组织 “%0” 下编辑项目": "Edit projects under the organization \\\"%0\\\"",
  "“%0” 导出文件已准备完成，文件下载链接将于24小时失效，请尽快下载": "The exported file \\\"%0\\\" is ready. The download link will expire in 24 hours, please download ASAP.",
  "无法直接删除选项集 “%0”": "Cannot delete option set \\\"%0\\\" directly",
  "管理应用“%0”": "Manage Application \\\"%0\\\"",
  "移动工作流“%0”至其他应用": "Move workflow \\\"%0\\\" to other applications",
  "彻底删除项目“%0”": "Permanently delete the project \\\"%0\\\"",
  "复制应用 “%0”": "Copy application \\\"%0\\\"",
  "删除分组\"%0\"": "Delete group \"%0\"",
  "操作失败，已启用“%0”集成": "Operation failed, \\\"%0\\\" integration has been enabled",
  ...
  "API 删除后将不可恢复，确认删除吗？": "Deleting the API cannot be undone. Are you sure you want to delete it?",
  ...
  "没有文件": "No files",
  "已存入 知识“我的文件” 中": "Saved to Knowledge \\\"My Files\\\"",
  "保存到": "Save to",
  ...
  "输入密码": "Enter password",
  "插件到期后不可用，留空则为永久有效": "The plugin will be unavailable after expiration; leaving it blank means it will be permanently valid.",
  "随机生成": "Random Generation",
  "导入时校验授权密钥": "Validate Authorization Key During Import",
  "组织编号格式": "Organization Number Format",
  ...
  "有%0位外部用户邀请失败。外部用户短信邀请用量达到上限。": "%0 external user invitations failed. The SMS invitation quota for external users has been reached.",
  ...
  "逾期%0天完成": "Completed %0 days overdue",
  "开始": "Start",
  "提前%0天完成": "Complete %0 days in advance",
  "逾期%0天": "Overdue %0 days",
  "逾期%0小时完成": "Completed %0 hours overdue",
  ...
  "查询设置": "Query Settings",
  "扫一扫分享给好友": "Scan to share with friends",
  ...
  "人员、部门、组织角色、自由连接、扩展值的文本字段不能用于公开表单，原表单内的以上字段将被自动隐藏。": "The text fields for personnel, department, organizational roles, free connections, and extended values cannot be used in public forms. The above fields in the original form will be automatically hidden.",
  "页面标题": "Page Title",
  ...
  "选择作为查询条件的字段。如设置多个条件，则所有条件都为必填。只支持文本类型字段进行查询，如：学号、身份证号、手机号、订单编号": "Select the fields to be used as query criteria. If multiple conditions are set, all conditions are required. Only text type fields can be queried, such as: student ID, ID card number, mobile phone number, order number.",
  ...
  "价税合计（小写）": "Total with Tax Included in Arabic Numbers",
  "价税合计（大写）": "Total with Tax Included in Uppercase",
  ...
  "填写金额": "Enter Amount",
  "最大支持输入16位数字": "Supports a maximum input of 16 digits",
  ...
  "检查项": "Check Item",
  "汇总关联记录或子表中的数据，如：汇总订单明细中的商品总价，最大支持汇总1000行数据。": "Summarize data from related records or sub-tables, for example: summarize the total price of products in order details, supporting a maximum of 1000 rows of data.",
  "将当前记录中的字段进行数值或日期计算": "Perform numeric or date calculations on the fields in the current record",
  "可通过定位输入地理位置": "You can enter your location by positioning it",
  ...
  "请填写邮箱地址": "Please enter your email address",
  ...
  "函数公式": "Function Formula",
  "日期公式": "Date Formula",
  "节点负责人": "Node Leader",
  "编辑状态下不支持查看": "Viewing is not supported in edit mode",
  ...
  "添加标签页": "Add Tab",
  "使用标签页归类字段，保持页面简洁": "Use tabbed categories for fields to keep the page tidy",
  "同时把标签页显示在顶部": "Show the tab pages at the top",
  "添加字段": "Add Field",
  "公式验证失败": "Formula validation failed",
  "输入验证信息失败": "Input validation information failed",
  ...
  "标签页内字段将移动到外部，不会被删除": "Fields in the tab will be moved outside and will not be deleted",
  ...
  "我已通过": "I have passed",
  "我已填写": "I have filled out",
  "我已转交": "I have forwarded",
  "流程否决": "Process Rejection",
  "我已转审": "I have transferred for review",
  "待查看": "Pending Review",
  "流程中止": "Process Stopped",
  ...
  "已筛选": "Filtered",
  "Webhook": "Webhook",
  "通过审批": "Through Approval",
  "您将通过选择的%0个审批事项": "You will proceed by selecting the %0 approval items",
  "否决审批": "Reject Approval",
  "循环": "Loop",
  ...
  "新建封装业务流程": "Create a packaged business process",
  ...
  "包含%03058": "Includes",
  "下级不包含%03081": "Subordinates not included",
  "标题不包含%03086": "Title not included",
  "开头是%03060": "It starts with",
  "不为空%03065": "Not empty",
  "结尾是%03062": "The end is",
  "为空%03065": "Empty",
  "大于%03066": "Greater than",
  "小于%03067": "Less than",
  "在范围内%03070": "Within range",
  "开始等于": "Start equals",
  "晚于%03073": "Later than",
  "早于%03072": "Earlier than",
  "开始晚于": "Starts later than",
  "开始早于": "Start earlier than",
  "开始已填写": "Started filled",
  "开始未填写": "Not filled in yet",
  "结束等于": "End equals",
  "结束早于": "Ends earlier than",
  "不属于%03078": "Not belonging to",
  "属于%03080": "Belongs to",
  "结束晚于": "Ends later than",
  "不选中": "Not selected",
  "结束未填写": "End Unfilled",
  "结束已填写": "Submission Completed",
  "同时包含%03084": "Simultaneously includes",
  "开头不是%03061": "Not the beginning",
  "结尾不是%03063": "Not the end",
  ...
  "可查看%0": "Viewable %0",
  "可分享%0": "Shareable %0",
  "单选下拉菜单": "Single Option Dropdown Menu",
  "拥有工作表所有权限": "Have all permissions for the worksheet",
  "普通成员": "Regular Member",
  ...
  "共%0行，%1/%2页": "Total %0 rows, %1/%2 pages",
  "复制%02003": "Copy",
  ...
  "当前用户所在的部门": "Current User's Department",
  ...
  "当前用户所在的组织角色": "Current user's organizational role",
  "全部联系人": "All Contacts",
  "所有同事": "All colleagues",
  ...
  "请先根据系统提供的字段代码对照表将所需要的字段代码复制后粘贴到对应 的本地的 %0 模板中制作成模板。": "Please first copy the required field codes from the system-provided field code reference table and paste them into the corresponding local %0 template to create the template.",
  ...
  "重新上传": "Re-upload",
  "未指定视图": "View not specified",
  "删除模板": "Delete Template",
  "上传中…": "Uploading…",
  "删除后将无法恢复": "Once deleted, it cannot be recovered",
  "筛选条件": "Filter Conditions",
  "暂无可选字段": "No optional field",
  "设置筛选条件，当满足条件时才显示打印模板。未设置条件始终显示": "Set filter criteria, and the print template will only be displayed when the conditions are met. If no conditions are set, it will always be displayed.",
  "设置在添加按钮，消息通知等需要指代记录时所使用的名称，如：可以修改“客户管理”表的记录名称为“客户”。": "Set the name used to refer to records in the add button, message notifications, etc., for example: you can change the record name of the 'Customer Management' worksheet to 'Customer'.",
  "记录名称": "Record Name",
  ...
  "的负责人": "The person in charge",
  "销售线索管理": "Sales Lead Management",
  "开发者备注修改失败": "Developer note update failed",
  "设置开发者备注，仅应用管理员、开发者和API中可见": "Set developer notes, visible only to application administrators, developers, and in the API",
  ...
  "升序": "Ascending",
  "创建索引": "Create Index",
  "手动为大数据量的工作表建立合适的索引，可以加快工作表检索速度，最多创建%0个。": "Manually creating suitable indexes for large data worksheets can speed up worksheet retrieval, with a maximum of %0 indexes created.",
  "索引类型": "Index Type",
  "索引字段": "Index Field",
  ...
  "保存系统打印的配置为模板，或上传 Word、Excel 模板自由定义记录打印的样式。": "Save the system print configuration as a template, or upload Word or Excel templates to freely define the record printing style.",
  "移动失败": "Move failed",
  ...
  "不显示隐藏的应用项": "Do not show hidden application items",
  ...
  "显示隐藏的应用项": "Show hidden application items",
  "感谢你尝试安装明道云！我们精心挑选了两个初始应用，供您体验。": "Thank you for trying to install Mingdao Cloud! We have carefully selected two initial applications for you to experience.",
  ...
  "打开文件": "Open File",
  "未发起联动筛选": "Linkage filtering not initiated",
  ...
  "组织门牌号 %0": "Organization Number %0",
  "帮助中心": "Help Center",
  "(可用于邀请其他人加入该网络)": "(Can be used to invite others to join the network)",
  "%0 到期": "%0 due",
  ...
  "否决": "Reject",
  "全选%0条可批量审批的记录": "Select all %0 records available for batch approval",
  ...
  "两步验证是在输入账号密码后，额外增加一道安全屏障（手机短信或邮箱验证码），保障您的帐号安全": "Two-factor authentication adds an extra layer of security (via SMS or email verification code) after entering your username and password, ensuring the safety of your account.",
  "%0前使用": "Used before %0",
  "现在": "Now",
  "我已经绑定了微信账号": "I have bound my WeChat account",
  "使用微信扫码绑定账号，开启登录微信提醒": "Use WeChat QR code to bind account and enable WeChat login notifications",
  ...
  "关闭后不允许在同类型设备（网页端、移动客户端）上同时登录": "Logging in on the same type of device (web or mobile) is not allowed after closing",
  "密码,8-20位，必须字母+数字": "Password, 8-20 characters, must include letters and numbers",
  ...
  "两次输入密码不一致": "The two password entries do not match",
  ...
  "账户": "Account",
  "您尚有未退出的组织，请先至 个人中心-我的组织 退出所有组织，方可注销": "You still have organizations you haven't exited. Please go to Personal Center - My Organizations to exit all organizations before you can cancel your account.",
  ...
  "使用：": "Use:",
  "密钥申请成功，请复制后去申请页面填写": "Key application successful, please copy and go to the application page to fill in",
  ...
  "社区版（私有部署免费版）": "Community Edition (Free Private Deployment)",
  ...
  "跟随设备时区（配置时区，依据您正在使用设备的系统时区设置）": "Follow device time zone (Configure time zone based on the system time zone settings of your device)",
  "包含全球地图，暂不支持搜索名称定位。": "Includes a global map; name search localization not supported at this time.",
  "高德地图": "Amap",
  "Google地图": "Google Maps",
  "地图": "Map",
  "支持搜索地点名称定位，地图信息只包含：中国大陆、香港、澳门、台湾地区": "Supports searching for location names for positioning; the map information only includes: mainland China, Hong Kong, Macau, and Taiwan.",
  "浏览器标签闪烁": "Browser tab flashing",
  "应用返回首页方式": "Method to return to the homepage of the application",
  "备注/签名": "Remarks/Signature",
  "流程节点": "Process Node",
  "(%0操作)": "(%0 operation)",
  "(%0委托)": "(%0 entrusted)",
  "退回到%0": "Return to %0",
  "无需填写": "No need to fill out",
  "预览: %0": "Preview: %0",
  "打印人：": "Printed by:",
  ...
  "您确定要删除表“%0” ?": "Are you sure you want to delete the worksheet \\\"%0\\\"?",
  "导出Excel%06002": "Export Excel",
  "按照原值导出%06000": "Export with Original Values",
  "按显示单位导出%06001": "Export by Display Unit",
  ...
  "千分比": "Percentage",
  "百分比": "Percentage",
  "万%06003": "Ten thousand",
  "千": "thousand",
  "百万": "One million",
  "亿%06004": "Hundred million",
  "向上舍入": "Round up",
  "十亿": "One billion",
  ...
  "已通过该用户申请": "Application approved by this user",
  "同意": "Agree",
  ...
  "扩展": "Expand",
  "开启时，当用户被添加、移除、变更角色时会收到系统通知，关闭时，以上操作不通知用户。": "When enabled, users will receive system notifications when they are added, removed, or their roles are changed. When disabled, these actions will not notify users.",
  ...
  "勾选时，普通角色可以查看应用下所有角色和人员。未勾选时，对普通角色直接隐藏用户入口": "When checked, regular roles can view all roles and personnel under the application. When unchecked, the user entry is directly hidden from regular roles.",
  ...
  "用于系统中发送邮件、短信等计费服务项目自动扣费。为避免系统功能不可用，请保障账户余额充足。【点击查看详细说明】": "Used for automatic billing services for sending emails, SMS, etc. in the system. To avoid system functionality being unavailable, please ensure that the account balance is sufficient. 【Click to view detailed instructions】",
  "已续费": "Renewed",
  "在线创建": "Create Online",
  "7. 如需打印字段所选成员的工号、邮箱、手机号，请将代码：工号: _ID； 邮箱: _Email； 手机号: _Phone。插入到模版中，如#{[member]字段ID$[(_ID;_Email;_Phone)]$}  实现拼接样式：张三(888;1511515@qq.com;13475236985)": "7. To print the selected member's employee ID, email, and phone number, please insert the code: Employee ID: _ID; Email: _Email; Phone: _Phone into the template, such as #{[member]FieldID$[(_ID;_Email;_Phone)]$} to achieve the concatenation style: Zhang San(888;1511515@qq.com;13475236985)",
  "或从系统范例模版快速开始创建": "Or quickly start creating from system sample templates",
  ...
  "认证 - 明道云HAP": "Certification - Mingdao Cloud HAP",
  "认证成功 - 明道云HAP": "Certification successful - Mingdao Cloud HAP",
  "个人认证 - 明道云HAP": "Personal Certification - Mingdao Cloud HAP",
  "（仅支持大陆身份证认证）": "(Only supports Mainland China ID authentication)",
  "开发者交流群": "Developer Community",
  "输入姓名、手机、邮箱、职位或工号均可搜索": "You can search by name, mobile, email, position, or work number",
  ...
  "用量不足时自动消耗余额增补，10元/1万行": "Automatically consume balance to supplement when usage is insufficient, 10 CNY/10,000 rows",
  "下个版本": "Next Version",
  "用量不足时自动消耗余额增补，20元/1GB": "Automatically consume balance to supplement when usage is insufficient, 20 CNY/1GB",
  "已用: %0": "Used: %0",
  "免费试用剩余 %0 天": "Free trial remaining %0 days",
  "组织额度": "Organization Quota",
  "点击查看人数计算规则": "Click to view the rules for calculating the number of people",
  "预警（<%0元）": "Warning (<%0 CNY)",
  "下个版本：%0": "Next version: %0",
  "启用自动增补": "Enable Auto Supplement",
  "平台": "Platform",
  ...
  "1.下载示范模板": "1. Download Sample Template",
  "开始预览": "Start Preview",
  ...
  "点击或拖拽添加，或通过": "Click or drag to add, or through",
  "创建工作流": "Create Workflow",
  "将日常工作与业务流程自动化运行，替代手工操作": "Automate daily tasks and business processes to replace manual operations",
  "当晚上八点时，自动将当日订单数据进行汇总，并生成报告发送邮件给领导查看": "At 8 PM, automatically summarize the day's order data and generate a report to send via email to the leaders for review.",
  "当新成交的客户生日时，当天九点自动给客户发送祝福短信": "When a newly acquired customer's birthday arrives, a congratulatory text message will be automatically sent to the customer at nine o'clock that day.",
  ...
  "用于集成中心的付费API服务，按每次使用的API服务的定价扣费": "Paid API services for the Integration Center, charged based on the pricing for each use of the API service.",
  "韩语": "Korean",
  "西班牙语": "Spanish",
  ...
  "泰语": "Thai",
  "马来语": "Malay",
  "同步任务算力自动增补": "Automatic supplement of computing power for synchronization tasks",
  "用于工作流短信节点或外部门户短信邀请，费用0.1元/条": "Used for workflow SMS nodes or external portal SMS invitations, cost 0.1 yuan/message",
  "发送短信": "Send SMS",
  "发送邮件": "Send Email",
  "用于工作流短信节点或外部门户发送邮件，费用0.03元/封": "Used for sending emails from workflow SMS nodes or external portals, cost 0.03 CNY per email",
  "生成PDF文件": "Generate PDF file",
  "用于工作流获取打印文件节点，费用0.15元/次": "Used to obtain print file nodes in the workflow, cost 0.15 CNY per time",
  "OCR识别": "OCR recognition",
  "用于工作表文本识别字段，费用0.1元/次": "Used for worksheet text recognition field, cost 0.1 CNY per use",
  "余额使用管理": "Balance Management",
  "集成中心API服务": "Integration Center API Service",
  "可上传PNG、JPG，图片格式推荐大小 48x48 px, 文件大小在128KB以内": "You can upload PNG, JPG, recommended image size 48x48 px, file size within 128KB",
  "用于工作流AIGC节点，按每次实际消耗的 token 数量扣费": "Used for workflow AIGC nodes, charges based on the actual number of tokens consumed per usage.",
  "取消绑定后，本组织内与服务号所有相关信息将失效（包含但不限于外部用户、模板消息）请您谨慎操作。": "After unbinding, all related information within the organization related to the service number will become invalid (including but not limited to external users and template messages). Please operate with caution.",
  ...
  "超级管理员可创建和分配角色权限，管理角色下的成员。其他管理员只能看到自己加入的角色或添加同角色成员（按配置）": "Super administrators can create and assign role permissions and manage members under those roles. Other administrators can only see the roles they have joined or add members to the same role (according to configuration).",
  ...
  "启用水印配置后，将在组织所有应用内显示水印。可自定义水印文字": "After enabling the watermark configuration, the watermark will be displayed in all applications of the organization. The watermark text can be customized.",
  "完整支持": "Full Support",
  "建议文字在20个字符以内，超出可能显示不全": "Suggested text should be within 20 characters; exceeding may cause display issues.",
  ...
  "通过微信扫码登录时，需先关注服务号": "You need to follow the service account before logging in with WeChat scan code.",
  "暂未绑定服务号，请前往": "Service number not yet bound, please go to",
  "注册开启审核后，审核结果(通过、拒绝)会短信告知注册用户;外部门户类型设为私有后再添加用户后也会发送邀请通知。": "After registration starts the review process, the review results (approved, rejected) will be notified to the registered users via SMS; after setting the external portal type to private, an invitation notification will also be sent when adding users.",
  "注册开启审核后，审核结果(通过、拒绝)会邮件告知注册用户;外部门户类型设为私有后再添加用户后也会发送邀请通知。": "After registration initiates review, the review results (approved, rejected) will be notified to the registered user via email; after setting the external portal type to private, an invitation notification will also be sent after adding users.",
  ...
  "主题和背景色渐变": "Gradient of theme and background color",
  "背景": "Background",
  "标题栏样式": "Header Bar Style",
  "选择图形": "Select Graphic",
  ...
  "获取单条组织角色": "Get a single organizational role",
  ...
  "应短信运营商要求，组织需完成企业身份认证才可自定义短信签名": "According to the requirements of the SMS service provider, organizations must complete corporate identity verification to customize SMS signatures.",
  ...
  "即可开始集成以及同步通讯录": "You can start integrating and synchronizing the address book",
  "%0属于必填项，请填写后提交": "%0 is a required field, please fill it out and submit",
  "Lark集成": "Lark Integration",
  "关闭Lark集成后，无法再从Lark处进入明道云应用": "After disabling the Lark integration, you will no longer be able to access the Mingdao Cloud application from Lark.",
  "从Lark开放平台获取对接信息，": "Obtain integration information from the Lark Open Platform,",
  "产品功能": "Product Features",
  "开通商户号收款试用": "Activate Merchant Number for Payment Trial",
  ...
  "已付费": "Paid",
  "付费状态": "Payment Status",
  "场景举例：在线教育场景中用户购买课程或服务；各类活动报名在线完成报名费支付；电商零售场景中下单购买商品": "Scenario examples: In the online education scenario, users purchase courses or services; various activities can be registered online with payment of registration fees; in the e-commerce retail scenario, placing orders to purchase goods.",
  ...
  "输入交易单号": "Enter transaction number",
  ...
  "模拟数据": "Simulated Data",
  "选择一条已有记录，模拟表单字段有数据的情况": "Select an existing record to simulate a situation where the form fields have data",
  "模拟只读(env.isDisabled)": "Simulate Read-Only (env.isDisabled)",
  "模拟移动端(env.isMobile)": "Simulate Mobile (env.isMobile)",
  "可从环境参数 \"env\" 中获取本字段控件是否处于移动端环境或只读状态": "You can obtain whether this field control is in a mobile environment or read-only state from the environment parameter \"env\".",
  "已加载记录": "Records Loaded",
  ...
  "先勾选一个字段，然后按下shift键，再勾选或点击另一个字段，这样两个字段之间的字段也会被选中。": "First, check one field, then press the shift key, and check or click another field. This way, the fields between the two fields will also be selected.",
  ...
  "查询或获取一条符合条件的工作表记录": "Query or obtain a record from the worksheet that meets the criteria",
  " 对数值、日期、文本进行数学或函数运算": "Perform mathematical or function operations on numbers, dates, and text",
  "刷新工作表记录中的公式计算、他表字段和汇总等延迟同步结果": "Refresh the delayed synchronization results of formula calculations, fields from other worksheets, and summaries in the worksheet records.",
  ...
  "基于大模型 AI 技术提取文本的数据作为参数输出": "Extract text data based on large model AI technology as parameter output",
  "向用户发送指定内容的系统“工作流”通知消息": "Send system \"worksheet\" notification messages with specified content to users",
  "向用户发送通知消息并附带指定的记录链接": "Send notification messages to users with the specified record link",
  "添加一个人工填写节点，流程将等待执行后再继续": "Add a manual input node, the process will wait to continue after execution",
  ...
  "向当前用户播放指定音效或语音播报指定文本内容": "Play a specified sound effect or voice broadcast the specified text content to the current user",
  ...
  "向当前用户弹窗推送提示、卡片、视图、记录或链接": "Push prompts, cards, views, records, or links to the current user in a pop-up window",
  ...
  "传入参数调用一个封装业务流程，获取输出参数值": "Pass input parameters to call an encapsulated business process and obtain output parameter values",
  "暂停运行当前流程，并在到达指定时间后继续执行": "Pause the current process and resume execution after reaching the specified time",
  ...
  "获取流程中单条记录对象通过自定义打印模板生成的 Word、Excel 或 PDF 文件": "Obtain Word, Excel, or PDF files generated from a single record object in the workflow using a custom print template",
  "获取流程中单条记录对象的对外分享或填写链接": "Get the external sharing or filling link of a single record object in the process",
  "在流程中修改应用下或组织下的全局变量值": "Modify global variable values under the application or organization in the process",
  "组织/部门": "Organization/Department",
  "从成员字段或组织中获取多个成员信息": "Get multiple member information from member fields or organizations",
  "将发送 API 请求、代码块、AI 获取数据对象节点中的JSON 对象解析为后续节点可使用的参数": "Send API requests, code blocks, and parse the JSON objects in the data object nodes obtained by AI into parameters that can be used by subsequent nodes",
  "将指定 URL 发送请求信息并获取": "Send request information to the specified URL and obtain",
  "编写或用 AI 生成 Python 或 Javascript 代码": "Write or generate Python or Javascript code using AI",
  ...
  "从组织角色字段或组织中获取多个组织角色信息": "Retrieve multiple organizational role information from the organizational role field or organization",
  "从组织角色字段或组织中获取单个组织角色信息": "Retrieve single organization role information from the organization role field or organization",
  ...
  "获取单条外部人员": "Get a single external person",
  "协作": "Collaboration",
  "向指定手机号发送短信邀请用户注册外部门户": "Send an SMS to the specified phone number to invite users to register for the external portal",
  "获取多条外部人员": "Retrieve multiple external personnel",
  "选择所有": "Select All",
  "添加插件": "Add Plugin",
  "选择一个字段，记录将以该字段的值作为分组在显示左侧": "Select a field, and the records will be displayed on the left grouped by the value of that field.",
  ...
  "2.切换到“机器人”，启用机器人功能，这样在%0消息测就能直接收到明道云内部的流程、应用消息": "2. Switch to \\\"Robot\\\" and enable the robot feature, so that you can directly receive messages from Mingdao Cloud's internal processes and applications in the %0 message test.",
  ...
  "早于等于": "Earlier than or equal To",
  "完成后，从二级域名下登录，点击%0的图标，扫一扫即可": "After completion, log in from the secondary domain, click the %0 icon, and scan to proceed.",
  "请向我描述您想要实现的字段功能，我将为你生成代码。你可以在左侧实时预览代码效果，也可以向我追加提问修改代码或者提供报错信息让我协助排查问题。": "Please describe the field functionality you want to achieve, and I will generate the code for you. You can preview the code effect in real time on the left, and you can also ask me to modify the code or provide error messages for assistance in troubleshooting.",
  "正在上传 %0": "Uploading %0",
  ...
  "撤回理由": "Reason for Withdrawal",
  "激活显示的标签页。标签页被隐藏时，激活动作将不生效。": "Activate the displayed tab. The activation action will not take effect when the tab is hidden.",
  "侧滑": "Swipe",
  "将查询到的记录值写入当前当前表单字段。": "Write the retrieved record values into the current form fields.",
  "导航": "Navigation",
  "在 APP 运行期间方可进行语音播报，而 H5 则不具备此功能": "Voice broadcast can only be made while the APP is running, and H5 does not have this feature.",
  "请输入数字": "Please enter a number",
  "允许发起人撤回流程": "Allow initiator to withdraw the process",
  "允许审批人撤回上次审批结果": "Allow approvers to retract the last approval result",
  "分栏宽度": "Column Width",
  ...
  "自定义（%0）": "Customize (%0)",
  "账户注销 - 明道云 | APaaS平台、零代码、hpaPaaS、iPaaS、BaaS、快速开发工具、中台应用": "Account Logout - Mingdao Cloud | APaaS Platform, No-Code, hpaPaaS, iPaaS, BaaS, Rapid Development Tools, Middle Platform Applications",
  "%0 分": "%0 minutes",
  ...
  "您尚有未退出的组织，请先至 个人中心-我的组织 退出所有组织，方可注销！": "You have organizations you have not exited. Please go to Personal Center - My Organizations to exit all organizations before you can deregister!",
  "下一步": "Next Step",
  "最新更新：2021年11月30日": "Latest Update: November 30, 2021",
  "明道云用户使用条款": "Mingdao Cloud User Agreement",
  "一、约定": "1. Agreement",
  ...
  "1.明道云用户注册账号时应提交真实、准确、完整的信息，不得违反国家法律法规及本使用协议，未经他人许可不得使用他人名义注册账号，不得恶意注册账号。": "1. When registering an account on Mingdao Cloud, users must provide authentic, accurate, and complete information, and must not violate national laws and regulations or this User Agreement. Users must not register accounts in the name of others without permission or maliciously register accounts.",
  "2.明道云账号的所有权及相关权益属于明道云所有，明道云用户不得以任何方式转让或向提供他人使用其使用的明道云账号，否则明道云有权立即不经通知收回该账号，由此带来的因明道云用户使用明道云产品产生的全部数据、信息等被清空、丢失等损失，明道云用户应自行承担。": "2. The ownership and related rights of the Mingdao Cloud account belong to Mingdao Cloud. Mingdao Cloud users may not transfer or provide their Mingdao Cloud account to others in any way. Otherwise, Mingdao Cloud has the right to immediately reclaim the account without notice. The Mingdao Cloud user shall bear all losses arising from the clearing or loss of all data and information due to the use of Mingdao Cloud products.",
  "3.明道云用户应当对其明道云账户下的一切行为负责，包括发布的任何内容以及由此产生的任何后果。明道云不对用户使用明道云服务而上传、存储或共享的内容承担任何责任。": "3. Mingdao Cloud users shall be responsible for all activities under their Mingdao Cloud accounts, including any content published and any consequences arising therefrom. Mingdao Cloud shall not be liable for any content uploaded, stored, or shared by users using Mingdao Cloud services.",
  "4.明道云的用户可以通过": "4. Users of Mingdao Cloud can access through",
  "《明道云隐私政策》": "\"Mingdao Cloud Privacy Policy\"",
  "5.明道云用户注销明道云账户的行为，将导致明道云终止提供服务，也将终止给明道云用户提供的外部门户服务。注销成功后，明道云将删除用户的个人信息，使其保持不可被检索、访问的状态，或对其进行匿名化处理。如果明道云用户仍执意注销账户，其账户需同时满足以下条件：": "5. The action of a Mingdao Cloud user canceling their Mingdao Cloud account will result in the termination of services provided by Mingdao Cloud, as well as the termination of external portal services offered to Mingdao Cloud users. Upon successful cancellation, Mingdao Cloud will delete the user's personal information, rendering it irretrievable and inaccessible, or will anonymize it. If a Mingdao Cloud user insists on canceling their account, their account must simultaneously meet the following conditions:",
  "1)明道云账户中无资产、无欠款；": "1) No assets and no debts in the Mingdao Cloud account;",
  ...
  "6.在明道云账户注销期间，如果用户的明道云账户涉及争议纠纷，包括但不限于投诉、举报、诉讼、仲裁、国家有权机关调查等，明道云有权自行终止本账户的注销而无需另行获得明道云用户的同意。": "6. During the account cancellation period of the Mingdao Cloud account, if the user's Mingdao Cloud account is involved in disputes or disputes, including but not limited to complaints, reports, litigation, arbitration, or investigations by national authorities, Mingdao Cloud has the right to unilaterally terminate the cancellation of this account without needing to obtain consent from the Mingdao Cloud user.",
  "1)无法登录、使用明道云账户；": "1) Unable to log in or use the Mingdao Cloud account;",
  "7.请明道云用户在提交注销申请前，务必解绑其他相关的第三方账户，具体操作方式可与我们的客服联系。": "7. Please make sure to unlink any related third-party accounts before submitting the account cancellation request on Mingdao Cloud. You can contact our customer service for specific instructions.",
  ...
  "2)明道云账户的个人资料和历史信息都将无法找回；": "2) The personal data and historical information of the Mingdao Cloud account will be irretrievable;",
  "9.注销本明道云账户并不代表本明道云账户注销前用户在该账户下的行为和相关责任得到豁免或减轻。": "9. Canceling this Mingdao Cloud account does not exempt or reduce the user's actions and related responsibilities under this account prior to the account cancellation.",
  "三、合法使用": "III. Legal Use",
  "1.明道云服务限于提供给客户用作正常和合法业务工具，客户如果使用明道云产品从事以下行为，将导致根本性违约，明道云有权随时停止服务、解除本协议，并追讨因此带来的损失：": "1. Mingdao Cloud services are limited to providing customers for normal and lawful business tools. If customers use Mingdao Cloud products to engage in the following behaviors, it will result in a fundamental breach of contract. Mingdao Cloud has the right to stop services, terminate this agreement at any time, and pursue compensation for any resulting damages:",
  "1)客户使用明道云用于违反法律的业务；": "1) Customers use Mingdao Cloud for business that violates the law;",
  "2)对明道云产品进行了任何形式的对其他第三方的再授权使用，销售或转让；": "2) Reauthorized the use, sale or transfer of the Mingdao Cloud product to any third party in any form;",
  "3)为设计开发竞争产品对明道云产品进行任何形式的反向工程，或在竞争产品抄袭模仿明道云的设计；": "3) Engage in any form of reverse engineering of the Mingdao Cloud product for the design and development of competitive products, or copy and imitate Mingdao Cloud's design in competitive products;",
  "4)滥用明道云产品的通信功能发送垃圾邮件和短信；": "4) Abuse the communication features of Mingdao Cloud products to send spam emails and messages;",
  "2.明道云使用客户所拥有的手机号作为用户权证的唯一识别信息。当客户不再拥有在明道云登记的手机号时，明道云有权终止提供服务，客户亦可以通过变更手机号的方式继续使用明道云服务。在付费版下，系统支持多个域名电子邮件地址，当最早登记的主域名权属发生改变时，明道云有权终止提供服务。": "2. Mingdao Cloud uses the phone number owned by the customer as the unique identification information for user credentials. When the customer no longer owns the phone number registered with Mingdao Cloud, Mingdao Cloud has the right to terminate the service, and the customer can continue to use Mingdao Cloud services by changing the phone number. In the paid version, the system supports multiple domain email addresses, and when the ownership of the earliest registered main domain changes, Mingdao Cloud has the right to terminate the service.",
  "4.本使用协议依据国家相关法律法规规章制定，明道云用户同意严格遵守以下义务：（1）不得利用明道云产品从事洗钱、窃取商业秘密、窃取个人信息等违法犯罪活动；（2）不得干扰明道云产品的正常运转，不得明道云产品及国家计算机信息系统；（3）不得传输或发表任何违法犯罪的、骚扰性的、中伤他人的、辱骂性的、恐吓性的、伤害性的、庸俗的、不文明的等信息；（4）不得教唆他人从事违法违规或本使用协议所禁止的行为；（5）不得利用在明道云注册的账户买卖进行牟利性经营活动；（6）不得发布任何侵犯他人个人信息、著作权、商标权等知识产权或合法权利的内容；": "4. This user agreement is formulated in accordance with relevant national laws, regulations, and rules. Users of Mingdao Cloud agree to strictly abide by the following obligations: (1) Do not use Mingdao Cloud products to engage in money laundering, stealing trade secrets, stealing personal information, or other illegal activities; (2) Do not interfere with the normal operation of Mingdao Cloud products, and do not impair Mingdao Cloud products and national computer information systems; (3) Do not transmit or publish any illegal, harassing, defamatory, abusive, threatening, harmful, vulgar, uncivilized information; (4) Do not instigate others to engage in illegal or prohibited behaviors under this user agreement; (5) Do not use accounts registered in Mingdao Cloud for profit-making business activities; (6) Do not post any content that infringes on others' personal information, copyright, trademark rights, or other intellectual property or legal rights.",
  "3.明道云用户须对自己在网上的言论和行为承担法律责任，若在明道云产品上散布和传播反动、色情或其它违反国家法律的信息，本公司的系统记录有可能作为明道云用户违反法律的证据。": "3. Users of Mingdao Cloud are responsible for their own statements and actions online. If any reactionary, pornographic, or other information that violates national laws is spread and disseminated on Mingdao Cloud products, the company's system records may serve as evidence of the user's violation of the law.",
  ...
  "7.明道云用户必须防范和抵制制作、复制、发布含有下列内容的不良信息：使用夸张标题，内容与标题严重不符的；炒作绯闻、丑闻、劣迹等的；不当评述自然灾害、重大事故等灾难的；带有性暗示、性挑逗等易使人产生性联想的；展现血腥、惊悚、残忍等致人身心不适的；煽动人群歧视、地域歧视等的；宣扬低俗、庸俗、媚俗内容的；可能引发未成年人模仿不安全行为和违反社会公德行为、诱导未成年人不良嗜好等的；其他对网络生态造成不良影响的内容。": "7. Users of Mingdao Cloud must guard against and resist the production, duplication, and publication of harmful information containing the following content: using exaggerated titles that are severely inconsistent with the content; sensationalizing scandals, rumors, and bad records; inappropriate commentary on natural disasters, major accidents, and other disasters; content containing sexual innuendos or provocations that may lead to sexual associations; graphic, horror-filled, or cruel content that causes physical or mental discomfort; incitement to group discrimination, regional discrimination, etc.; promotion of vulgar, tacky, and kitsch content; content that may provoke minors to imitate unsafe behaviors or violate social ethics, or induce minors into harmful habits; and any other content that negatively impacts the online ecosystem.",
  "四、数据和程序归属权": "4. Ownership of Data and Programs",
  "五、用户隐私权": "5. User Privacy Rights",
  "1.明道云应当从组织结构和技术角度尽最大努力保护用户数据安全，只根据用户在网站上的行为指示来分发用户的信息。明道云永远不会将用户产生的具体数据提供给任何无关第三方。": "Mingdao Cloud shall make every effort to protect user data security from organizational and technical perspectives, and will distribute user information solely based on user behavior instructions on the website. Mingdao Cloud will never provide specific data generated by users to any unrelated third parties.",
  "1.用户在明道云平台创建的独创性数据归属客户所有，客户有权进行任何形式的处置，包括从平台中复制、导出和删除。": "1. The originality of the data created by users on the Mingdao Cloud platform belongs to the customer, who has the right to dispose of it in any form, including copying, exporting, and deleting from the platform.",
  "2.明道云保留使用汇总统计性信息的权利，这些信息应当是匿名，且不是针对特定用户的。": "Mingdao Cloud reserves the right to use aggregated statistical information, which should be anonymous and not targeted at specific users.",
  "3.明道云保留面向免费模式用户刊载广告的权利，这些广告刊载过程中将可能使用必要的定向技术来提高广告相关度，但明道云不会将用户的个人信息透露给广告商，而只会在匿名的基础上通过自动化匹配技术实现广告优化刊载。": "3. Mingdao Cloud reserves the right to display advertisements to users of the free model. During the ad placement process, necessary targeting technologies may be used to increase ad relevance, but Mingdao Cloud will not disclose users' personal information to advertisers and will only implement ad optimization on an anonymous basis through automated matching technologies.",
  "六、服务连续性": "6. Service Continuity",
  "4.如果明道云用户想要行使个人信息权利，或者想了解明道云如何处理其个人信息，请认真阅读《明道云隐私政策》，明道云将按照本协议以及《明道云隐私政策》的规定收集、使用、共享、储存和保护明道云用户的个人信息。本使用协议对个人信息保护相关内容未作明确规定的，均应以《明道云隐私政策》的内容为准。": "4. If Mingdao Cloud users wish to exercise their personal information rights or want to understand how Mingdao Cloud handles their personal information, please carefully read the \"Mingdao Cloud Privacy Policy.\" Mingdao Cloud will collect, use, share, store, and protect the personal information of Mingdao Cloud users in accordance with this agreement and the provisions of the \"Mingdao Cloud Privacy Policy.\" For any matters related to personal information protection that are not explicitly stated in this usage agreement, the content of the \"Mingdao Cloud Privacy Policy\" shall prevail.",
  "5.《明道云隐私政策》构成本使用协议不可分割的一部分。": "5. The \"Mingdao Cloud Privacy Policy\" constitutes an integral part of this User Agreement.",
  "1.明道云将尽最大努力保障软件平台的连续可靠运行，对付费版用户，明道云承诺99%以上的正常在线率，低于此比例，明道云有义务按照服务中断时间比例向客户退还相应的服务费用，客户理解该等赔偿。明道云对免费模式用户不提供任何补偿。": "1. Mingdao Cloud will make every effort to ensure the continuous and reliable operation of the software platform. For paid users, Mingdao Cloud promises an online availability rate of over 99%. If this rate is not met, Mingdao Cloud is obligated to refund the corresponding service fees based on the duration of service interruption. Customers understand this compensation. Mingdao Cloud does not provide any compensation for free model users.",
  "七、责任限制": "7. Limitation of Liability",
  "3.在发生需要从备份文件中恢复数据的情形时，明道云通常需要4小时，最长48小时完成，在此时间范围内的数据恢复视作服务是连续的。": "3. In cases where data needs to be restored from backup files, Mingdao Cloud typically takes 4 hours, and up to 48 hours to complete. Data recovery within this time frame is considered a continuous service.",
  "2.不论在何种情况下，明道云不对由于网络连接故障、电脑或系统故障、电力故障、罢工、暴乱、火灾、洪水、爆炸、战争、政府行为、疫情等情况造成的不能服务或延迟服务承担任何责任。": "2. Under no circumstances shall Mingdao Cloud be liable for any failure or delay in service resulting from network connection failures, computer or system malfunctions, power outages, strikes, riots, fires, floods, explosions, wars, government actions, pandemics, or other such situations.",
  "1.服务将按照“现状”和“可得到”的状态提供。明道云在此明确声明，除本协议有明确约定外，明道云对服务不作任何明示或暗示的保证，包括但不限于对服务的适用性、准确性、持续性、可靠性、服务没有错误或疏漏等。": "1. The service will be provided on an \"as is\" and \"as available\" basis. Mingdao Cloud hereby explicitly states that, except as expressly provided in this agreement, Mingdao Cloud makes no explicit or implicit guarantees regarding the service, including but not limited to the applicability, accuracy, continuity, reliability of the service, and that the service is free of errors or omissions.",
  "4.如因用户违反本协议、法律法规要求、用户未能履行付款义务或用户注销账户等造成数据丢失、删除、毁损的，明道云不承担任何责任，用户应自行负责对数据进行备份。": "4. If data loss, deletion, or damage occurs due to the user violating this agreement, legal and regulatory requirements, failing to fulfill payment obligations, or account cancellation, Mingdao Cloud shall not bear any responsibility, and the user shall be responsible for backing up their data.",
  "3.明道云不对任何间接的、惩罚性的、突发性的损害或利益损失承担责任。": "3. Mingdao Cloud shall not be liable for any indirect, punitive, incidental damages or loss of profits.",
  "在向用户提供服务的过程中，明道云可能会接入第三方的产品或服务，该产品或服务由明道云以外的第三方提供。在法律允许的范围内，明道云不对第三方的产品或服务承担任何责任。用户需遵守所有第三方的产品或服务的使用条款和隐私政策。": "In the process of providing services to users, Mingdao Cloud may integrate third-party products or services, which are provided by third parties other than Mingdao Cloud. To the extent permitted by law, Mingdao Cloud shall not be liable for any third-party products or services. Users are required to comply with all terms of use and privacy policies of third-party products or services.",
  "八、第三方产品和服务": "VIII. Third-Party Products and Services",
  "九、违约与赔偿": "9. Breach and Compensation",
  "1.如果明道云用户违反本协议，明道云有权根据独立判断，采取适当的处置措施，包括但不限于随时删除或屏蔽内容，或暂停向用户提供部分或全部服务等。": "1. If Mingdao Cloud users violate this agreement, Mingdao Cloud has the right to take appropriate disposal measures based on independent judgment, including but not limited to deleting or blocking content at any time, or suspending the provision of some or all services to users.",
  "2.如果用户违反相关法律法规，明道云有权采取适当的法律措施，并根据相关法律法规的要求保存相关信息，并向有关主管部门报告、配合有关主管部门调查。": "2. If users violate relevant laws and regulations, Mingdao Cloud has the right to take appropriate legal measures and, in accordance with relevant laws and regulations, to retain related information, report to relevant authorities, and cooperate with the investigation of relevant authorities.",
  "3.若因用户违反本协议或其他应当遵守的条款引起的任何索赔、要求或损失，用户应当承担全部责任。由此给明道云或关联方等主体造成的任何损失，用户也应承当全部赔偿责任。": "3. The user shall bear full responsibility for any claims, demands or losses arising from the user's violation of this agreement or other terms that should be adhered to. The user shall also be fully liable for any losses incurred by Mingdao Cloud or related parties as a result.",
  "十、计费和支付": "10. Billing and Payment",
  "2.客户应当按照本订单载明的支付义务及时支付价款，用户逾期支付账单超过30天后系统会停止付费版服务，而转入免费模式，用户在付费版下的设定参数数据可能因此丢失或恢复缺省设置。即使在停止付费版服务后，任何未支付的账单均会作为客户的欠款，明道云保留追讨欠款及滞纳金的权利，滞纳金将根据拖欠天数，每天按欠款金额的万分之五计收。": "2. Customers shall timely pay the price according to the payment obligations specified in this order. If users delay payment of the invoice for more than 30 days, the system will stop the paid version service and switch to the free mode. The parameter data set under the paid version may be lost or restored to default settings. Even after stopping the paid version service, any unpaid invoices will be considered as the customer's debt. Mingdao Cloud reserves the right to recover debts and late fees, which will be calculated at a rate of 0.05% of the outstanding amount for each day of delay.",
  "明道云授权期限到期后，如果未能及时购买续约包，用户付费版自动终止。用户如需要继续使用明道云付费版，需要在授权到期前至少三个工作日内签订续约订单。": "After the expiration of the Mingdao Cloud authorization period, if the renewal package is not purchased in time, the paid version of the user will be automatically terminated. If the user needs to continue using the paid version of Mingdao Cloud, they must sign the renewal order at least three working days before the authorization expires.",
  "十一、付费版服务终止": "11. Termination of Paid Services",
  "1.明道云有权随时对本协议的协议进行修订，并在修订生效日前一个工作日更新在明道云网站。": "Mingdao Cloud reserves the right to amend this agreement at any time and will update the Mingdao Cloud website one working day prior to the effective date of the amendments.",
  "十二、协议修订": "12. Agreement Amendments",
  "2.明道云有权对付费版的定价进行修订，并在修订生效日前一个月通告给所有付费版用户。": "2. Mingdao Cloud reserves the right to revise the pricing of the paid version and will notify all paid users one month prior to the effective date of the revision.",
  ...
  "如果您对本协议或明道云产品有任何意见或建议，可通过feedback@mingdao.com与我们取得联系，我们会给予您必要的帮助。": "If you have any comments or suggestions regarding this agreement or Mingdao Cloud products, you can contact us at feedback@mingdao.com, and we will provide you with the necessary assistance.",
  ...
  "验证码发送成功，%0收不到验证码？%1": "Verification code sent successfully, %0 not receiving the code? %1",
  "账号不正确": "Account is incorrect",
  "· 需包含字母和数字，区分大小写": "· Must include letters and numbers, case sensitive",
  "当前企业账户余额不足，无法发送短信/邮件": "The current enterprise account balance is insufficient to send SMS/email",
  ...
  "收不到验证码？": "Did not receive the verification code?",
  ...
  "LDAP登录": "LDAP Login",
  "飞书登录": "Feishu Login",
  "找回密码 - 明道云 | APaaS平台、零代码、hpaPaaS、iPaaS、BaaS、快速开发工具、中台应用": "Reset Password - Mingdao Cloud | APaaS Platform, No-Code, hpaPaaS, iPaaS, BaaS, Rapid Development Tools, Middle Platform Applications",
  ...
  "应用维护中": "Application under maintenance",
  ...
  "会通过短信/邮件告知您审核结果": "You will be notified of the review results via SMS/email",
  ...
  "未勾选同意接收短信": "Not checked to agree to receive SMS",
  ...
  "分发所有应用项, 80：可查看、编辑、删除所有记录; 60：可查看所有记录，但只能编辑、删除自己拥有的记录; 30：可查看加入的，只能编辑、删除自己拥有的记录; 20：对所有记录只有查看权限; 0：分发有权限应用项": "Distribute all application items, 80: can view, edit, and delete all records; 60: can view all records but can only edit and delete records they own; 30: can view joined ones, but can only edit and delete records they own; 20: has view-only access to all records; 0: distribute application items with permissions",
  ...
  "权限方式：分发所有应用项，80：可查看、编辑、删除所有记录，60：可查看所有记录，但只能编辑、删除自己拥有的记录，30：可查看加入的，只能编辑、删除自己拥有的记录，20：对所有记录只有查看权限，0：分发有权限应用项": "Permission Type: Distribute all application items, 80: Can view, edit, and delete all records, 60: Can view all records, but can only edit and delete records owned by oneself, 30: Can view joined records, but can only edit and delete records owned by oneself, 20: Only has view permissions for all records, 0: Distribute application items with permissions",
  ...
  "选项排序值: 必须为整数，越小越靠前": "Option sort value: Must be an integer; the smaller it is, the closer to the front.",
  "选项集1": "Option Set 1",
  ...
  "当type=26时，权限 0：仅录入 1：成员  2：拥有者": "When type=26, permissions 0: Input only 1: Member 2: Owner",
  ...
  "记录提交失败：子表字段存在重复数据": "Record submission failed: Duplicate data exists in the subtable fields",
  "无数据": "No data",
  "发布评论": "Post Comment",
  "发表内容过长，最多允许3000个字符": "The content is too long. A maximum of 3000 characters is allowed.",
  "请选择": "Please select",
  "暂无搜索结果": "No search results found",
  ...
  "- 不需要输入，不进行安全验证": "- No input required, no security verification performed",
  ...
  "聊天成员": "Chat Members",
  "已经申请加入该群组，请等待群组管理员的审批": "You have already applied to join this group. Please wait for the group administrator's approval.",
  ...
  "退出群组后，您将不能进入这个群组": "After exiting the group, you will not be able to enter this group",
  ...
  "关联部门：": "Related Department:",
  "重新邀请成功": "Re-invitation successful",
  "编辑文件夹": "Edit Folder",
  "操作提示": "Operation Tips",
  "创建文件夹": "Create Folder",
  "操作失败, 请稍后重试": "Operation failed, please try again later",
  ...
  "2.除非另有书面声明，明道云的网站、应用程序、源代码、LOGO、界面设计、应用程序编程接口（API）、以及明道云产品中的内容、图表、版式设计、网页、文字、图片、图像、色彩、地图、图标、音频、视频、电子文档、数据资料等，以及用于开发、维护、运营上述内容和信息的基础设施和平台，包括但不限于软件、网站、应用程序及其源代码、系统数据等所关联的所有知识产权（包括但不限于专利权、著作权、商标权、商业秘密及对数据享有的财产性权利）均归属上海万企明道软件有限公司。": "2. Unless otherwise stated in writing, the website, applications, source code, LOGO, interface design, application programming interfaces (APIs), and the content, charts, layout design, web pages, text, images, graphics, colors, maps, icons, audio, video, electronic documents, data materials, etc., contained in Mingdao Cloud products, as well as the infrastructure and platforms used to develop, maintain, and operate the above content and information, including but not limited to software, websites, applications and their source code, system data, etc., all associated intellectual property rights (including but not limited to patent rights, copyrights, trademark rights, trade secrets, and property rights related to data) belong to Shanghai Wanqi Mingdao Software Co., Ltd.",
  "下文中的“明道云”指应用平台“明道云”（包括但不限于明道云网页、明道云App以及明道云微信小程序）或其运营企业上海万企明道软件有限公司，也是本协议的契约方之一。": "The term \\\"Mingdao Cloud\\\" in the following text refers to the application platform \\\"Mingdao Cloud\\\" (including but not limited to the Mingdao Cloud webpage, Mingdao Cloud App, and the Mingdao Cloud WeChat Mini Program) or its operating entity, Shanghai Wanqi Mingdao Software Co., Ltd, which is also one of the contracting parties of this agreement.",
  "1.本协议是明道云用户（包括使用的个人和代表的企业）与明道云运营企业上海万企明道软件有限公司之间的协议，用户注册明道云服务即代表接受本协议的约束，并自注册成功之时即成为本协议一方，付费版用户签署本协议并回传（包括使用传真，电子邮件等电子通信手段）给明道云即代表接受本协议中的计费和支付协议，并自发出协议之时即受该等协议约束。": "1. This agreement is between users of Mingdao Cloud (including individuals and enterprises they represent) and the operating company of Mingdao Cloud, Shanghai Wanqi Mingdao Software Co., Ltd. By registering for the Mingdao Cloud service, users agree to be bound by this agreement, and upon successful registration, shall become a party to this agreement. Paid users who sign this agreement and return it (including via fax, email, and other electronic communication means) to Mingdao Cloud are deemed to accept the billing and payment terms contained within this agreement, and shall be bound by such terms from the moment the agreement is sent.",
  ...
  "无限": "Unlimited",
  "增值服务充值金额将在收到付款后充入指定网络的企业账户中，用于客户支付短信，通讯，扩展应用等增值服务。": "The amount for value-added service recharge will be credited to the designated enterprise account on the network upon receipt of payment, to be used for customer payment of SMS, communication, expanded applications, and other value-added services.",
  ...
  "订单签署": "Order Signing",
  "条款": "Terms",
  "明道云服务限于提供给客户用作正常和合法业务工具，客户如果使用明道云产品从事以下行为，将导致根本性违约，明道云有权随时停止服务、解除本合约，并追讨因此带来的损失:": "Mingdao Cloud services are limited to providing customers with tools for normal and legal business purposes. If customers use Mingdao Cloud products for the following behaviors, it will constitute a fundamental breach of contract, and Mingdao Cloud has the right to suspend services, terminate this contract at any time, and seek compensation for any resulting losses:",
  "本合约受中华人民共和国法律管辖。": "This contract is governed by the laws of the People's Republic of China.",
  "约定": "Agreement",
  "合法使用": "Legitimate Use",
  "对明道云产品进行了任何形式的对其他第三方的再授权使用，销售或转让。": "Any form of re-licensing, sale, or transfer of the Mingdao Cloud product to any third party has been conducted.",
  "为设计开发竞争产品对明道云产品进行任何形式的反向工程，或在竞争产品抄袭模仿明道云的设计。": "Any form of reverse engineering of the Mingdao Cloud products for the design and development of competing products, or copying and imitating the design of Mingdao Cloud in competing products.",
  "明道云的应用程序、源代码、LOGO、界面设计、应用程序编程接口（API）所关联的所有知识产权均归属明道云运营企业。": "All intellectual property associated with Mingdao Cloud's applications, source code, LOGO, interface design, and application programming interfaces (APIs) belongs to the operating company of Mingdao Cloud.",
  "数据和程序归属权": "Data and Program Ownership",
  "滥用明道云产品的通信功能发送垃圾邮件和短信。": "Abusing the communication functions of Mingdao Cloud products to send spam emails and messages.",
  "有明确证据表明客户使用明道云用于违反法律的业务。": "There is clear evidence that customers are using Mingdao Cloud for illegal business activities.",
  "明道云应当从组织结构和技术角度尽最大努力保护用户数据安全，只根据用户在网站上的行为指示来分发用户的信息。明道云永远不会将用户产生的具体数据提供任何无关第三方。": "Mingdao Cloud shall make every effort from an organizational and technical perspective to protect user data security, distributing user information only based on user behavior indications on the website. Mingdao Cloud will never provide any specific data generated by users to any unrelated third parties.",
  "用户在明道云平台创建的独创性数据归属客户所有，客户有权进行任何形式的处置，包括从平台中复制，导出和删除（额外导出服务按量另行收费）。": "The originality of the data created by users on the Mingdao Cloud platform belongs to the customer, who has the right to dispose of it in any form, including copying, exporting, and deleting from the platform (additional export services are charged separately based on usage).",
  ...
  "明道云高级模式用户包中所限定的用户数是指客户网络中所有生效的用户总数，邀请的外部用户不计算。": "The number of users specified in the Mingdao Cloud Advanced Mode User Package refers to the total number of all active users in the client network, while invited external users are not counted.",
  "客户应当按照本订单载明的支付义务及时支付价款，用户逾期支付账单超过30天后系统会停止高级模式服务，而转入免费模式，用户在高级模式下的设定参数数据可能因此丢失或恢复缺省设置。即使在停止高级模式服务后，任何未支付的账单均会作为客户的欠款，明道云保留追讨欠款及滞纳金的权利，滞纳金将根据拖欠天数，每天按欠款金额的万分之五计收。": "Customers shall make timely payment of the price according to the payment obligations specified in this order. If the user delays payment of the bill for more than 30 days, the system will stop the premium mode service and switch to the free mode. The parameter data set by the user in premium mode may be lost or reset to default settings as a result. Even after the premium mode service has been stopped, any unpaid bills will still be considered as the customer's debt. Mingdao Cloud reserves the right to pursue the debt and late fees, which will be charged at a rate of 0.05% of the outstanding amount per day based on the number of overdue days.",
  "明道云保留使用汇总统计性信息的权利，这些信息应当是匿名，且不是针对特定用户的。": "Mingdao Cloud reserves the right to use aggregated statistical information, which should be anonymous and not targeted at specific users.",
  "应用定制服务交付": "Application Customization Service Delivery",
  "明道云授权期限到期后，如果未能及时购买续约包，用户高级模式自动终止。用户如需要继续使用明道云高级模式，需要在授权到期前至少三个工作日内签订续约订单。": "After the authorization period of Mingdao Cloud expires, if the renewal package is not purchased in a timely manner, the user's advanced mode will be automatically terminated. If users wish to continue using the advanced mode of Mingdao Cloud, they must sign the renewal order at least three working days before the authorization expires.",
  "计费和支付": "Billing and Payment",
  "因重大自然灾害，战争等不可抗力导致的明道云服务中断和长时间终止，明道云不承担赔偿责任。": "Mingdao Cloud will not be liable for compensation for service interruptions and prolonged cessation caused by significant natural disasters, wars, and other force majeure events.",
  "对高级模式用户，明道云承诺提供服务期内99%的正常服务率，因产品更新而预先通知的小于一小时的停机维护应当视作正常服务范围。在发生需要从备份文件中恢复数据的情形时，明道云通常需要4小时，最长48小时完成，在此时间范围内的数据恢复视作服务是连续的。": "For users in advanced mode, Mingdao Cloud promises a 99% uptime rate during the service period. Downtime maintenance due to product updates that is notified in advance and lasts less than one hour shall be considered within the normal service scope. In cases where data needs to be restored from backup files, Mingdao Cloud typically requires 4 hours, with a maximum of 48 hours to complete; data recovery within this time frame is considered as continuous service.",
  ...
  "免费咨询热线": "Free Consultation Hotline",
  ...
  "条件组": "Condition Group",
  "添加条件组，结合 且/或 条件进行筛选": "Add condition group and filter using AND/OR conditions",
  ...
  "工作流在执行时自动弹出或打开某个页面、数据、视图或链接。": "The workflow automatically pops up or opens a page, data, view, or link when executed.",
  ...
  "使用分析": "Usage Analysis",
  "支持doc、docx、wps、xls、xlsx、et、ppt、pptx、dps、pdf等主流文档格式，最大文档尺寸100MB以内进行编辑，具体可参考帮助文档说明": "Supports mainstream document formats including doc, docx, wps, xls, xlsx, et, ppt, pptx, dps, and pdf, with a maximum document size of 100MB for editing. For specifics, please refer to the help documentation.",
  ...
  "数据同步任务数": "Number of Data Synchronization Tasks",
  "ETL:可以在数据同步的过程中对数据进行处理": "ETL: Data processing can occur during the data synchronization process",
  "5个": "5",
  "仅同步": "Sync Only",
  ...
  "1万行/月": "10,000 lines/month",
  "10万行/月": "100,000 lines/month",
  "50万行/月": "500,000 rows/month",
  "钉钉整合": "DingTalk Integration",
  "100万行/月": "1 million lines/month",
  "在飞书中使用明道云": "Use Mingdao Cloud in Feishu",
  ...
  "50元/1万次（剩余月份）": "50 CNY / 10,000 times (remaining months)",
  "每月工作流执行次数免费额度不足时可购买使用，即时生效。": "When the monthly free quota for workflow executions is insufficient, you can purchase usage, effective immediately.",
  "300元/人/年": "300 CNY/person/year",
  "10元/1千次（本月）": "10 CNY / 1,000 times (this month)",
  "当月工作流执行次数额度不足时可购买使用，即时生效。": "You can purchase usage when the monthly workflow execution limit is insufficient, and it will take effect immediately.",
  "聚合表扩充包": "Aggregation Table Extension Pack",
  "数据同步算力升级包": "Data Synchronization Computing Power Upgrade Package",
  "50元/10万行（剩余月份）": "50 CNY/ 100,000 lines (remaining months)",
  ...
  "10元/1万行（本月）": "10 CNY/10,000 lines (this month)",
  ...
  "组织信息保存成功": "Organization information saved successfully",
  ...
  "适合对明道云产品已经完成试用的中小企业客户": "Suitable for small and medium-sized enterprise customers who have completed the trial of the Mingdao Cloud product",
  "适合具备自主搭建应用能力的客户": "Suitable for clients with the ability to build applications independently",
  "联系明道云顾问购买": "Contact Mingdao Cloud Consultant for Purchase",
  ...
  "可在此配置分享后的文件是否允许用户下载（分享到“消息”的将自动设为可下载）": "You can configure whether the shared files are downloadable by users (those shared to 'messages' will be automatically set as downloadable)",
  "复制链接": "Copy Link",
  "分享链接": "Share Link",
  "允许下载%02071": "Allow Download",
  "链接已关闭，开启后可进行共享": "The link is closed; it can be shared once opened.",
  "发动态%02073": "Post Update",
  "发消息%02072": "Send Message",
  "发任务%02074": "Assign Task",
  "分享到": "Share to",
  "存入知识%02076": "Store Knowledge",
  "添加说明": "Add Description",
  ...
  "设置组织管理员": "Set Organization Administrator",
  "创建部门": "Create Department",
  "拥有后台操作的权限": "Have permission for后台操作",
  "可以上传组织 logo": "You can upload the organization logo",
  ...
  "（月）": "(Month)",
  "行": "Row",
  "数据同步任务已用算力": "Data synchronization task has consumed computing power",
  ...
  "%0到期": "%0 due",
  "剩余": "Remaining",
  "试用还剩 %0 天": "%0 days remaining in trial",
  "%0 ~ %1": "%0 ~ %1",
  "上限 %0 个": "Limit of %0 items",
  "当前账户余额 (￥)": "Current Account Balance (¥)",
  "充值": "Recharge",
  "上限 %0": "Limit %0",
  "上限 %0 万行": "Limit %0 ten thousand rows",
  "使用": "Use",
  ...
  "收藏成功": "Favorites added successfully",
  ...
  "取消收藏失败！": "Failed to remove from favorites!",
  ...
  "应用库%01012": "Application Library",
  "市场": "Market",
  "收藏": "Favorite",
  "APP": "APP",
  "Web移动端": "Web Mobile Version",
  "应用库%01000": "Application Library",
  "协作%01001": "Collaboration",
  "集成%01002": "Integration",
  "推广奖励%01016": "Promotion Rewards",
  "第三方应用%01017": "Third-party applications",
  ...
  "已保存": "Saved",
  "支持 jpg、jpeg、png、gif格式，2MB以内": "Supports jpg, jpeg, png, gif formats, under 2MB",
  "链接格式不正确": "Link format is incorrect",
  "设计建议": "Design Suggestions",
  "宣传栏": "Promotional Column",
  "例如：": "For example:",
  "正在上传": "Uploading",
  "折叠": "Fold",
  "显示全部": "Show All",
  "拖拽": "Drag and Drop",
  "标语": "Slogan",
  "可以在宣传栏中添加图片链接，展示组织重要信息": "You can add image links in the announcement bar to display important information about the organization",
  ...
  "在新页面中打开": "Open in a new page",
  "该别名与系统字段的别名相同，请重新输入": "The alias is the same as the system field alias, please input again",
  "批量生成": "Batch Generate",
  "确定批量生成字段别名？": "Are you sure to batch generate field aliases?",
  "字段别名仅允许使用字母（不区分大小写）、数字和下划线组合，且必须以字母开头，不可重复。": "Field aliases can only use combinations of letters (case-insensitive), numbers, and underscores, and must start with a letter and not be duplicated.",
  "按应用": "By Application",
  ...
  "应用于指定视图": "Applied to specified view",
  "所有记录": "All Records",
  "使用范围": "Scope of Use",
  "请输入按钮名称": "Please enter the button name",
  "人物": "Character",
  "有%0位外部用户邀请失败，外部用户短信邀请用量达到上限": "Failed to invite %0 external users, the SMS invitation usage for external users has reached its limit",
  ...
  "审批前加签": "Add signature before approval",
  "否决申请": "Rejected",
  "通过申请": "Approved",
  "无需审批": "No Approval Required",
  "通过申请并加签": "Apply and add signature",
  "修改": "Edit",
  "审批人": "Approver",
  "通知人": "Notifier",
  "发起人": "Initiator",
  ...
  "关闭分享": "Close Sharing",
  "%0 的联系人可预览": "Contacts of %0 can preview",
  "无权修改，请联系管理员": "Insufficient permissions to modify, please contact the administrator",
  "已经复制到粘贴板，你可以使用Ctrl+V 贴到需要的地方": "Copied to clipboard. You can use Ctrl+V to paste it where needed.",
  ...
  "产品密钥": "Product Key",
  "偏好设置": "Preferences",
  "从联系人中选择用户，邀请加入到当前组织": "Select a user from the contacts to invite to the current organization",
  ...
  "请输入手机号/邮箱地址": "Please enter your phone number/email address",
  "手机": "Mobile",
  "(二维码)": "(QR code)",
  ...
  "添加": "Add",
  "批量导入": "Batch Import",
  "邀请后，成员会收到邀请链接，验证后可加入%0": "After the invitation, members will receive an invitation link and can join %0 after verification",
  "永久": "Permanent",
  "24小时": "24 hours",
  ...
  "成员可通过搜索组织门牌号申请加入": "Members can apply to join by searching for the organization door number.",
  ...
  "添加审批人": "Add Approver",
  "清除": "Clear",
  "撤回后重新发起": "Re-initiate after withdrawal",
  "最近修改人：": "Last modified by:",
  "创建人：": "Creator:",
  "创建时间：": "Creation Time:",
  ...
  "批量打印": "Batch Print",
  "工号": "Employee ID",
  "保存成功，请到打印模板中查看": "Saved successfully, please check in the print template",
  "系统打印": "System Print",
  "导出成功！": "Export successful!",
  "正在使用WPS服务预览": "Previewing using WPS services",
  "预览失败？使用WPS预览": "Preview failed? Use WPS for preview",
  "您是否保存本次修改？": "Do you want to save this modification?",
  "使用默认方式预览": "Preview with default mode",
  "当前有尚未保存的修改，你在离开页面前是否需要保存这些修改？": "There are unsaved changes. Do you want to save these changes before leaving the page?",
  ...
  "链接将于": "The link will be",
  "份结束收集": "End of collection",
  "已收集": "Collected",
  ...
  "再填写一份": "Fill out another one",
  "公开填写": "Public Fill",
  "公开表单": "Public Form",
  "举报": "Report",
  "填写说明": "Instructions for filling out",
  ...
  "表单字段": "Form Field",
  "系统字段": "System Field",
  "子表、关联记录、查询记录（列表）、审批明细": "Sub-table, Related Records, Query Records (List), Approval Details",
  "子表、关联记录（列表）、查询记录（列表）、审批明细中的字段支持四种打印方式。打印审批明细时，如果同一条审批流程被重复发起了多次，则只会打印发起时间最近的一次。": "The subtable, associated records (list), queried records (list), and fields in the approval details support four printing methods. When printing approval details, if the same approval process has been initiated multiple times, only the most recent initiation time will be printed.",
  ...
  "（3）填充打印：在指定位置填充列表中固定某一行记录的字段，可在字段代码或字段ID的子表或关联表名后加索引值，如固定显示第一行记录的#{客户.客户名称}加索引号写法为#{客户[1].客户名称}；": "(3) Fill Printing: Fill in the fields of a fixed record of a certain row in the list at the specified location. You can add an index value after the field code or field ID's sub-table or associated table name, such as fixing the display of the first record’s #{Customer.Customer Name} written with an index number as #{Customer[1].Customer Name};",
  "[审批]": "[Approval]",
  "帮助文档": "Help Documentation",
  "制作模板 - %0": "Create Template - %0",
  "制作说明": "Production Instructions",
  ...
  "（1）图片尺寸支持4种设置方式。[90*auto] 表示宽度固定为90，高度自适应。[auto*90] 表示宽度自适应，高度固定为90。[90*50_auto]表示宽高在90*50的范围内同时自适应。[90*50]表示宽高为固定尺寸。": "(1) Image size supports 4 types of settings. [90*auto] indicates a fixed width of 90 with automatic height. [auto*90] indicates automatic width with a fixed height of 90. [90*50_auto] indicates that both width and height adapt within the range of 90*50. [90*50] indicates fixed width and height dimensions.",
  ...
  "这里": "Here",
  "7. 如需打印字段所选成员的工号、邮箱、手机号，请将代码：工号: {_ID}； 邮箱: {_Email}； 手机号: {_Phone}。插入到模版中，如#{[member]字段ID$[(_ID;_Email;_Phone)]$} 实现拼接样式：张三(888;1511515@qq.com;13475236985)": "7. To print the selected member's employee ID, email, and phone number, please insert the code: Employee ID: {_ID}; Email: {_Email}; Phone: {_Phone}. into the template, e.g. #{[member]field ID$[(_ID;_Email;_Phone)]$} to achieve the concatenated style: Zhang San(888;1511515@qq.com;13475236985)",
  ...
  "对所有记录只有查看权限": "View only permissions for all records",
  "自定义权限": "Custom Permissions",
  "可查看加入的，只能编辑、删除自己拥有的记录": "Can view the joined ones, can only edit and delete the records owned by oneself",
  "可查看、编辑、删除所有记录": "View, edit, and delete all records",
  "验证码": "Verification Code",
  "包含记录分享、视图分享": "Includes record sharing and view sharing",
  "可查看所有记录，但只能编辑、删除自己拥有的记录": "You can view all records, but can only edit or delete the records you own.",
  "导入": "Import",
  "包含工作表日志、记录日志": "Includes worksheet logs, record logs",
  "附件下载": "Attachment Download",
  "拥有所有权限": "Have all permissions",
  ...
  "批量操作": "Batch Operation",
  "新增记录": "Add Record",
  "运营者能管理普通角色下的成员，主要包含：": "Operators can manage members under ordinary roles, mainly including:",
  "运营者": "Operator",
  ...
  "管理普通角色下的角色负责人": "Manage role leaders under ordinary roles",
  "管理所有数据和普通角色下的成员，不可配置应用": "Manage all data and members under the ordinary role, non-configurable application",
  "开发者只能配置应用": "Developers can only configure applications",
  "开发者能配置应用，主要包含：": "Developers can configure applications, mainly including:",
  "可查看加入的，只能编辑、删除自己拥有的记录 注：开发者不可复制、删除、导出应用": "You can view the ones you've joined, but can only edit or delete records you own. Note: Developers cannot copy, delete, or export applications.",
  "创建当前新增的角色？": "Create the currently added role?",
  "保存当前角色权限配置 ？": "Save current role permission configuration?",
  "开发者": "Developer",
  "工作表跨应用关联，被关联的工作表所属应用必须是应用“开发者”或“管理员”": "Cross-application association of worksheets requires that the associated worksheet's belonging application must be 'Developer' or 'Administrator'",
  ...
  "开启后，应用的管理员、运营者、开发者可以使用不同的角色身份访问应用。请注意，该操作不会改变开发者角色的数据权限，开发者始终无法看到业务数据。": "Once enabled, the application administrators, operators, and developers can access the application with different roles. Please note that this action will not change the data permissions of the developer role; developers will always be unable to see business data.",
  "关闭失败！": "Close failed!",
  "角色调试": "Role debug",
  ...
  "我是用户，并对明道云 %0伙伴政策%1 感兴趣": "I am a user and I am interested in the Mingdao Cloud %0 Partner Policy %1",
  "我是用户": "I am a user",
  ...
  "认证添加成功": "Certification added successfully",
  ...
  "配置发送 API 请求时需要的 Query Param、Header、Body 等请求参数": "Configure the request parameters such as Query Param, Header, Body needed for sending API requests",
  "输入参数用于在工作表或工作流中使用 API 查询时，可以传入动态值": "Input parameters are used to pass dynamic values when using the API query in a worksheet or workflow.",
  ...
  "仅一次": "Only once",
  "链接设置": "Link Settings",
  "指定次数": "Specified times",
  "平台用户": "Platform User",
  "每天一次": "Once a day",
  "不限": "Unlimited",
  "指定范围": "Specify Range",
  "指定月份": "Designated Month",
  "平台官方微信服务号": "Official WeChat service account of the platform",
  "无需授权,静默获取": "No authorization required, silent access",
  "指定日期": "Specified Date",
  "后结束收集": "Finalize Collection",
  "跳转到指定链接": "Jump to specified link",
  "组织的微信认证服务号": "WeChat Official Account for Organizations",
  "仅查看": "View Only",
  "需授权,用户允许后获取": "Authorization required, retrieve after user approval",
  ...
  "保持图片完整显示，适合包含文字内容的横幅图片": "Keep the image fully displayed, suitable for banner images containing text content",
  ...
  "关联记录控件id/别名": "Related record control ID/Alias",
  "更新时间": "Last Updated",
  "行数": "Row Count",
  ...
  "获取关联记录 POST": "Get Related Record POST",
  "单位s,为空表示永久有效": "Unit s, empty indicates permanently valid",
  ...
  "试用、免费版需组织完成身份认证后可充值余额；自定义短信签名需组织完成企业身份认证（注意：非个人身份）": "Trial, free version of the organization needs to complete the authentication before recharging the balance.",
  "身份认证": "Identity Verification",
  "组织唯一身份编号，用于沟通反馈问题时使用": "Unique number for every org, used for communication and feedback",
  "成员可输入组织门牌号加入组织": "Members can enter the organization door number to join",
  "没有组织门牌号？": "No Org Door Number?",
  ...
  "附件上传流量自动增补": "Auto -supplement Attachment upload",
  "当年附件上传流量剩余2%时自动购买当年额度包，费用20元/1GB": "Auto-purchase the annual quota package when the remaining attachment upload is 2%, cost CNY 20 /1GB",
  "附件上传流量": "Attachment Upload",
  "同步任务总数": "Data Sync Tasks",
  "聚合表数": "Aggregate Table",
  "工作表总数": "Worksheets",
  ...
  "基于大模型 AI 技术用提示词生成一段文本": "Generate text with large model AI using prompt words",
  ...
  "基础信息": "Basics",
  "在组织管理【汇报关系】中管理用户的下属": "Manage users' subordinates in organizational management 【Org Chart】",
  "汇报关系": "Org Chart",
  "版本": "Edition",
  ...
  "剩余%0天": "Remaining % days",
  "试用期剩余%0天": "%0 days remaining in trial",
  "免费试用剩余%0天": "%0 days remaining in trial",
  "剩余 %0 天": "Remaining % days\n",
  ...
  "封装业务流程": "PBP",
  "对业务数据发起审批流程，实现自动化和人工审批的打通": "Initiate approval flows for business data to achieve integration of automated and manual approvals",
  ...
  "使用「发起审批流程」节点可提供更完整的审批能力，旧「审批」节点即将被下线。流程中已添加的审批节点不受影响，仍可以继续使用。": "The 'Initiate Approval Flow' node provides more complete approval capabilities, and the old 'Approval' node will soon be discontinued. Approval nodes already added to the process will not be affected and can continue to be used.",
  "未勾选时：在审批流程中，不验证审批、填写、抄送人在工作表中的记录权限，只按照流程节点设置的权限进行查看和操作": "When unchecked: in the approval flow, do not verify the approval, fill in, copy the person in the worksheet record permissions, only in accordance with the permissions set in the process node for viewing and operation",
  "审批过程中更新": "Update During Approval Flow",
  ...
  "审批流程": "Approval Flow",
  "向子流程的流程参数传递初始值，供子流程执行时使用": "Pass initial values to the process parameters of the subflow for use during its execution",
  "子流程执行完毕后，再开始下一个节点": "After the subflow is completed, start the next node",
  "执行子流程": "Execute Subflow",
  "流程中有其他PBP、子流程、循环流程、代办、延时节点时，输出参数映射无效": "When there are other PBPs, subflows, looping processes, to-dos, or delay nodes in the workflow, the output parameter mapping is invalid.",
  "转为子流程": "Convert to Subflow",
  "子流程%03038": "Subflow",
  "-子流程": "-Subflow",
  "数据按顺序逐条执行，但不会等待流程中包含的子流程和PBP执行完毕，速度较慢": "Data is executed sequentially, but it will not wait for the Subflows and PBP included in the workflow to complete, resulting in slower speed.",
  "触发了以下子流程": "Triggered the following Subflows",
  "子流程触发": "Subflow Trigger",
  "子流程%03006": "Subflow",
  "在某个流程流转过程中可以创建一个子流程并执行": "A subflow can be created and executed during the flow of a process.",
  "子流程": "Subflow",
  "调用流程": "Calling Workflow",
  "组织人员事件触发": "Org Personnel Trigger",
  "组织人员事件触发%03014": "Org Personnel Trigger",
  "人员事件触发": "Personnel Trigger",
  "人员事件%03005": "Personnel",
  "人员事件": "Personnel",
  "工作表事件触发%03011": "Worksheet Trigger",
  "工作表事件触发": "Worksheet Trigger",
  ...
  "在填写前显示填写说明": "Set an expiration date for the link",
  "限制填写次数": "Limit filling times",
  "限制收集数量上限": "Limit the number of collections",
  "设置填写时段": "Set fill time period",
  ...
  "若选择本地上传，请选择%0格式的%1文件；": "Please select a %1 file in %0 format if chooing locak upload;",
  "允许下载打印文件": "Allow file download and print",
  ...
  "选择一个一对多关系的本表关联字段，数据将按此字段的父级（单条）、子级（多条）关系构成树形表格": "Select a one-to-many Associated Fields from this table, and the data will be structured into a tree table based on the parent (single) and child (multiple) relationships of this field.",
  "选择子表中的关联本表字段": "Select Associated Fields from the subtable",
  ...
  "提交后继续创建下一条": "Save & Add Next After Submission",
  ...
  "当只有一个标签页时隐藏": "Hide when only one tab",
  ...
  "请谨慎选择“他表字段”作为条件字段，可能因为数据同步更新延迟而导致结果非预期": "Please carefully choose 'Foreign Fields' as condition fields, as data sync delays may lead to unexpected results.",
  "指定的节点对象中，没有关联他表字段": "No associated fields from foreign tables in the specified node object.",
  "校准刷新符合筛选条件的工作表记录的计算结果、选项排序和分值、他表字段和汇总结果，此节点为异步排队执行，一次最多刷新10万行记录。每次校准必须间隔120分钟以上，否则将跳过节点": "Calibration refreshes the calculation results, option sorting and scores, foreign fields, and summary results for worksheet records that meet the filter criteria; this node is an asynchronous queued execution that refreshes up to 100,000 rows of records at a time. Each calibration must be separated by 120 minutes or more, or the node will be skipped.",
  "即时校准刷新工作表单条记录中的公式计算、他表字段和汇总等延迟同步结果，后续节点可使用校准后的值": "Instant calibration refreshes the delayed sync results of formula calculations, foreign fields and summaries in the worksheet entry record, and subsequent nodes can use the calibrated values",
  ...
  "他表字段": "Foreign Field",
  "在关联记录": "In Relationship",
  "筛选关联记录": "Filter Relationship",
  "关联记录": "Relationship",
  "关联": "Relational",
  ...
  "选择一个单选项或关联记录单条字段，记录将以选中项作为分组在显示左侧": "Select a Single select or a related record field; records will be displayed on the left grouped by the selected item.",
  ...
  "色值%0": "Color %0",
  "黄昏": "Twilight",
  "无相关聚合表": "No related Aggregate Table",
  "聚合表": "Aggregate Table",
  "工作表": "Worksheet",
  ...
  "编辑应用说明%02050": "Edit App Description",
  "应用描述": "App Description",
  "凌晨好": "Good morning",
  "最常协作": "Latest Contacts",
  ...
  "提醒%19000": "Alert",
  "起止时间": "From",
  "日程标题最大长度266个字符": "The max length of the event title is 266 characters",
  "日程标题或组织者为空": "The event title or organizer is empty",
  "请输入日程标题…": "Please enter the event title...",
  "请输入日程标题": "Please enter the event title",
  ...
  "设置后，从SSO登录的账号在点击应用上的首页按钮时返回到此地址。未设置时，返回到本平台的工作台。": "After setting, the account logged in from SSO will return to this address when clicking the home button on the application. If not set, it will return to the Launchpad of this platform.",
  ...
  "发送站内通知%03028": "Send Station Notice",
  "站内通知": "Station Notice",
  "最近1个月": "Last 1 month",
  "本月读取记录行数": "Number of records read this month",
  "万行": "Ten Thousand Rows",
  "任务名称/创建人": "Task Name/Creator",
  ...
  "启用后，用户输入登录密码后才可进行通过/否决": "Once enabled, users can proceed with approval/denial only after entering their login password",
  "通过微信扫码登录时，需先关注公众号": "You need to follow the official account before logging in with WeChat QR code",
  ...
  "企业微信扫码登录（可选）": "WeCom QR code login (optional)",
  ...
  "仅限应用内成员登录系统后根据权限访问": "Access is restricted to in-app members after logging in based on permissions.",
  ...
  "已发送短信到%0，请输入验证码完成登录。": "A message has been sent to %0. Please enter the verification code to complete the login.",
  ...
  "此处配置的注册登录方式需遵循基础设置的配置范围，如超出范围则链接无效": "The registration and login methods configured here must comply with the configuration range of the basic settings, otherwise the link will be invalid.",
  ...
  "1.明道云付费版用户包中所限定的用户数是指客户网络中所有生效的用户总数，包括正常用户，屏蔽、移除、标疑但当月有过登录记录的用户，员工离职后正常关闭且实际无登录的用户不计算。": "The number of users limited in the Mingdao Cloud paid version package refers to the total number of active users in the client's network, including regular users, blocked, removed, marked users who have logged in during the current month, while employees who have left and are normally disabled without actual logins are not counted.",
  "3)通过明道云账号进行登录的明道云旗下APP（包括但不限于明道云APP等）所有记录都将无法找回。无法再登录、使用前述服务，曾获得的SaaS服务、外部用户包、工作流执行行数付费包、应用附件上传量扩充包等视为自行放弃，将无法继续使用。明道云用户应当理解并同意，明道云无法协助重新恢复前述服务。": "3) All records of the Mingdao Cloud apps (including but not limited to the Mingdao Cloud app) that are logged in through a Mingdao Cloud account will be irretrievable. Users will no longer be able to log in or use the aforementioned services, and any previously obtained SaaS services, external user packages, workflow execution number subscription packages, application attachment upload volume expansion packages, etc., will be deemed as voluntarily relinquished and cannot be continued. Mingdao Cloud users should understand and agree that Mingdao Cloud cannot assist in restoring the aforementioned services.",
  ...
  "此签名适用的短信场景:外部门户用户注册登录、邀请外部用户注册、外部用户审核(通过/拒绝);": "This signature applies to the SMS scenarios: external portal user registration and login, inviting external users to register, external user review (approve/reject);",
  ...
  "登录 - 明道云 | APaaS平台、零代码、hpaPaaS、iPaaS、BaaS、快速开发工具、中台应用": "Login - Mingdao Cloud | APaaS Platform, No-Code, hpaPaaS, iPaaS, BaaS, Rapid Development Tools, Middleware Applications",
  ...
  "SSO登录时，应用首页地址": "Application homepage address during SSO login",
  ...
  "明道云可与您的LDAP/AD目录进行整合， 终端用户可实现单点登录": "Mingdao Cloud can integrate with your LDAP/AD directory, allowing end users to achieve single sign-on.",
  ...
  "使用 %0HAP%1 创建": "Create with %0HAP%1",
  ...
  "以下用户邀请成功": "User invitation successful",
  ...
  "填写申请说明": "Fill out the application instructions",
  ...
  "确定": "Confirm",
  "拖拽至此处上传文件": "Drag and drop files here to upload",
  "任务全体成员": "All members of the task",
  "动态参与者": "Dynamic Participants",
  ...
  "删除讨论失败": "Failed to delete the discussion",
  "您确定要删除该讨论吗？": "Are you sure you want to delete this discussion?",
  "暂无讨论": "No discussions available",
  ...
  "发送讨论（按Ctrl+Enter快速发布）": "Send Discussion (Press Ctrl+Enter to Publish Quickly)",
  "发送": "Send",
  "表情": "Expression",
  ...
  "截止到 %0": "As of %0",
  "每%0年 在 %1": "Every %0 years at %1",
  "MM月DD日": "MM/DD",
  "共 %0 次": "Total %0 times",
  "操作失败，请稍后再试": "Operation failed, please try again later",
  "查看他的空闲时间 >": "Check his free time >",
  "(全天)": "(All Day)",
  "邀请短信发送数量已达最大限制，请移除外部用户创建日程": "The number of invitation messages sent has reached the maximum limit. Please remove external users from creating schedules.",
  ...
  "地点：": "Location:",
  "已经复制到粘贴板，你可以使用Ctrl+V 贴到需要的地方去了哦": "Copied to clipboard. You can use Ctrl+V to paste it where needed.",
  "%0 至 %1": "%0 to %1",
  "取消分享": "Cancel Sharing",
  "复制日程分享链接": "Copy Schedule Sharing Link",
  ...
  "分发有选择的应用项（高级）": "Publish selected app items (Advanced)",
  "分发所有应用项（简单）": "Publish all app items (Simple)",
  "分发哪些应用项？": "Which app items to publish?",
  "常规": "General",
  "文本识别": "OCR",
  "文字识别": "OCR",
  ...
  "USD $0.015": "USD $0.015",
  "按月计费": "Monthly",
  "3 个应用配额": "3 application quotas",
  "最多10个成员": "Up to 10 members",
  "免费版功能：": "Free includes:",
  "总行数最多 50,000 行": "A maximum of 50,000 rows",
  "每表最多 5,000 行": "Up to 5,000 rows per worksheet",
  "100 个工作表配额": "100 worksheet quota",
  "每年 1GB 附件上传": "1GB attachment upload per year",
  "每月 1,000 次工作流执行": "1,000 workflow executions per month",
  "5个成员起步": "Start with 5 members",
  "包含免费版的所有功能，此外还包括：": "Everything in Free, plus:",
  "每表最多 1,000,000 行": "Up to 1,000,000 rows per worksheet",
  "无限的应用配额": "Unlimited application quota",
  "总行数不限": "Unlimited number of rows",
  "每月 100,000 次工作流执行": "100,000 workflow executions per month",
  "每年 60GB 附件上传": "60GB of attachments uploaded annually",
  "每月 100,000 次数据同步": "100,000 data sync per month",
  "10个成员起步": "Starting with 10 members",
  "100 个外部门户用户": "100 external portal users",
  "包含标准版的所有功能，此外还包括：": "Everything in Standard, plus:",
  "无限的工作表配额": "Unlimited worksheet quota",
  "每表最多 5,000,000 行": "Up to 5,000,000 rows per worksheet",
  "每月 500,000 次工作流执行": "500,000 workflow executions per month",
  "每月 500,000 次数据同步": "500,000 data sync per month",
  "应用备份与恢复": "Application Backup and Recovery",
  "每年 120GB 附件上传": "Upload 120GB of attachments annually",
  ...
  "已升级": "Upgraded",
  "我们正在为您的组织进行授权，预计需要约1分钟。授权完成后，您将收到系统消息通知。": "Authorizing your org, takes about 1 min. You'll get a system message when done.",
  ...
  "App下载与设置": "App Download and Setup",
  ...
  "升级至专业版": "Upgrade to Premium Edition",
  "目录": "Directory",
  ...
  "运营": "Operation",
  "App 初次启动需要填写的配置信息": "Configuration information required on first launch of the App",
  ...
  "不管是在电脑前，还是出门在外，都能让你与工作信息时刻保持连接": "Whether you're at your computer or out and about, you can stay connected to your work information at all times",
  "Mac 下载": "Mac Download",
  ...
  "HAP 私有部署版": "HAP Private Deployment Edition",
  ...
  "服务名": "Service Name",
  "平台管理员账号管理，可从管理员所属组织中直接添加管理员成员，也可移除成员": "Platform administrator account management allows for the direct addition of administrator members from the organization to which the administrator belongs, as well as the removal of members.",
  "输入完整的服务名": "Enter the full service name",
  "未查询到相关内容": "No relevant content found",
  "导出前500条日志": "Export the first 500 logs",
  "输入日志内容": "Enter log content",
  ...
  "新版本提示": "New Version Notification",
  "检测": "Detection",
  ...
  "LOGO跳转链接": "LOGO link",
  "当组织、用户信息变更时，以标准的 HTTP 协议把事件内容推送到指定的地址。请求时间超过10秒则超时，超时后不再重试。": "When organization or user information changes, the event content is pushed to the designated address using standard HTTP protocol. If the request time exceeds 10 seconds, it times out, and no further retries will be made after the timeout.",
  "Favicon": "Favicon",
  "文档链接": "Document Link",
  "Webhook 地址": "Webhook Address",
  "事件订阅": "Event Subscription",
  "组织信息收集": "Organization Information Collection",
  "发送测试示例": "Send Test Example",
  "请输入正确的地址": "Please enter a valid address",
  "当前密钥": "Current Key",
  "通知地址": "Notification Address",
  "内部用户配额": "Internal User Quota",
  "平台用户申请将应用上架到企业微信工作台，通过接口将平台用户申请通知到平台管理员": "Platform users apply to list applications on the WeChat Workbench, notifying the platform administrator of the application request through the API.",
  "已授权": "Authorized",
  ...
  "操作限制": "Operational Restrictions",
  "允许非管理员创建应用": "Allow non-administrators to create applications",
  "子流程节点可处理的数据上限": "Data processing limit for sub-process nodes",
  "工作流“获取多条数据”节点获取的数据，被后续数据处理节点(非子流程)使用时，可处理的数据量上限": "Workflow \"Get Multiple Data\" node has a data processing limit for subsequent nodes (non-subprocesses).",
  "工作表Excel导入行数上限": "Maximum number of rows for importing Excel to worksheet",
  "开启后，在个人头像下拉列表显示App下载入口": "After enabling, the App download entry will be displayed in the personal avatar dropdown list",
  "工作流“获取多条数据”节点获取的数据，被子流程节点使用时，可处理的数据量上限": "The data obtained by the workflow node \"Get Multiple Data\" has an upper limit on the amount of data that can be processed when used by the sub-process node.",
  ...
  "开启后将显示短信相关功能入口（如：工作流发送短信节点、手机号邀请用户、外部门户短信通知等）。为保障功能实际可用，需要自行申请第三方短信服务商账号，然后自主集成或由官方技术团队定制开发": "Once enabled, SMS function entry points will show (e.g., workflow SMS nodes, mobile user invites, external portal SMS notifications). To use this, apply for a third-party SMS provider account and integrate it yourself or via official custom development.",
  "仅支持发送登录/注册验证码。只需配置一个服务商，若配置了多个服务商，则发送验证码短信时每次会随机选择一个。": "Only supports sending login/register verification codes. Simply configure one service provider, and if multiple service providers are configured, a random one will be selected each time a verification code SMS is sent.",
  "%0短信配置服务": "%0 SMS Configuration Service",
  "了解自主集成": "Understand Autonomous Integration",
  "验证码短信": "Verification Code SMS",
  "自定义短信功能": "Custom SMS Function",
  ...
  "开启后，在登录页显示注册账号入口": "After enabled, display the registration account entry on the login page",
  ...
  "允许使用验证码登录": "Allow login with verification code",
  "开启后绑定邮箱或手机号时，需要验证合法性": "When binding an email address or phone number after enabling, validity verification is required.",
  "启后将在登录页显示Google登录按钮": "After enabling, the Google login button will be displayed on the login page",
  "回调地址": "Callback URL",
  "底部信息栏": "Footer Information Bar",
  "请完善配置信息": "Please complete the configuration information",
  "设置链接": "Set Link",
  "在登录、注册页底部显示自定义链接如：法律条款、备案号等信息": "Display custom links at the bottom of the login and registration pages, such as terms of service,备案号 and other information.",
  ...
  "登录后直接进入应用": "Directly enter the application after logging in",
  "登录验证": "Login Verification",
  "二次验证": "Two-step Verification",
  "5天": "5 days",
  "开启后，除了基于账号密码的登录认证，还需要通过手机号或邮箱接收验证码进行二次认证，所以请确保组织成员的手机号、邮箱的合法性，同时确保系统内的短信服务、邮件服务已正常启用。": "Once enabled, besides account and password login, a secondary authentication via mobile or email verification code is required. Ensure member mobile numbers and email addresses are valid, and system SMS and email services are working properly.",
  "支持设置登录后直接进入的应用，应用ID可前往应用管理右上角查看。若未设置，则默认登录后进入工作台": "Supports setting the application to directly enter after login, and the application ID can be viewed at the top right corner of the application management. If not set, the default is to enter the workspace after login.",
  ...
  "15天": "15 days",
  "过期天数": "Expired Days",
  "首次登录需修改密码": "You need to change your password on first login",
  "密码规则": "Password Rules",
  ...
  "提示说明": "Notification Instructions",
  "用户密码": "User Password",
  "开启时，平台账户可自行配置设备登录限制(账户管理-->安全设置)；关闭后，平台用户仅可在同设备类型登录一个终端，例如在Web浏览器登录后，将会使其他Web浏览器登录的同一账号强制退出登录，以确保账户登录安全，手机APP同理": "When enabled, the platform account can configure device login restrictions by itself (Account Management --> Security Settings); when disabled, platform users can only log in one terminal on the same device type. For example, logging in via a web browser will force the same account logged in on other web browsers to log out to ensure account login security, and this applies to the mobile APP as well.",
  ...
  "%0/%1": "%0/%1",
  "确认删除 %0 ?": "Confirm to delete %0?",
  "推荐尺寸": "Recommended Size",
  "已创建工作表（含聚合表）": "Worksheet created (including aggregate worksheet)",
  ...
  "绑定服务号后，外部门户将可以通过指定的域名获取该服务号下微信用户的授权及openID，可以通过工作流为外部的微信用户推送模板消息": "After binding service number, external portal can get WeChat user auth and openID via specified domain, and push template msgs to external WeChat users via workflows.",
  ...
  "门户地址": "Portal Address",
  "确定删除%0 ?": "Confirm to delete %0?",
  "请输入0以上的整数": "Please enter an integer greater than 0",
  "路径": "Path",
  "非子流程节点数据处理上限（最大200）": "Non-subprocess node data processing limit (maximum 200)",
  "工作表Excel导入行数上限（最大40000）": "Worksheet Excel import row limit (maximum 40000)",
  "子流程节点可处理的数据上限（最大20000）": "The maximum data limit that a sub-process node can handle (up to 20000)",
  "数据操作设置": "Data Operation Settings",
  "工作表批量数据操作上限（最大10000）": "Worksheet batch data operation limit (maximum 10,000)",
  "应用批量导出工作表上限（最大500）": "Application batch export worksheet limit (maximum 500)",
  "单附件上传大小上限（最大4096）": "Single attachment upload size limit (max 4096)",
  "收件邮箱": "Recipient Email",
  "请输入发送邮箱": "Please enter the sending email",
  "请输入端口": "Please enter the port",
  "使用 SSL 链接": "Use SSL connection",
  "邮件服务设置": "Email Service Settings",
  "请输入收件邮箱": "Please enter the recipient's email",
  "发送测试邮件": "Send Test Email",
  "取消勾选, 配置过程中将隐藏该工作表控件。该功能不影响已配置字段的使用": "Uncheck, the worksheet control will be hidden during the configuration process. This function does not affect the use of configured fields.",
  ...
  "开启后将显示AI相关功能入口。若要保证功能正常使用，还需要在下方配置相应服务。如未完成配置，可先关闭。": "Once enabled, the entry points for AI-related features will be displayed. To ensure the functionality works properly, you also need to configure the necessary services below. If the configuration is not complete, you may close it for now.",
  "如：工作表字段建议、工作表自定义字段、工作流代码块自动生成、应用多语言智能翻译": "For example: worksheet field suggestions, worksheet custom fields, workflow code block auto-generation, application multilingual intelligent translation",
  "使用工作流AIGC节点时可根据需要选择不同的模型，备选模型的配置需在配置文件中完成": "When using the workflow AIGC node, you can choose different models as needed, and the configuration of alternative models must be completed in the configuration file.",
  "搜索品牌": "Search Brand",
  "包名": "Package Name",
  "+ 添加品牌": "+ Add Brand",
  ...
  "iOS消息推送通道设置": "iOS Push Notification Channel Settings",
  "有效期：%0": "Validity Period: %0",
  "证书": "Certificate",
  "证书、密钥为 .pem 格式，不得大于1M，密钥与证书需匹配": "Certificates and keys must be in .pem format and should not exceed 1MB; the keys must match the certificates.",
  "模板 code": "Template code",
  "模板类型": "Template Type",
  "保存失败，请检查配置信息": "Save failed, please check the configuration information",
  "BundleId": "BundleId",
  "模板 Code不能为空": "Template Code cannot be empty",
  "如：\"您的验证码是${code}，感谢您的使用\"，则参数为 code。": "Your verification code is ${code}. Thank you for using our service.",
  "如：\"您的验证码是{1}，感谢您的使用\"，则参数为 {1}。": "Your verification code is {1}. Thank you for using our service.",
  "模版 Code": "Template Code",
  "（暂仅支持验证码）": "(Currently supports verification code only)",
  ...
  "短信模板": "SMS Template",
  "配置文本识别服务": "Configure Text Recognition Service",
  ...
  "邮件%0/封，": "Email %0/message(s),",
  "聊天功能已关闭": "The chat feature has been disabled",
  "可恢复%0天内删除的字段": "Fields deleted within %0 days can be restored",
  "抱歉，操作过于频繁或者创建的组织已经达到上限，请升级版本！": "Sorry, operation too frequent or max orgs reached, upgrade needed!",
  ...
  "已选择 ${md.global.SysSettings.worktableBatchOperateDataLimitCount} 条数据": "Selected ${md.global.SysSettings.worktableBatchOperateDataLimitCount} records",
  ...
  "HAP": "HAP",
  "当前所选记录数量超过%0行，数据不会进入回收站而直接进行彻底删除。此操作只有应用管理员可以执行。": "The number of currently selected records exceeds %0 rows, and the data will not go to the recycle bin but will be permanently deleted. This operation can only be performed by application administrators.",
  "最大支持批量执行%0行记录，是否只选中并执行前%0行数据？": "A maximum of %0 rows can be executed in batch. Do you want to select and execute only the first %0 rows of data?",
  "现在开始搭建你自己的业务系统吧。": "Start building your own business system now.",
  "可恢复%0天内删除的应用项": "Recoverable application items deleted within %0 days",
  "%0天内可在 回收站 内找回已删除%1，无编辑权限的数据无法删除。": "You can recover deleted %1 within %0 days in the Recycle Bin. Data without edit permissions cannot be deleted.",
  ...
  "如何实现企业微信扫码登录？": "How to implement WeChat Enterprise QR code login?",
  "可将指定应用内的所有工作表数据存储到专属数据库中，免受系统默认数据库的影响，适用于隔离等场景，当前支持最多创建%0个可用专属数据库实例；管理员创建应用时，可选择专属数据库。": "You can store all worksheet data within the specified application into a dedicated database, unaffected by the system's default database, suitable for isolation scenarios. Currently, up to %0 dedicated database instances can be created; administrators can choose a dedicated database when creating applications.",
  ...
  "OA": "OA",
  "关闭企业微信集成后，无法再从企业微信处进入应用": "After disabling the integration with Enterprise WeChat, you will no longer be able to access the application from Enterprise WeChat.",
  ...
  "从Welink通讯录同步到该系统": "Synchronize from Welink address book to this system",
  ...
  "可通过设置组织别名来实现更多的使用场景（如：LDAP 登录时指定组织）。": "Set org aliases for more use cases (e.g., LDAP login).",
  ...
  "您确定要删除 ?": "Confirm to delete?",
  "编辑资源": "Edit Resource",
  "设计图标": "Design Icon",
  "添加资源": "Add Resource",
  "AI服务未配置，AI对话生成代码暂不可用，请联系管理员反馈": "AI service not configured, AI conversation generation code is temporarily unavailable, please contact the administrator for feedback.",
  "您获取的多条数据可供本流程的数据处理节点或子流程节点使用。被数据处理节点（新增、更新、删除）使用，最多支持%0条。被子流程节点使用，最多支持%1条。": "The multiple pieces of data you obtain can be used by the data processing nodes or sub-process nodes of this workflow. Up to %0 records can be used by data processing nodes (create, update, delete). Up to %1 records can be used by sub-process nodes.",
  "去配置": "Go Configure",
  "跳转地址": "Redirect URL",
  "AI服务未配置，AI对话生成代码暂不可用": "AI service not configured, AI conversation generation code is currently unavailable",
  "100万": "1 million",
  ...
  "支持字段：金额、数值、公式、汇总；限制在2位小数（超过只取前两位数值），可支付的金额范围：0.01~10000": "Supported fields: Currency, Number, Formula, Rollup; limited to 2 decimal places (only the first two digits are taken if exceeded), payment amount range: 0.01~10000",
  ...
  "请确认所有应用成员都不再需要此应用后，再执行此操作": "Confirm all app members no longer need app before proceeding.",
  ...
  "更多图标": "More",
  "隐藏不可用的按钮": "Hide unavailable buttons.",
  "将所选字段选项以列表的形式显示在视图左侧，帮助用户快速查看记录。": "Display selected field options as list on left side of view.",
  "选择字段作为快速筛选器平铺显示在视图中，以帮助用户快速查询记录。": "Select fields for quick filtering in view.",
  ...
  "大于等于%03068": "≥",
  "不包含%25004": "not included",
  "不包含%03059": "not included",
  "不包含": "not included",
  ...
  "与 AI 对话生成代码，创建一个完全自定义样式与交互的字段": "Generate custom field code via AI conversation, with styles and interactions.",
  "此字段处于公测体验阶段，欢迎体验使用，如有问题欢迎反馈。": "The field is in public beta. Feel free to try and give feedback on issues.",
  "内容由 AI 生成，可能存在错误，仅供参考": "AI-generated content may have errors, for reference only.",
  "currentControl[当前字段控件]": "currentControl[current field control]",
  "请选择已添加的关联记录字段": "Please select the Associated Records field",
  "选择配置的 “关联记录” 字段": "Select the configured \"Associated Record\" field",
  ...
  "按钮搜索": "Button",
  "搜索方式": "Search Mode",
  "在激活下拉框时请求，将返回的多条数据列表作为下拉菜单的选项进行选择": "Request on dropdown activation to select multiple returned data as dropdown options.",
  ...
  "建立映射": "Create Mapping",
  "使用系统集成的识别服务，单次识别收费为%0/次，批量处理按照%0/附件数量计费，费用将直接从企业账务中心扣除。": "Using integrated recognition service, single recognition costs %0 per occurrence, batch processing is charged %0 per attachment, deducted from company's finance center.",
  "集成中心": "Integration",
  "显示经纬度": "Display Coordinates",
  "从某个定位字段返回位置标题、详细地址或经纬度": "Return location title, address details or coordinates from a location field",
  ...
  "正在获取取经纬度，请稍后": "Fetching coordinates, please wait",
  "点击获取当前位置经纬度": "Click to get current location Coordinates",
  ...
  "必须选择到最后一级": "Full-Level Selection required",
  "打印模板必选": "Print templates required",
  "参与计算的字段值为空时，视为 0": "Empty field values in calculation are treated as 0.",
  ...
  "当前部门及所有下级部门成员": "Current dept. and all sub. members",
  "仅当前部门成员": "Only current dept. member",
  ...
  "启用后，可以为每个选项赋分值。赋值后的选项字段可以公式运算或作为数值字段默认值使用。字段值取所有选择项的分值求和，支持输入正负值。": "Once enabled, you can score options. Scored fields can be used in formulas or as numeric field defaults. The field value is the sum of selected options' scores, supporting positive and negative values.",
  ...
  "验证": "Validation",
  "控件事件是指在应用内表单详情页中的字段控件上有交互事件发生时，如果表单内的数据满足条件，则可以根据配置执行不同动作，如显示消息、调用集成API等。": "Control events are interactive events on field controls in the app's worksheet detail page. If the worksheet data meets conditions, actions like showing messages or calling APIs can be executed based on settings.",
  "不折叠": "Non-collapsible",
  "基础设置": "Basic",
  "在组织的二级域名登录页面，当组织启用了LDAP、SSO或第三方平台账号登录时，可以关闭本系统账号登录": "On the org's subdomain login page, if LDAP, SSO, or third-party platform login is enabled, system account login can be turned off.",
  "在付费版下，您可以通过组织的二级域名登录页面，通过集成LDAP账号登录，实现统一身份认证管理 （确保员工的账号已与邮箱绑定，系统通过邮箱进行映射）": "\nUnder the paid version, you can log in through the organization's secondary domain name login page, through the integrated LDAP account, to achieve unified authentication management (make sure that the employee's account has been bound to the mailbox, and the system maps through the mailbox)",
  "绑定服务号后，外部门户将可以通过指定的域名获取该服务号下微信用户的授权及OpenID，可以通过工作流为外部的微信用户推送模板消息": "After binding the service account, the external portal can get WeChat user's authorization and OpenID via the specified domain name, and push template messages to external WeChat users through workflows.",
  ...
  "从第三方同步通讯录，只能集成一个平台": "Sync contacts from a third party, only one platform can be integrated.",
  "操作系统版本": "OS Version",
  "操作系统类型": "OS Type",
  "登录类型": "Type",
  "登录/登出时间": "Time",
  ...
  "当前分组没有应用项，创建或从其他分组移动应用项": "There are no app items in the current group. Create or move application items from other groups.",
  ...
  "数据同步功能限制": "Data Sync Functional limitations",
  ...
  "申请商户号，开通组织在线收款": "Apply for merchant ID and enable online collection for organization",
  "申请商户号": "Apply for Merchant ID",
  "请选择支付渠道": "Please select payment method",
  "选择支付渠道": "Select Payment Method",
  "支付渠道": "Payment Channel",
  "商户简称": "Merchant Name",
  "系统预设": "Default",
  "自定义颜色可用于应用、自定义页面等地方": "Custom colors can be used in applications, custom pages, etc.",
  "上传的图标可用于应用、应用项、工作表的图标选择，使用SVG格式的单色图标": "The uploaded icon can be used for selecting icons for apps, app  items, and worksheets, using monochrome icons in SVG format.",
  "上传的图标可用于应用、应用项、工作表等地方": "Uploaded icons can be used in apps, app items, worksheets, etc.",
  "应用附件上传量": " Attachment Uploads",
  "应用访问次数计数说明：": "App Access Count description:",
  "应用访问次数": "App Access Count",
  "去年": "Last Year",
  "最近1年": "Last Year",
  "最近90天": "Last 90 Days",
  "最近半年": "Last 6 Months",
  ...
  "当月工作流执行数剩余2%时自动购买当月额度包，费用10元/1,000次": "Auto-purchase monthly quota package when the remaining workflow execution times for this month is 2%, cost CNY 10 /1,000 times",
  "当月同步任务算力剩余2%时自动购买当月额度包，费用10元/10,000行": "Auto-purchase monthly quota package when the remaining processing power for the sync tasks this month is 2%, cost CNY 10 /10,000 rows",
  "工作流执行数自动增补": "Workflow Auto-supplement",
  "工作流执行数单月包": "Workflow single month package",
  "工作流执行数升级包": "Workflow Upgrade Package",
  "附件上传量": "Attachment Upload",
  "记录创建次数计数说明：": "Record creation times description:",
  "记录创建次数": "Record creation times",
  "工作流总数": "Workflows",
  "人数": "Participants",
  "附件累计存储量": "Attachments",
  "确定要删除此字段？": "Are you sure to delete this field?",
  "只能编辑自己上传的附件": "Only edit files uploaded by users themselves",
  ...
  "管理": "Manage",
  "创建于": "Created in",
  "（截止到版本到期时间）": "(as of version expire time)",
  "（截止到接口许可到期时间）": "(as of interface license expire time)",
  "Access Token 过期时间": "Access Token Expire Time",
  "未设置到期时间": "Expire time not set",
  "授权到期时间": "Authorization Expire Time",
  "过期时间": "Expire time",
  "到期时间": "Expire time",
  "链接截止时间：": "Link expire time:",
  "到期时间：根据您所在组织最晚到期时间为准。": "Expire time: Based on the latest expiration time of your organization.",
  ...
  "本月消费": "Monthly spending",
  "本月新增": "Monthly additions",
  "流程": "Workflow",
  "执行详情": "Details",
  "新增": "New",
