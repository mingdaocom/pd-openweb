var translations = {
  ...
  "通过二级域名可建立组织专属的登录页，会展示组织LOGO与配置的背景图，若配置了LDAP、企业微信、钉钉或飞书集成，也会展示在登录页可快捷登录": "You can set up a dedicated login page via a subdomain, featuring its logo and a configured background image. When LDAP, WeCom, DingTalk or Feishu integration is configured, relevant options will be shown on the login page for quick access",
  "在详情页新建或打开记录": "create / open a new record on the detail page",
  ...
  "每次使用时动态计算": "Calculate dynamically when used",
