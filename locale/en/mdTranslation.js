var translations = {
  ...
  "伙伴": "Partner",
  "$": "$",
  "本次测试消耗 %0 tokens， 计费 %1 $": "This test consumed %0 tokens, charged %1 $",
  "未通过分支": "Failed branch",
  ...
  "开发版单个工作表下最多可创建1万条行记录，请升级版本以创建更多行记录": "In the development version, a single worksheet can create up to 10,000 row records. Please upgrade to create more row records.",
  ...
  "开发版最多可创建5万条行记录，请升级以继续": "The developer version allows for a maximum of 50,000 record entries, please upgrade to continue",
  ...
  "用于显示长文本，最多可显示5行": "Used to display long text, up to 5 lines",
  ...
  "4、配置内容请参考": "4. For config content, please refer to",
  ...
  "2、资金直达微信；本平台仅收取商户功能费，支持先试用后付费，点击": "2. Funds go directly to WeChat; this platform only charges merchants functional fee, supporting pay after trial, click",
  "2、资金直达支付宝；本平台仅收取商户功能费，支持先试用后付费，点击": "2. Funds go directly to Alipay; this platform only charges merchant functionality fee, supporting pay after trial, click",
  ...
  "由鲸先企付提供，提交资料需要1-3个工作日完成申请；支持微信和支付宝聚合支付，费率固定为0.25%": "Powered by Jingxian Enterprise Payment. Application takes 1 - 3 business days after submitting. Supports combined WeChat and Alipay payments with a fixed 0.25% fee rate",
  ...
  "允许成员下载打印文件": "Allow to download & print files",
  ...
  "定义输出数据对象的参数，参数名称只能是英文、数字和下划线。参数名称和说明需要含义清晰以便 AI 识别。": "Define output data object parameters. Parameter names can only contain English letters, numbers, and underscores. Keep names and descriptions clear for AI recognition.",
  ...
  "仅对主流程进行测试执行。引用的子流程、PBP、审批流程将跳过执行，可单独前往测试这些流程。": "Only excute the main process. The referenced subprocesses, PBP, and approval processes will be bypassed during execution; but they can be tested separately.",
  ...
  "本次测试消耗 %0 tokens， 计费 %1 元": "This test consumed %0 tokens, billed ￥ %1.",
  ...
  "告诉AI模型在生成响应时应该如何行为以及需要参考的任何上下文。你可以描述助手的个性，告诉它应该回答什么和不应该回答什么，并告诉它如何格式化响应。系统消息将按所消耗token数进行计费。": "You can create an persona for  AI, such as response behavior、applicable context、personality traits、answer scope and response format. System messages are billed by token usage.",
  ...
  "获取流程中单条记录对象通过自定义打印模板生成的 Word、Excel 或 PDF 文件": "Get Word, Excel, or PDF generated from a single record object in the workflow using a custom print template",
  ...
  "指定显示在时间块上的内容": "The content displayed in the time block",
  "开通商户号收款试用": "Activate Merchant Account for Payment Trial",
  "申请商户号，开通组织在线收款": "Apply for merchant account and enable online collection for organization",
  "申请商户号": "Apply for Merchant Account",
  "商户号配置指引": "Merchant Account Configuration Guide",
